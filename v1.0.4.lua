-- This file was Beautified by LeakD | discord.gg/qteAQmfJmP

do
    ply = game.Players plr = ply.LocalPlayer Root = plr.Character.HumanoidRootPart replicated = game:GetService('ReplicatedStorage') Lv = game.Players.LocalPlayer.Data.Level.Value TeleportService = game:GetService('TeleportService') TW = game:GetService('TweenService') Lighting = game:GetService('Lighting') Enemies = workspace.Enemies vim1 = game:GetService('VirtualInputManager') vim2 = game:GetService('VirtualUser') TeamSelf = plr.Team RunSer = game:GetService('RunService') Stats = game:GetService('Stats') Energy = plr.Character.Energy.Value BringConnections = {} BossList = {} MaterialList = {} NPCList = {} shouldTween = false SoulGuitar = false KenTest = true debug = false Brazier1 = false Brazier2 = false Brazier3 = false Sec = 0.1 ClickState = 0 Num_self = 25
end
repeat
    local start = plr.PlayerGui:WaitForChild('Main'):WaitForChild('Loading') and game:IsLoaded() wait()
until start World1 = game.PlaceId == 2753915549 or game.PlaceId == 85211729168715 World2 = game.PlaceId == 4442272183 or game.PlaceId == 79091703265657 World3 = game.PlaceId == 7449423635 or game.PlaceId == 100117331123089 Marines = function()
...
local Attack = {} Attack.__index = Attack Attack.Alive = function(model)
if not model then
    return
end
...
if model and Succes then
    ...
    PosMon = model:GetAttribute('Locked').Position BringEnemy() EquipWeapon(_G.SelectWeapon)
    ...
    if RandomCFrame then
        wait(0.5) _tp(model.HumanoidRootPart.CFrame * CFrame.new(0, 30, 25)) wait(0.5) _tp(model.HumanoidRootPart.CFrame * CFrame.new(25, 30, 0)) wait(0.5) _tp(model.HumanoidRootPart.CFrame * CFrame.new(- 25, 30, 0)) wait(0.5) _tp(model.HumanoidRootPart.CFrame * CFrame.new(0, 30, 25)) wait(0.5) _tp(model.HumanoidRootPart.CFrame * CFrame.new(- 25, 30, 0))
    end
end
end
...
if model and Succes then
    ...
    if RandomCFrame then
        wait(0.1) _tp(model.HumanoidRootPart.CFrame * CFrame.new(0, 30, 25)) wait(0.1) _tp(model.HumanoidRootPart.CFrame * CFrame.new(25, 30, 0)) wait(0.1) _tp(model.HumanoidRootPart.CFrame * CFrame.new(- 25, 30, 0)) wait(0.1) _tp(model.HumanoidRootPart.CFrame * CFrame.new(0, 30, 25)) wait(0.1) _tp(model.HumanoidRootPart.CFrame * CFrame.new(- 25, 30, 0))
    end
end
end
...
if model and Succes then
    ...
    if ToolTip =='Blox Fruit'then
        ...
        notween(model.HumanoidRootPart.CFrame * CFrame.new(0, 50, 8)) wait(0.85) notween(model.HumanoidRootPart.CFrame * CFrame.new(0, 400, 0)) wait(1)
    end
end
end
...
if model and Succes then
    ...
    PosMon = model:GetAttribute('Locked').Position BringEnemy() weaponSc('Sword') _tp(model.HumanoidRootPart.CFrame * CFrame.new(0, 30, 0))
    if RandomCFrame then
        wait(0.1) _tp(model.HumanoidRootPart.CFrame * CFrame.new(0, 30, 25)) wait(0.1) _tp(model.HumanoidRootPart.CFrame * CFrame.new(25, 30, 0)) wait(0.1) _tp(model.HumanoidRootPart.CFrame * CFrame.new(- 25, 30, 0)) wait(0.1) _tp(model.HumanoidRootPart.CFrame * CFrame.new(0, 30, 25)) wait(0.1) _tp(model.HumanoidRootPart.CFrame * CFrame.new(- 25, 30, 0))
    end
end
...
if model and Succes then
    ...
    PosMon = model:GetAttribute('Locked').Position BringEnemy()
    if model.Humanoid.Health < = HealthM then
        _tp(model.HumanoidRootPart.CFrame * CFrame.new(0, 20, 0)) Useskills('Blox Fruit','Z') Useskills('Blox Fruit','X') Useskills('Blox Fruit','C')
    else
        weaponSc('Melee') _tp(model.HumanoidRootPart.CFrame * CFrame.new(0, 30, 0))
    end
end
end
...
if model and Succes then
    ...
    PosMon = model:GetAttribute('Locked').Position BringEnemy()
    if model.Humanoid.Health < = HealthM then
        _tp(model.HumanoidRootPart.CFrame * CFrame.new(0, 35, 8)) Useskills('Gun','Z') Useskills('Gun','X')
    else
        weaponSc('Melee') _tp(model.HumanoidRootPart.CFrame * CFrame.new(0, 30, 0))
    end
end
    ...
    if v ~ = Mon then
        ...
        if alive and v.Name == Mon.Name then
            ...
            if distance < = 3000 then
                ...
                if not bv then
                    bv = Instance.new('BodyVelocity') bv.Name ='BodyVelocity'bv.MaxForce = Vector3.new(1e9, 1e9, 1e9) bv.Velocity = Vector3.zero bv.Parent = root
                end
                if distance < = 10 then
                    AreaMob = true
                end
...
if Mon and Mon:FindFirstChild('HumanoidRootPart') then
    Mon.HumanoidRootPart.CanCollide = false Mon.Humanoid.WalkSpeed = 0 Mon.Humanoid.JumpPower = 0
end
end
)
end
...
if weapon =='Melee'then
    weaponSc('Melee')
    if skill =='Z'then
        vim1:SendKeyEvent(true,'Z', false, game) vim1:SendKeyEvent(false,'Z', false, game)
    elseif skill =='X'then
        vim1:SendKeyEvent(true,'X', false, game) vim1:SendKeyEvent(false,'X', false, game)
    elseif skill =='C'then
        vim1:SendKeyEvent(true,'C', false, game) vim1:SendKeyEvent(false,'C', false, game)
    end
...
elseif weapon =='Blox Fruit'then
    ...
    elseif skill =='C'then
        vim1:SendKeyEvent(true,'C', false, game) vim1:SendKeyEvent(false,'C', false, game)
    elseif skill =='V'then
        vim1:SendKeyEvent(true,'V', false, game) vim1:SendKeyEvent(false,'V', false, game)
    end
...
local old = gg.__namecall setreadonly(gg, false) gg.__namecall = newcclosure(function(...)
...
local w = g.Workspace
local l = g.Lighting
local t = w.Terrain t.WaterWaveSize = 0 t.WaterWaveSpeed = 0 t.WaterReflectance = 0 t.WaterTransparency = 0 l.GlobalShadows = false l.FogEnd = 9e9 l.Brightness = 0 settings().Rendering.QualityLevel ='Level01'for i, v in pairs(g:GetDescendants()) do
...
elseif v:IsA('MeshPart') then
    v.Material ='Plastic'v.Reflectance = 0 v.TextureID = 10385902758728956
end
end
...
elseif Method =='Observation'and Var then
    local VisionRadius = plr.VisionRadius VisionRadius.Value = math.huge
end
end
Hop = function()
pcall(function()
...
local a = game.Players.LocalPlayer repeat
task.wait()
until a.Character and a.Character.PrimaryPart block.CFrame = a.Character.PrimaryPart.CFrame
while task.wait() do
    pcall(function()
...
local LocalPlayer = Players.LocalPlayer sea1 = (game.PlaceId == 2753915549 or game.PlaceId == 85211729168715) sea2 = (game.PlaceId == 4442272183 or game.PlaceId == 79091703265657) sea3 = (game.PlaceId == 7449423635 or game.PlaceId == 100117331123089)
local Settings = { ['Tween Speed'] = 350, ['Bypass Teleport'] = true, ['Up Y'] = false, ['Up Y When Low Health'] = false, ['Same Y'] = false, }
local newdao = CFrame.new(10641.0918, - 1953.92981, 9825.07031, - 0.652825892, - 9.2805891e - 8, - 0.757508039, - 2.73638356e - 8, 1, - 9.89323823e - 8, 0.757508039, - 4.38572947e - 8, - 0.652825892)
local cframenpc = CFrame.new(- 16271.126, 25.5847301, 1371.98755, 0.999396622, - 5.78875188e - 8, - 0.0347310975, 5.52972779e - 8, 1, - 8.7544322e - 8, 0.034731105, 8.28877091e - 8, 0.999396741) function Convert_CFrame(x)
if not x then
    return
end
    ...
    for i, v in next, Spawns do
        if v:FindFirstChild('Part') then
            if (x.Position - HRP.Position).Magnitude > = 3000 and GetSpawnPoint(v.Part) ~ = GetSpawnPoint(HRP) and (v.Part.Position - HRP.Position).Magnitude < = 10000 and (v.Part.Position - x.Position).Magnitude < = Max then
                Max = (v.Part.Position - x.Position).Magnitude Pos = v
            end
        end
    end
    return Pos
...
function BypassTP(Target)
    ...
    if CanBypassTeleport(Target) and GetBypassCFrame(Target) then
        ...
        if TargetTP and TargetTP:FindFirstChild('Part') then
            Character.LastSpawnPoint.Disabled = true ReplicatedStorage.Remotes.CommF_:InvokeServer('SetLastSpawnPoint', TargetTP.Name) ReplicatedStorage.Remotes.CommF_:InvokeServer('SetSpawnPoint') Character:PivotTo(TargetTP.Part.CFrame) Humanoid:ChangeState(15) repeat
            task.wait()
...
function totopofgreattree()
    if getdis(CFrame.new(28310.0234, 14895.1123, 109.456741)) > 1500 then
        ReplicatedStorage.Remotes.CommF_:InvokeServer('requestEntrance', Vector3.new(28310.0234, 14895.1123, 109.456741)) wait(0.3)
    end
    local targetCF = CFrame.new(28607.5352, 14896.5449, 106.011726) _tp(targetCF) repeat
    wait()
until getdis(targetCF) < = 5 wait(0.5)
for i = 1, 4 do
...
function requestentrance(pos)
    ...
    elseif y < getdis(pos) then
        local requestPos = typeof(x) =='Vector3'and x or x.Position ReplicatedStorage.Remotes.CommF_:InvokeServer('requestEntrance', requestPos) wait(1)
    end
end
end
_tp = function(target)
...
local rootPart = character.HumanoidRootPart pcall(function()
if CanBypassTeleport(gg) then
    BypassTP(gg) task.wait(0.5)
end
end
) pcall(function()
...
if sea3 and getdis(gg.Position, newdao.Position) < 2000 then
    ...
    if math.abs(newdao.Position.Y - hrp.CFrame.Y) > 1000 then
        repeat
            task.wait() old_tp(cframenpc)
            if getdis(cframenpc) < 10 then
                local net = ReplicatedStorage.Modules.Net net['RF/SubmarineWorkerSpeak']:InvokeServer('AskKilledTikiBoss') task.wait(0.5) net['RF/SubmarineWorkerSpeak']:InvokeServer('TravelToSubmergedIsland')
            end
        until getdis(gg.Position) < 2000 task.wait(0.6) pcall(function()
...
tween:Play() task.spawn(function()
...
function BTP(p)
    ...
    local lastPosition = humanoidRootPart.Position repeat
    humanoid.Health = 0 humanoidRootPart.CFrame = p playerGui.Quest.Visible = false
    if (humanoidRootPart.Position - lastPosition).Magnitude > 1 then
        lastPosition = humanoidRootPart.Position humanoidRootPart.CFrame = p
    end
    task.wait(0.5)
...
while task.wait() do
    ...
    if _G.SailBoat_Hydra or _G.WardenBoss or _G.AutoFactory or _G.HighestMirage or _G.HCM or _G.PGB or _G.Leviathan1 or _G.UPGDrago or _G.Complete_Trials or _G.TpDrago_Prehis or _G.BuyDrago or _G.AutoFireFlowers or _G.DT_Uzoth or _G.AutoBerry or _G.Prefully or _G.Prehis_Find or _G.Prehis_Skills or _G.Prehis_DB or _G.Prehis_DE or _G.FarmBlazeEM or _G.Dojoo or _G.CollectPresent or _G.AutoLawKak or _G.TpLab or _G.AutoPhoenixF or _G.AutoFarmChest or _G.AutoHytHallow or _G.LongsWord or _G.BlackSpikey or _G.AutoHolyTorch or _G.TrainDrago or _G.AutoSaber or _G.FarmMastery_Dev or _G.CitizenQuest or _G.AutoEctoplasm or _G.KeysRen or _G.Auto_Rainbow_Haki or _G.obsFarm or _G.AutoBigmom or _G.Doughv2 or _G.AuraBoss or _G.Raiding or _G.Auto_Cavender or _G.TpPly or _G.Bartilo_Quest or _G.Level or _G.FarmEliteHunt or _G.AutoZou or _G.AutoFarm_Bone or getgenv().AutoMaterial or _G.CraftVM or _G.FrozenTP or _G.TPDoor or _G.AcientOne or _G.AutoFarmNear or _G.AutoRaidCastle or _G.DarkBladev3 or _G.AutoFarmRaid or _G.Auto_Cake_Prince or _G.Addealer or _G.TPNpc or _G.TwinHook or _G.FindMirage or _G.FarmChestM or _G.Shark or _G.TerrorShark or _G.Piranha or _G.MobCrew or _G.SeaBeast1 or _G.FishBoat or _G.AutoPole or _G.AutoPoleV2 or _G.Auto_SuperHuman or _G.AutoDeathStep or _G.Auto_SharkMan_Karate or _G.Auto_Electric_Claw or _G.AutoDragonTalon or _G.Auto_Def_DarkCoat or _G.Auto_God_Human or _G.Auto_Tushita or _G.AutoMatSoul or _G.AutoKenVTWO or _G.AutoSerpentBow or _G.AutoFMon or _G.Auto_Soul_Guitar or _G.TPGEAR or _G.AutoSaw or _G.AutoTridentW2 or _G.AutoEvoRace or _G.AutoGetQuestBounty or _G.MarinesCoat or _G.TravelDres or _G.Defeating or _G.DummyMan or _G.Auto_Yama or _G.Auto_SwanGG or _G.SwanCoat or _G.AutoEcBoss or _G.Auto_Mink or _G.Auto_Human or _G.Auto_Skypiea or _G.Auto_Fish or _G.CDK_TS or _G.CDK_YM or _G.CDK or _G.AutoFarmGodChalice or _G.AutoFistDarkness or _G.AutoMiror or _G.Teleport or _G.AutoKilo or _G.AutoGetUsoap or _G.Praying or _G.TryLucky or _G.AutoColShad or _G.AutoUnHaki or _G.Auto_DonAcces or _G.AutoRipIngay or _G.DragoV3 or _G.DragoV1 or _G.SailBoats or NextIs or _G.FarmGodChalice or _G.IceBossRen or senth or senth2 or _G.Lvthan or _G.beasthunter or _G.DangerLV or _G.Relic123 or _G.tweenKitsune or _G.Collect_Ember or _G.AutofindKitIs or _G.snaguine or _G.TwFruits or _G.tweenKitShrine or _G.Tp_LgS or _G.Tp_MasterA or _G.tweenShrine or _G.FarmMastery_G or _G.FarmMastery_S or _G.FarmBoss or _G.AutoFarmAllBoss or _G.AutoFishSlap or _G.FarmTyrant or _G.FarmPhaBinh or _G.AutoSpawnCP or _G.AutoBerryH or _G.AutoChestBP or _G.FarmEliteHop or _G.AutoHop_Dough or _G.AutoDoughKing or _G.AutoAttackDoughKing or _G.AutoChipFruit or _G.AutoChipBeli or _G.StartEvent or _G.AutoMysticIsland or _G.AutoPlayerHunter or _G.SafeMode or _G.AutoKillMob or _G.AutoStartPrehistoric or _G.AutoUnHaki or _G.AutoAttackRipIndra or _G.AutoFarmIsland or _G.AutoFarmDungeon or _G.AutoFarmCandy or _G.AutoTP_Gift or _G.AutoTPGift or _G.AutoTPAndCollect or _G.MasterAutoLevel or _G.MasterAutoCandy or _G.TPFloor1 or _G.TPFloor2 or _G.TPFloor3 or _G.TPFloor4 then
        ...
        if not plr.Character.HumanoidRootPart:FindFirstChild('BodyClip') then
            local Noclip = Instance.new('BodyVelocity') Noclip.Name ='BodyClip'Noclip.Parent = plr.Character.HumanoidRootPart Noclip.MaxForce = Vector3.new(100000, 100000, 100000) Noclip.Velocity = Vector3.new(0, 0, 0)
        end
        if not plr.Character:FindFirstChild('highlight') then
            local Test = Instance.new('Highlight') Test.Name ='highlight'Test.Enabled = true Test.FillColor = Color3.fromRGB(0, 255, 254) Test.OutlineColor = Color3.fromRGB(0, 255, 254) Test.FillTransparency = 0.5 Test.OutlineTransparency = 0.2 Test.Parent = plr.Character
        end
...
if World1 then
    if _G.FindBoss =='The Gorilla King'then
        bMon ='The Gorilla King'Qname ='JungleQuest'Qdata = 3 PosQBoss = CFrame.new(- 1601.6553955078, 36.85213470459, 153.38809204102) PosB = CFrame.new(- 1088.75977, 8.13463783, - 488.559906, - 0.707134247, 0, 0.707079291, 0, 1, 0, - 0.707079291, 0, - 0.707134247)
    elseif _G.FindBoss =='Bobby'then
        bMon ='Bobby'Qname ='BuggyQuest1'Qdata = 3 PosQBoss = CFrame.new(- 1140.1761474609, 4.752049446106, 3827.4057617188) PosB = CFrame.new(- 1087.3760986328, 46.949409484863, 4040.1462402344)
    elseif _G.FindBoss =='The Saw'then
        bMon ='The Saw'PosB = CFrame.new(- 784.89715576172, 72.427383422852, 1603.5822753906)
    elseif _G.FindBoss =='Yeti'then
        bMon ='Yeti'Qname ='SnowQuest'Qdata = 3 PosQBoss = CFrame.new(1386.8073730469, 87.272789001465, - 1298.3576660156) PosB = CFrame.new(1218.7956542969, 138.01184082031, - 1488.0262451172)
    elseif _G.FindBoss =='Mob Leader'then
        bMon ='Mob Leader'PosB = CFrame.new(- 2844.7307128906, 7.4180502891541, 5356.6723632813)
    elseif _G.FindBoss =='Vice Admiral'then
        bMon ='Vice Admiral'Qname ='MarineQuest2'Qdata = 2 PosQBoss = CFrame.new(- 5036.2465820313, 28.677835464478, 4324.56640625) PosB = CFrame.new(- 5006.5454101563, 88.032081604004, 4353.162109375)
    elseif _G.FindBoss =='Saber Expert'then
        bMon ='Saber Expert'PosB = CFrame.new(- 1458.89502, 29.8870335, - 50.633564)
    elseif _G.FindBoss =='Warden'then
        bMon ='Warden'Qname ='ImpelQuest'Qdata = 1 PosB = CFrame.new(5278.04932, 2.15167475, 944.101929, 0.220546961, - 4.4994640100000005e - 6, 0.975376427, - 1.95412576e - 5, 1, 9.031620720000001e - 6, - 0.975376427, - 2.10519756e - 5, 0.220546961) PosQBoss = CFrame.new(5191.86133, 2.84020686, 686.438721, - 0.731384635, 0, 0.681965172, 0, 1, 0, - 0.681965172, 0, - 0.731384635)
    elseif _G.FindBoss =='Chief Warden'then
        bMon ='Chief Warden'Qname ='ImpelQuest'Qdata = 2 PosB = CFrame.new(5206.92578, 0.997753382, 814.976746, 0.342041343, - 0.00062915677, 0.939684749, 0.00191645394, 0.999998152, - 2.80422337e - 5, - 0.939682961, 0.00181045406, 0.342041939) PosQBoss = CFrame.new(5191.86133, 2.84020686, 686.438721, - 0.731384635, 0, 0.681965172, 0, 1, 0, - 0.681965172, 0, - 0.731384635)
    elseif _G.FindBoss =='Swan'then
        bMon ='Swan'Qname ='ImpelQuest'Qdata = 3 PosB = CFrame.new(5325.09619, 7.03906584, 719.570679, - 0.309060812, 0, 0.951042235, 0, 1, 0, - 0.951042235, 0, - 0.309060812) PosQBoss = CFrame.new(5191.86133, 2.84020686, 686.438721, - 0.731384635, 0, 0.681965172, 0, 1, 0, - 0.681965172, 0, - 0.731384635)
    elseif _G.FindBoss =='Magma Admiral'then
        bMon ='Magma Admiral'Qname ='MagmaQuest'Qdata = 3 PosQBoss = CFrame.new(- 5314.6220703125, 12.262420654297, 8517.279296875) PosB = CFrame.new(- 5765.8969726563, 82.92064666748, 8718.3046875)
    elseif _G.FindBoss =='Fishman Lord'then
        bMon ='Fishman Lord'Qname ='FishmanQuest'Qdata = 3 PosQBoss = CFrame.new(61122.65234375, 18.497442245483, 1569.3997802734) PosB = CFrame.new(61260.15234375, 30.950881958008, 1193.4329833984)
    elseif _G.FindBoss =='Wysper'then
        bMon ='Wysper'Qname ='SkyExp1Quest'Qdata = 3 PosQBoss = CFrame.new(- 7861.947265625, 5545.517578125, - 379.85974121094) PosB = CFrame.new(- 7866.1333007813, 5576.4311523438, - 546.74816894531)
    elseif _G.FindBoss =='Thunder God'then
        bMon ='Thunder God'Qname ='SkyExp2Quest'Qdata = 3 PosQBoss = CFrame.new(- 7903.3828125, 5635.9897460938, - 1410.923828125) PosB = CFrame.new(- 7994.984375, 5761.025390625, - 2088.6479492188)
    elseif _G.FindBoss =='Cyborg'then
        bMon ='Cyborg'Qname ='FountainQuest'Qdata = 3 PosQBoss = CFrame.new(5258.2788085938, 38.526931762695, 4050.044921875) PosB = CFrame.new(6094.0249023438, 73.770050048828, 3825.7348632813)
    elseif _G.FindBoss =='Ice Admiral'then
        bMon ='Ice Admiral'Qdata = nil PosQBoss = CFrame.new(1266.08948, 26.1757946, - 1399.57678, - 0.573599219, 0, - 0.81913656, 0, 1, 0, 0.81913656, 0, - 0.573599219) PosB = CFrame.new(1266.08948, 26.1757946, - 1399.57678, - 0.573599219, 0, - 0.81913656, 0, 1, 0, 0.81913656, 0, - 0.573599219)
    elseif _G.FindBoss =='Greybeard'then
        bMon ='Greybeard'Qdata = nil PosQBoss = CFrame.new(- 5081.3452148438, 85.221641540527, 4257.3588867188) PosB = CFrame.new(- 5081.3452148438, 85.221641540527, 4257.3588867188)
    end
end
if World2 then
    if _G.FindBoss =='Diamond'then
        bMon ='Diamond'Qname ='Area1Quest'Qdata = 3 PosQBoss = CFrame.new(- 427.5666809082, 73.313781738281, 1835.4208984375) PosB = CFrame.new(- 1576.7166748047, 198.59265136719, 13.724286079407)
    elseif _G.FindBoss =='Jeremy'then
        bMon ='Jeremy'Qname ='Area2Quest'Qdata = 3 PosQBoss = CFrame.new(636.79943847656, 73.413787841797, 918.00415039063) PosB = CFrame.new(2006.9261474609, 448.95666503906, 853.98284912109)
    elseif _G.FindBoss =='Orbitus'then
        bMon ='Orbitus'Qname ='MarineQuest3'Qdata = 3 PosQBoss = CFrame.new(- 2441.986328125, 73.359344482422, - 3217.5324707031) PosB = CFrame.new(- 2172.7399902344, 103.32216644287, - 4015.025390625)
    elseif _G.FindBoss =='Don Swan'then
        bMon ='Don Swan'PosB = CFrame.new(2286.2004394531, 15.177839279175, 863.8388671875)
    elseif _G.FindBoss =='Smoke Admiral'then
        bMon ='Smoke Admiral'Qname ='IceSideQuest'Qdata = 3 PosQBoss = CFrame.new(- 5429.0473632813, 15.977565765381, - 5297.9614257813) PosB = CFrame.new(- 5275.1987304688, 20.757257461548, - 5260.6669921875)
    elseif _G.FindBoss =='Awakened Ice Admiral'then
        bMon ='Awakened Ice Admiral'Qname ='FrostQuest'Qdata = 3 PosQBoss = CFrame.new(5668.9780273438, 28.519989013672, - 6483.3520507813) PosB = CFrame.new(6403.5439453125, 340.29766845703, - 6894.5595703125)
    elseif _G.FindBoss =='Tide Keeper'then
        bMon ='Tide Keeper'Qname ='ForgottenQuest'Qdata = 3 PosQBoss = CFrame.new(- 3053.9814453125, 237.18954467773, - 10145.0390625) PosB = CFrame.new(- 3795.6423339844, 105.88877105713, - 11421.307617188)
    elseif _G.FindBoss =='Darkbeard'then
        bMon ='Darkbeard'Qdata = nil PosQBoss = CFrame.new(3677.08203125, 62.751937866211, - 3144.8332519531) PosB = CFrame.new(3677.08203125, 62.751937866211, - 3144.8332519531)
    elseif _G.FindBoss =='Cursed Captaim'then
        bMon ='Cursed Captain'Qdata = nil PosQBoss = CFrame.new(916.928589, 181.092773, 33422) PosB = CFrame.new(916.928589, 181.092773, 33422)
    elseif _G.FindBoss =='Order'then
        bMon ='Order'Qdata = nil PosQBoss = CFrame.new(- 6217.2021484375, 28.047645568848, - 5053.1357421875) PosB = CFrame.new(- 6217.2021484375, 28.047645568848, - 5053.1357421875)
    end
end
if World3 then
    if _G.FindBoss =='Stone'then
        bMon ='Stone'Qname ='PiratePortQuest'Qdata = 3 PosQBoss = CFrame.new(- 289.76705932617, 43.819011688232, 5579.9384765625) PosB = CFrame.new(- 1027.6512451172, 92.404174804688, 6578.8530273438)
    elseif _G.FindBoss =='Hydra Leader'then
        bMon ='Hydra Leader'Qname ='VenomCrewQuest'Qdata = 3 PosQBoss = CFrame.new(5211.021484375, 1004.35778859375, 758.1847534179688) PosB = CFrame.new(5821.89794921875, 1019.0950927734375, - 73.71923065185547)
    elseif _G.FindBoss =='Kilo Admiral'then
        bMon ='Kilo Admiral'Qname ='MarineTreeIsland'Qdata = 3 PosQBoss = CFrame.new(2179.3010253906, 28.731239318848, - 6739.9741210938) PosB = CFrame.new(2764.2233886719, 432.46154785156, - 7144.4580078125)
    elseif _G.FindBoss =='Captain Elephant'then
        bMon ='Captain Elephant'Qname ='DeepForestIsland'Qdata = 3 PosQBoss = CFrame.new(- 13232.682617188, 332.40396118164, - 7626.01171875) PosB = CFrame.new(- 13376.7578125, 433.28689575195, - 8071.392578125)
    elseif _G.FindBoss =='Beautiful Pirate'then
        bMon ='Beautiful Pirate'Qname ='DeepForestIsland2'Qdata = 3 PosQBoss = CFrame.new(- 12682.096679688, 390.88653564453, - 9902.1240234375) PosB = CFrame.new(5283.609375, 22.56223487854, - 110.78285217285)
    elseif _G.FindBoss =='Cake Queen'then
        bMon ='Cake Queen'Qname ='IceCreamIslandQuest'Qdata = 3 PosQBoss = CFrame.new(- 819.376709, 64.9259796, - 10967.2832, - 0.766061664, 0, 0.642767608, 0, 1, 0, - 0.642767608, 0, - 0.766061664) PosB = CFrame.new(- 678.648804, 381.353943, - 11114.2012, - 0.908641815, 0.00149294338, 0.41757378, 0.00837114919, 0.999857843, 0.0146408929, - 0.417492568, 0.0167988986, - 0.90852499)
    elseif _G.FindBoss =='Longma'then
        bMon ='Longma'Qdata = nil PosQBoss = CFrame.new(- 10238.875976563, 389.7912902832, - 9549.7939453125) PosB = CFrame.new(- 10238.875976563, 389.7912902832, - 9549.7939453125)
    elseif _G.FindBoss =='Soul Reaper'then
        bMon ='Soul Reaper'Qdata = nil PosQBoss = CFrame.new(- 9524.7890625, 315.80429077148, 6655.7192382813) PosB = CFrame.new(- 9524.7890625, 315.80429077148, 6655.7192382813)
    end
end
end
QuestBeta = function()
...
local blacklistquest = {'MarineQuest','BartiloQuest','CitizenQuest','Trainees', } CheckSea = function(b)
...
if World1 then
    if SelectMaterial =='Angel Wings'then
        MMon = {'Shanda','Royal Squad','Royal Soldier','Wysper','Thunder God', } MPos = CFrame.new(- 4698, 845, - 1912) SP ='Default'local c = Vector3.new(- 4607.82275, 872.54248, - 1667.55688) shouldRequestEntrance(c, 10000)
    elseif SelectMaterial =='Leather + Scrap Metal'then
        MMon = {'Brute','Pirate', } MPos = CFrame.new(- 1145, 15, 4350) SP ='Default'elseif SelectMaterial =='Magma Ore'then
        MMon = {'Military Soldier','Military Spy','Magma Admiral', } MPos = CFrame.new(- 5815, 84, 8820) SP ='Default'elseif SelectMaterial =='Fish Tail'then
        MMon = {'Fishman Warrior','Fishman Commando','Fishman Lord', } MPos = CFrame.new(61123, 19, 1569) SP ='Default'local c = Vector3.new(61163.8515625, 5.342342376708984, 1819.7841796875) shouldRequestEntrance(c, 17000)
    end
elseif World2 then
    if SelectMaterial =='Leather + Scrap Metal'then
        MMon = {'Marine Captain', } MPos = CFrame.new(- 2010.5059814453125, 73.00115966796875, - 3326.620849609375) SP ='Default'elseif SelectMaterial =='Magma Ore'then
        MMon = {'Magma Ninja','Lava Pirate', } MPos = CFrame.new(- 5428, 78, - 5959) SP ='Default'elseif SelectMaterial =='Ectoplasm'then
        MMon = {'Ship Deckhand','Ship Engineer','Ship Steward','Ship Officer', } MPos = CFrame.new(911.35827636719, 125.95812988281, 33159.5390625) SP ='Default'local c = Vector3.new(61163.8515625, 5.342342376708984, 1819.7841796875) shouldRequestEntrance(c, 18000)
    elseif SelectMaterial =='Mystic Droplet'then
        MMon = {'Water Fighter', } MPos = CFrame.new(- 3385, 239, - 10542) SP ='Default'elseif SelectMaterial =='Radioactive Material'then
        MMon = {'Factory Staff', } MPos = CFrame.new(295, 73, - 56) SP ='Default'elseif SelectMaterial =='Vampire Fang'then
        MMon = {'Vampire', } MPos = CFrame.new(- 6033, 7, - 1317) SP ='Default'end
    elseif World3 then
        if SelectMaterial =='Scrap Metal'then
            MMon = {'Jungle Pirate','Forest Pirate', } MPos = CFrame.new(- 11975.78515625, 331.7734069824219, - 10620.0302734375) SP ='Default'elseif SelectMaterial =='Fish Tail'then
            MMon = {'Fishman Raider','Fishman Captain', } MPos = CFrame.new(- 10993, 332, - 8940) SP ='Default'elseif SelectMaterial =='Conjured Cocoa'then
            MMon = {'Chocolate Bar Battler','Cocoa Warrior', } MPos = CFrame.new(620.6344604492188, 78.93644714355469, - 12581.369140625) SP ='Default'elseif SelectMaterial =='Dragon Scale'then
            MMon = {'Dragon Crew Archer','Dragon Crew Warrior', } MPos = CFrame.new(6594, 383, 139) SP ='Default'elseif SelectMaterial =='Gunpowder'then
            MMon = {'Pistol Billionaire', } MPos = CFrame.new(- 84.8556900024414, 85.62061309814453, 6132.0087890625) SP ='Default'elseif SelectMaterial =='Mini Tusk'then
            MMon = {'Mythological Pirate', } MPos = CFrame.new(- 13545, 470, - 6917) SP ='Default'elseif SelectMaterial =='Demonic Wisp'then
            MMon = {'Demonic Soul', } MPos = CFrame.new(- 9495.6806640625, 453.58624267578125, 5977.3486328125) SP ='Default'end
        end
    end
    QuestNeta = function()
...
local Window = redzlib:MakeWindow({ Title ='Zeox Hub | v1.0.4', SubTitle ='by @ru_.3 in discord', SaveFolder ='oknaiget.json', })
local Minimizer = Window:NewMinimizer({ KeyCode = Enum.KeyCode.LeftControl, })
local MobileButton = Minimizer:CreateMobileMinimizer({ Image ='rbxassetid://81733589114704', BackgroundColor3 = Color3.fromRGB(0, 0, 0), })
local Tabs = { Info = Window:MakeTab({ Title ='Tab Info And Status', Icon ='Info', }), Main = Window:MakeTab({ Title ='Tab Farming', Icon ='rbxassetid://7733960981', }), Settings = Window:MakeTab({ Title ='Tab Setting', Icon ='rbxassetid://7734053495', }), Fish = Window:MakeTab({ Title ='Tab Fishing', Icon ='rbxassetid://127664059821666', }), Quests = Window:MakeTab({ Title ='Tab Quest And Item', Icon ='rbxassetid://13075622619', }), SeaEvent = Window:MakeTab({ Title ='Tab Sea Event', Icon ='waves', }), Race = Window:MakeTab({ Title ='Tab Mirage And Race', Icon ='rbxassetid://11162889532', }), Prehistoric = Window:MakeTab({ Title ='Tab Volcano Event', Icon ='tent', }), Esp = Window:MakeTab({ Title ='Tab Stats And Esp', Icon ='rbxassetid://7040410130', }), Raids = Window:MakeTab({ Title ='Tab Fruit And Raid', Icon ='rbxassetid://11155986081', }), Combat = Window:MakeTab({ Title ='Tab Local Player', Icon ='rbxassetid://13075651575', }), Travel = Window:MakeTab({ Title ='Tab Teleport', Icon ='locate', }), Shop = Window:MakeTab({ Title ='Tab Shopping', Icon ='rbxassetid://6031265976', }), Misc = Window:MakeTab({ Title ='Tab Miscellaneous', Icon ='rbxassetid://10709783577', }), } Tabs.Info:AddSection('Status Server')
local TimeZone = Tabs.Info:AddParagraph('Time Zone','') function UpdateOS()
local date = os.date('*t')
local hour = (date.hour) % 24
local ampm = hour < 12 and'AM'or'PM'local timezone = string.format('%02i:%02i:%02i %s', ((hour - 1) % 12) + 1, date.min, date.sec, ampm)
...
if result then
    ...
    getgenv().countryRegionCode ='Unknown'end
else
...
local GameTime = Tabs.Info:AddParagraph('Game Time','') function UpdateGameTime()
...
local Second = math.floor(GameTimeValue / (60 ^ 0)) % 60 GameTime:SetDesc(Hour ..' Hour (h) '.. Minute ..' Minute (m) '.. Second ..' Second (s)')
end
spawn(function()
while true do
    UpdateGameTime() wait(1)
end
end
)
local MirageCheck = Tabs.Info:AddParagraph('Mirage Island','Status: ')
local previousMirageStatus =''spawn(function()
pcall(function()
while true do
    wait(1)
    local mirageIslandExists = game.Workspace._WorldOrigin.Locations:FindFirstChild('Mirage Island') ~ = nil
    local currentStatus = mirageIslandExists and'\u{2705}'or'\u{274c}'if currentStatus ~ = previousMirageStatus then
    MirageCheck:SetDesc('Status: '.. currentStatus) previousMirageStatus = currentStatus
end
end
end
)
...
local previousKitsuneStatus =''spawn(function()
while task.wait(1) do
    local currentStatus = game:GetService('Workspace').Map:FindFirstChild('KitsuneIsland') and'\u{2705}'or'\u{274c}'if currentStatus ~ = previousKitsuneStatus then
    KitsuneCheck:SetDesc('Status: '.. currentStatus) previousKitsuneStatus = currentStatus
end
end
end
)
local PrehistoricCheck = Tabs.Info:AddParagraph('Prehistoric Island','Status: ')
local previousPrehistoricStatus =''task.spawn(function()
while task.wait(1) do
    local currentStatus = game.Workspace._WorldOrigin.Locations:FindFirstChild('Prehistoric Island') and'\u{2705}'or'\u{274c}'if currentStatus ~ = previousPrehistoricStatus then
    PrehistoricCheck:SetDesc('Status: '.. currentStatus) previousPrehistoricStatus = currentStatus
end
end
end
)
local FrozenCheck = Tabs.Info:AddParagraph('Frozen Dimension','Status: ')
local previousFrozenStatus =''spawn(function()
while wait(1) do
    local currentStatus = game.Workspace._WorldOrigin.Locations:FindFirstChild('Frozen Dimension') and'\u{2705}'or'\u{274c}'if currentStatus ~ = previousFrozenStatus then
    FrozenCheck:SetDesc('Status: '.. currentStatus) previousFrozenStatus = currentStatus
end
end
end
)
local CakePrinceStatus = Tabs.Info:AddParagraph('Cake Prince','') spawn(function()
while wait(1) do
    local cakePrince = game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('CakePrinceSpawner')
    local killStatus ='Cake Prince: \u{2705}'if string.len(cakePrince) > = 86 then
    local killCount = string.sub(cakePrince, 39, 41) killStatus ='Killed: '.. killCount
end
...
local previousRipStatus =''spawn(function()
while wait(1) do
    local currentStatus = (game:GetService('ReplicatedStorage'):FindFirstChild('rip_indra True Form') or game:GetService('Workspace').Enemies:FindFirstChild('rip_indra')) and'\u{2705}'or'\u{274c}'if currentStatus ~ = previousRipStatus then
    RipIndraCheck:SetDesc('Status: '.. currentStatus) previousRipStatus = currentStatus
end
end
end
)
local DoughKingCheck = Tabs.Info:AddParagraph('Dough King','Status: ')
local previousDoughStatus =''spawn(function()
while wait(1) do
    local currentStatus = (game:GetService('ReplicatedStorage'):FindFirstChild('Dough King') or game:GetService('Workspace').Enemies:FindFirstChild('Dough King')) and'\u{2705}'or'\u{274c}'if currentStatus ~ = previousDoughStatus then
    DoughKingCheck:SetDesc('Status: '.. currentStatus) previousDoughStatus = currentStatus
end
end
end
)
local FullMoonCheck = Tabs.Info:AddParagraph('Full Moon','') task.spawn(function()
while task.wait(1) do
    local moonTextureId = game:GetService('Lighting').Sky.MoonTextureId
    local moonStatus ='Moon: 0/5'if moonTextureId =='http://www.roblox.com/asset/?id=9709149431'then
    moonStatus ='Moon: 5/5 (Full Moon) \u{2705}'elseif moonTextureId =='http://www.roblox.com/asset/?id=9709149052'then
    moonStatus ='Moon: 4/5'elseif moonTextureId =='http://www.roblox.com/asset/?id=9709143733'then
    moonStatus ='Moon: 3/5'elseif moonTextureId =='http://www.roblox.com/asset/?id=9709150401'then
    moonStatus ='Moon: 2/5'elseif moonTextureId =='http://www.roblox.com/asset/?id=9709149680'then
    moonStatus ='Moon: 1/5'end
    FullMoonCheck:SetDesc(moonStatus)
end
end
)
local LegendarySwordCheck = Tabs.Info:AddParagraph('Legendary Sword','Status: ') spawn(function()
while wait(1) do
    local swordStatus ='Not Found'if game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('LegendarySwordDealer','1') then
    swordStatus ='Shisui \u{2705}'elseif game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('LegendarySwordDealer','2') then
    swordStatus ='Wando \u{2705}'elseif game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('LegendarySwordDealer','3') then
    swordStatus ='Saddi \u{2705}'end
    LegendarySwordCheck:SetDesc(swordStatus)
end
end
)
local BoneCount = Tabs.Info:AddParagraph('Bone','') spawn(function()
while wait(1) do
    local bones = game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('Bones','Check') BoneCount:SetDesc('You Have: '.. tostring(bones) ..' Bones')
end
end
)
local RFSubmarineWorkerSpeak = replicated.Modules.Net['RF/SubmarineWorkerSpeak'] WeaponDropdown = Tabs.Main:AddDropdown({ Name ='Select Weapon', Options = {'Melee','Sword','Blox Fruit','Gun', }, Default ='Melee', Callback = function(Value)
_G.ChooseWP = Value
end
, }) spawn(function()
...
) Tabs.Main:AddDropdown({ Name ='UI Scale', Options = {'Small','Normal','Big', }, Default ='Normal', Callback = function(Value)
local scales = { Small = 0.8, Normal = 1, Big = 1.2, } Window:SetUIScale(scales[Value])
end
, }) Tabs.Main:AddSection('Farming') FarmLevel = Tabs.Main:AddToggle({ Name ='Auto Farm Level', Description ='', Default = false, Callback = function(Value)
_G.Level = Value
if not Value then
    alreadyTeleported = false teleporting = false
end
end
, })
...
while task.wait(Sec) do
    if _G.Level then
        ...
        local QuestTitle = questUI.Visible and questUI.Container.QuestTitle.Title.Text or''if level > = 2600 and not inSub and not teleporting and not alreadyTeleported then
        teleporting = true
        local npcPos = CFrame.new(- 16269.7041, 25.2288494, 1373.65955)
        local teleportAttempts = 0 repeat
        task.wait(Sec) _tp(npcPos) teleportAttempts = teleportAttempts + 1
...
until not _G.Level or tick() - timeout > 15 task.wait(2) alreadyTeleported = true teleporting = false
elseif inSub or level < 2600 then
    alreadyTeleported = true teleporting = false
    ...
    if questUI.Visible and not string.find(QuestTitle, questData[1]) then
        replicated.Remotes.CommF_:InvokeServer('AbandonQuest') task.wait(0.2)
        return
    end
...
for _, v in pairs(workspace.Enemies:GetChildren()) do
    if v.Name == enemyName and Attack.Alive(v) then
        foundMob = true repeat
        task.wait(Sec) _tp(v.HumanoidRootPart.CFrame * CFrame.new(0, 20, 0)) Attack.Kill(v, _G.Level)
        if not questUI.Visible then
            break
        end
    until not _G.Level or not v.Parent or v.Humanoid.Health < = 0 break
end
end
if not foundMob then
    for _, v in pairs(replicated:GetChildren()) do
        if v.Name == enemyName and Attack.Alive(v) then
            foundMob = true _tp(v.HumanoidRootPart.CFrame * CFrame.new(0, 20, 0)) break
        end
    end
end
if not foundMob then
    for _, spawnPoint in pairs(workspace['_WorldOrigin'].EnemySpawns:GetChildren()) do
        if string.find(spawnPoint.Name, enemyName) then
            _tp(spawnPoint.CFrame * CFrame.new(0, 20, 0)) break
        end
    end
end
end
    ...
    teleporting = false alreadyTeleported = false
end
end
end
) ClosetMons = Tabs.Main:AddToggle({ Name ='Auto Farm Nearest', Description ='', Default = false, Callback = function(Value)
        ...
        for i, v in pairs(workspace.Enemies:GetChildren()) do
            if v:FindFirstChild('Humanoid') or v:FindFirstChild('HumanoidRootPart') then
                if v.Humanoid.Health > 0 then
                    repeat
                        wait() Attack.Kill(v, _G.AutoFarmNear)
...
) FactoryRaids = Tabs.Main:AddToggle({ Name ='Auto Factory Raid', Description ='', Default = false, Callback = function(Value)
...
) CastleRaids = Tabs.Main:AddToggle({ Name ='Auto Pirate Raid', Description ='', Default = false, Callback = function(Value)
                ...
                if v:FindFirstChild('HumanoidRootPart') and v:FindFirstChild('Humanoid') and v.Humanoid.Health > 0 then
                    if v.Name then
                        if (v.HumanoidRootPart.Position - Root.Position).Magnitude < = 2000 then
                            repeat
                                wait() Attack.Kill(v, _G.AutoRaidCastle)
...
) Ecto = Tabs.Main:AddToggle({ Name ='Auto Farm Ectoplasm', Description ='', Default = false, Callback = function(Value)
...
while wait(Sec) do
    ...
    if _G.AutoEctoplasm then
        ...
        if Attack.Alive(v) then
            repeat
                wait() Attack.Kill(v, _G.AutoEctoplasm)
...
) Tabs.Main:AddSection('Chest') ChestTW = Tabs.Main:AddToggle({ Name ='Auto Farm Chest', Description ='', Default = false, Callback = function(Value)
        ...
        for i = 1, #Chests do
            ...
            if not SelectedIsland or Chest:IsDescendantOf(SelectedIsland) then
                if not Chest:GetAttribute('IsDisabled') and Magnitude < Distance then
                    Distance = Magnitude Nearest = Chest
                end
            end
        end
        if Nearest then
...
) ChestBP = Tabs.Main:AddToggle({ Name ='Auto Chest Bypass', Description ='', Default = false, Callback = function(Value)
...
local RootPart = getCharacter().LowerTorso table.sort(Chests, function(a, b)
...
IsFarming = true task.spawn(function()
while _G.AutoChestBP and LocalPlayer.Character and LocalPlayer.Character.Parent do
    local Chests = getChestsSorted()
    if #Chests > 0 then
        local RootPart = getCharacter().HumanoidRootPart RootPart.CFrame = Chests[1].CFrame
    end
    task.wait(0.1)
end
IsFarming = false
...
, }) StopI = Tabs.Main:AddToggle({ Name ='Stop Items', Description ='', Default = true, Callback = function(Value)
...
while wait(0.2) do
    if _G.StopWhenChalice and (_G.AutoFarmChest or _G.AutoChestBP) then
        ...
        if GetBP("God's Chalice") or GetBP('Sweet Chalice') or GetBP('Fist of Darkness') then
            _G.AutoFarmChest = false _G.AutoChestBP = false
        end
    end
    )
end
...
) Tabs.Main:AddSection('Collect Berry') Berry = Tabs.Main:AddToggle({ Name ='Auto Farm Berry', Description ='', Default = false, Callback = function(Value)
_G.AutoBerry = Value
end
, }) spawn(function()
while wait(Sec) do
                ...
                if not BerryArray or table.find(BerryArray, BerryName) then
                    ...
                    for i = 1, #BerryBush do
                        ...
                        for AttributeName, BerryName in pairs(Bush:GetChildren()) do
                            if not BerryArray or table.find(BerryArray, BerryName) then
                                _tp(BerryName.WorldPivot) fireproximityprompt(BerryName.ProximityPrompt, math.huge)
                            end
                        end
                    end
                end
...
) BerryH = Tabs.Main:AddToggle({ Name ='Auto Farm Berry + Hop', Description ='', Default = false, Callback = function(Value)
_G.AutoBerryH = Value
end
, }) spawn(function()
while wait(Sec) do
                    ...
                    for j = 1, #BerryBush do
                        ...
                        for _, BerryChild in pairs(Bush2:GetChildren()) do
                            if not BerryArray or table.find(BerryArray, BerryChild.Name) then
                                _tp(BerryChild.WorldPivot) fireproximityprompt(BerryChild.ProximityPrompt, math.huge)
                            end
                        end
                    end
                end
...
if World1 then
    Tabs.Main:AddDropdown({ Name ='Select Mob', Default = Bandit, Options = {'Bandit','Monkey','Gorilla','Pirate','Brute','Desert Bandit','Desert Officer','Snow Bandit','Snowman','Chief Petty Officer','Sky Bandit','Dark Master','Toga Warrior','Gladiator','Military Soldier','Military Spy','Fishman Warrior','Fishman Commando',"God's Guard",'Shanda','Royal Squad','Royal Soldier','Galley Pirate','Galley Captain', }, Callback = function(Value)
    getgenv().SelectMob = Value
end
, })
end
if World2 then
    Tabs.Main:AddDropdown({ Name ='Select Mob', Default = Raider, Options = {'Raider','Mercenary','Swan Pirate','Factory Staff','Marine Lieutenant','Marine Captain','Zombie','Vampire','Snow Trooper','Winter Warrior','Lab Subordinate','Horned Warrior','Magma Ninja','Lava Pirate','Ship Deckhand','Ship Engineer','Ship Steward','Ship Officer','Arctic Warrior','Snow Lurker','Sea Soldier','Water Fighter', }, Callback = function(Value)
    getgenv().SelectMob = Value
end
, })
end
if World3 then
    Tabs.Main:AddDropdown({ Name ='Select Mob', Options = {'Pirate Millionaire','Dragon Crew Warrior','Dragon Crew Archer','Female Islander','Giant Islander','Marine Commodore','Marine Rear Admiral','Fishman Raider','Fishman Captain','Forest Pirate','Mythological Pirate','Jungle Pirate','Musketeer Pirate','Reborn Skeleton','Living Zombie','Demonic Soul','Posessed Mummy','Peanut Scout','Peanut President','Ice Cream Chef','Ice Cream Commander','Cookie Crafter','Cake Guard','Baking Staff','Head Baker','Cocoa Warrior','Chocolate Bar Battler','Sweet Thief','Candy Rebel','Candy Pirate','Snow Demon','Isle Outlaw','Island Boy','Sun-kissed Warrior','Isle Champion', }, Callback = function(Value)
    getgenv().SelectMob = Value
end
, })
end
Tabs.Main:AddToggle({ Name ='Auto Kill Mob', Default = false, Callback = function(Value)
            ...
            for i, v in pairs(game:GetService('Workspace').Enemies:GetChildren()) do
                if v.Name == getgenv().SelectMob then
                    if v:FindFirstChild('Humanoid') and v:FindFirstChild('HumanoidRootPart') and v.Humanoid.Health > 0 then
                        repeat
                            game:GetService('RunService').Heartbeat:Wait() Attack.Kill(v, _G.AutoKillMob)
...
Tabs.Main:AddToggle({ Name ='Auto Farm All Island', Default = false, Callback = function(Value)
...
while task.wait(0.2) do
    ...
    local found = false
    for _, v in pairs(workspace.Enemies:GetChildren()) do
        if MobMap[v.Name] and v:FindFirstChild('Humanoid') and v:FindFirstChild('HumanoidRootPart') and v.Humanoid.Health > 0 then
            found = true repeat
            task.wait() _tp(v.HumanoidRootPart.CFrame * CFrame.new(0, 10, 0)) Attack.Kill(v, true)
        until not _G.AutoFarmIsland or not v.Parent or v.Humanoid.Health < = 0
    end
end
if not found then
    _tp(islandPos)
...
local Process = Tabs.Main:AddParagraph('Elites Process','') spawn(function()
while wait(Sec) do
    pcall(function()
...
local EliteHunter = Tabs.Main:AddParagraph('Elite Spawn','Status: ') spawn(function()
local previousStatus =''while wait(1) do
local currentStatus = (game:GetService('ReplicatedStorage'):FindFirstChild('Diablo') or game:GetService('ReplicatedStorage'):FindFirstChild('Deandre') or game:GetService('ReplicatedStorage'):FindFirstChild('Urban') or game:GetService('Workspace').Enemies:FindFirstChild('Diablo') or game:GetService('Workspace').Enemies:FindFirstChild('Deandre') or game:GetService('Workspace').Enemies:FindFirstChild('Urban')) and'\u{2705}'or'\u{274c}'local progress = game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('EliteHunter','Progress')
if currentStatus ~ = previousStatus then
    EliteHunter:SetDesc('Status: '.. currentStatus ..' | Killed: '.. progress) previousStatus = currentStatus
end
end
end
) EliteQ = Tabs.Main:AddToggle({ Name ='Auto Farm Elite', Description ='', Default = false, Callback = function(Value)
        ...
        if not questGui.Visible then
            ...
            if eliteName then
                ...
                if boss and boss:FindFirstChild('HumanoidRootPart') then
                    _tp(boss.HumanoidRootPart.CFrame * CFrame.new(0, 30, 0)) repeat
                    wait() Attack.Kill(boss, _G.FarmEliteHunt)
...
) EliteH = Tabs.Main:AddToggle({ Name ='Auto Farm Elite + Hop', Description ='', Default = false, Callback = function(Value)
_G.FarmEliteH = Value
end
, })
...
local Api ='https://games.roblox.com/v1/games/'local PlaceID = game.PlaceId
local Servers = {}
local Cursor =''local foundServer = false repeat
    ...
    if data.data then
        for _, v in pairs(data.data) do
            if v.playing < v.maxPlayers and v.id ~ = game.JobId then
                foundServer = true TPS:TeleportToPlaceInstance(PlaceID, v.id) break
            end
        end
        Cursor = data.nextPageCursor or''end
    end
    ...
    if _G.FarmEliteH then
        ...
        if not questGui.Visible then
            ...
            if eliteName then
                ...
                if boss and boss:FindFirstChild('HumanoidRootPart') then
                    _tp(boss.HumanoidRootPart.CFrame * CFrame.new(0, 30, 0)) repeat
                    wait() Attack.Kill(boss, _G.FarmEliteH)
                until not _G.FarmEliteH or not boss.Parent or boss.Humanoid.Health < = 0 or not questGui.Visible
            else
                task.wait(5) HopServer()
            end
        else
            replicated.Remotes.CommF_:InvokeServer('AbandonQuest') task.wait(1) HopServer()
        end
    end
end
end
...
) Tabs.Main:AddSection('Farm Rip Indra') Tabs.Main:AddToggle({ Name ='Auto Attack Rip Indra', Description ='', Default = false, Callback = function(Value)
...
while wait(Sec) do
    ...
    if _G.AutoRipIngay then
        ...
        if not GetWP('Dark Dagger') or not GetIn('Valkyrie') and v then
            repeat
                wait() Attack.Kill(v, _G.AutoRipIngay)
            until not _G.AutoRipIngay or not v.Parent or v.Humanoid.Health < = 0
        else
            replicated.Remotes.CommF_:InvokeServer('requestEntrance', Vector3.new(- 5097.93164, 316.447021, - 3142.66602, - 0.405007899, - 4.31682743e - 8, 0.914313197, - 1.9094333199999998e - 8, 1, 3.8755778999999997e - 8, - 0.914313197, - 1.76180437e - 9, - 0.405007899)) wait(0.1) _tp(CFrame.new(- 5344.822265625, 423.98541259766, - 2725.0930175781))
        end
    end
end
)
...
) Tabs.Main:AddToggle({ Name ='Auto Unlocked Haki', Description ='', Default = false, Callback = function(Value)
_G.AutoUnHaki = Value
end
, }) AuraSkin = function(HakiID)
local args = { [1] = { ['StorageName'] = HakiID, ['Type'] ='AuraSkin', ['Context'] ='Equip', }, } replicated:WaitForChild('Modules'):WaitForChild('Net'):WaitForChild('RF/FruitCustomizerRF'):InvokeServer(unpack(args))
end
            ...
            for i, v in pairs(Summoner:FindFirstChild('Circle'):GetChildren()) do
                if v.Name =='Part'then
                    ...
                    if VaildColor(TogglesPart) == false then
                        AuraSkin(HakiCalculate(v)) repeat
                        wait() _tp(v.CFrame)
...
local MobKilled = Tabs.Main:AddParagraph('Cake Princes','') spawn(function()
while wait(0.2) do
    pcall(function()
...
) Cake = Tabs.Main:AddToggle({ Name ='Auto Farm Cake Prince', Description ='', Default = false, Callback = function(Value)
...
while task.wait() do
    if _G.Auto_Cake_Prince and not _G.AutoRaidCastle then
        ...
        if _G.AcceptQuestC and questUI and not questUI.Visible then
            local questPos = CFrame.new(- 1927.92, 37.8, - 12842.54) _tp(questPos)
            while (questPos.Position - root.Position).Magnitude > 50 do
                task.wait(0.2)
            end
            local randomQuest = math.random(1, 4)
            local questData = { [1] = {'StartQuest','CakeQuest2', 2, }, [2] = {'StartQuest','CakeQuest2', 1, }, [3] = {'StartQuest','CakeQuest1', 1, }, [4] = {'StartQuest','CakeQuest1', 2, }, } pcall(function()
            game.ReplicatedStorage.Remotes.CommF_:InvokeServer(unpack(questData[randomQuest]))
        end
        )
    end
    if not cakeMap then
        _tp(CFrame.new(- 2077, 252, - 12373)) task.wait(2)
        return
    end
    if bigMirror and (bigMirror.Other.Transparency == 0 or enemies:FindFirstChild('Cake Prince')) then
        ...
        if boss then
            repeat
                task.wait() Attack.Kill2(boss, _G.Auto_Cake_Prince)
        ...
        if mob then
            repeat
                task.wait() Attack.Kill(mob, _G.Auto_Cake_Prince)
...
) CakeQ = Tabs.Main:AddToggle({ Name ='Accept Quests', Description ='', Default = false, Callback = function(Value)
_G.AcceptQuestC = Value
end
, }) CakeSM = Tabs.Main:AddToggle({ Name ='Auto Summon Cake Prince', Description ='', Default = false, Callback = function(Value)
...
) Tabs.Main:AddToggle({ Name ='Auto Dough King [Fully]', Default = false, Callback = function(Value)
    ...
    if _G.AutoDoughKing then
        ...
        if not workspace.Map.CakeLoaf:FindFirstChild('RedDoor') then
            if GetBP('Red Key') then
                replicated.Remotes.CommF_:InvokeServer('CakeScientist','Check') replicated.Remotes.CommF_:InvokeServer('RaidsNpc','Check')
            end
        elseif workspace.Map.CakeLoaf:FindFirstChild('RedDoor') then
            if GetBP('Red Key') then
                repeat
                    task.wait() _tp(CFrame.new(- 2681.97998, 64.3921585, - 12853.7363, 0.149007782, - 1.8790219199999998e - 8, 0.98883605, 3.60619588e - 8, 1, 1.35681812e - 8, - 0.98883605, 3.3637601099999994e - 8, 0.149007782))
                until not getgenv().AutoDoughKing or (plr.Character.HumanoidRootPart.CFrame - CFrame.new(- 2681.97998, 64.3921585, - 12853.7363, 0.149007782, - 1.8790219199999998e - 8, 0.98883605, 3.60619588e - 8, 1, 1.35681812e - 8, - 0.98883605, 3.3637601099999994e - 8, 0.149007782)).Magnitude < = 5 EquipWeapon('Red Key')
            end
        elseif GetConnectionEnemies('Dough King') then
            local v = GetConnectionEnemies('Dough King')
            if v then
                repeat
                    task.wait() Attack.Kill(v, _G.AutoDoughKing)
        ...
        if GetBP('Sweet Chalice') then
            replicated.Remotes.CommF_:InvokeServer('CakePrinceSpawner', true) _G.AutoAttackDoughKing = true
        else
...
) Tabs.Main:AddToggle({ Name ='Auto Farm Dough King', Default = false, Callback = function(Value)
...
while wait() do
    if _G.AutoAttackDoughKing then
        ...
        if v then
            repeat
                task.wait() Attack.Kill(v, _G.AutoAttackDoughKing)
...
) Tabs.Main:AddToggle({ Name ='Auto Farm Dough King + Hop', Default = false, Callback = function(Value)
...
while task.wait() do
    if _G.AutoHop_Dough then
        ...
        if v then
            repeat
                task.wait() Attack.Kill(v, _G.AutoHop_Dough)
            until not _G.AutoHop_Dough or not v.Parent or v.Humanoid.Health < = 0
        else
            _tp(CFrame.new(- 1943.6765, 251.5095, - 12337.8809)) task.wait(2)
...
local CheckingBone = Tabs.Main:AddParagraph('Bones','') spawn(function()
while wait(0.2) do
    pcall(function()
...
) Tabs.Main:AddToggle({ Name ='Auto Farm Bone', Description ='', Default = false, Callback = function(Value)
...
while wait(0.5) do
    ...
    if _G.AcceptQuestB and questUI and not questUI.Visible then
        local questPos = CFrame.new(- 9516.99316, 172.01718, 6078.46533) _tp(questPos) repeat
        wait(2)
    until not _G.AutoFarm_Bone or (questPos.Position - root.Position).Magnitude < = 50
    if not _G.AutoFarm_Bone then
        return
    end
    local questData = { {'StartQuest','HauntedQuest2', 2, }, {'StartQuest','HauntedQuest2', 1, }, {'StartQuest','HauntedQuest1', 1, }, {'StartQuest','HauntedQuest1', 2, }, } game.ReplicatedStorage.Remotes.CommF_:InvokeServer(unpack(questData[math.random(1, #questData)]))
end
if bone then
    repeat
        wait() Attack.Kill(bone, true)
...
) BoneQ = Tabs.Main:AddToggle({ Name ='Accept Quests', Description ='', Default = false, Callback = function(Value)
_G.AcceptQuestB = Value
end
, }) Tabs.Main:AddToggle({ Name ='Auto Soul Reaper', Description ='', Default = false, Callback = function(Value)
...
while wait(Sec) do
    if _G.AutoHytHallow then
        ...
        if v then
            repeat
                task.wait() Attack.Kill(v, _G.AutoHytHallow)
            until v.Humanoid.Health < = 0 or _G.AutoHytHallow == false
        else
            if not GetBP('Hallow Essence') then
                repeat
                    task.wait(0.1) replicated.Remotes.CommF_:InvokeServer('Bones','Buy', 1, 1)
                until _G.AutoHytHallow == false or GetBP('Hallow Essence')
            else
                repeat
                    wait(0.1) _tp(CFrame.new(- 8932.322265625, 146.83154296875, 6062.55078125))
                until _G.AutoHytHallow == false or (plr.Character.HumanoidRootPart.CFrame == CFrame.new(- 8932.322265625, 146.83154296875, 6062.55078125)) EquipWeapon('Hallow Essence')
            end
        end
    end
    )
...
) RanBone = Tabs.Main:AddToggle({ Name ='Auto Random Bones', Description ='', Default = false, Callback = function(Value)
...
while wait(Sec) do
    ...
    if _G.Auto_Random_Bone then
        repeat
            task.wait() replicated.Remotes.CommF_:InvokeServer('Bones','Buy', 1, 1)
...
) Lucky = Tabs.Main:AddToggle({ Name ='Auto Try Luck Gravestone', Description ='', Default = false, Callback = function(Value)
_G.TryLucky = Value
end
, }) spawn(function()
while wait(Sec) do
...
) Pray = Tabs.Main:AddToggle({ Name ='Auto Pray Gravestone', Description ='', Default = false, Callback = function(Value)
_G.Praying = Value
end
, }) spawn(function()
while wait(Sec) do
...
local TyrantStatus = Tabs.Main:AddParagraph('Boss Spawn','') spawn(function()
pcall(function()
while wait(1) do
    if workspace.Enemies:FindFirstChild('Tyrant of the Skies') then
        TyrantStatus:SetDesc('\u{2705}')
    else
        TyrantStatus:SetDesc('\u{274c}')
    end
end
end
)
...
local EyeStatus = Tabs.Main:AddParagraph('Check Status Eyes','') function Check_Eye()
...
local alerted = false
while task.wait(1) do
    local current, full = Check_Eye() EyeStatus:SetDesc('Eyes: '.. current ..'/4')
...
) FarmTyrant = Tabs.Main:AddToggle({ Name ='Auto Farm Boss TOTS', Description ='', Default = false, Callback = function(Value)
_G.FarmTyrant = Value
end
, }) spawn(function()
while wait(Sec) do
    if _G.FarmTyrant then
        ...
        if (hrp.Position - bossPos).Magnitude > 5 then
            _tp(CFrame.new(bossPos)) repeat
            wait()
        until not _G.FarmTyrant or (plr.Character and plr.Character:FindFirstChild('HumanoidRootPart') and (plr.Character.HumanoidRootPart.Position - bossPos).Magnitude < = 5)
    end
        ...
        for _, mob in pairs(workspace.Enemies:GetChildren()) do
            ...
            if mob and mob.Name == mobName and mob:FindFirstChild('HumanoidRootPart') and mob:FindFirstChild('Humanoid') and mob.Humanoid.Health > 0 then
                if (hrp.Position - mob.HumanoidRootPart.Position).Magnitude > 5000 then
                    ...
                    local t0 = tick() repeat
                    wait() hrp = plr.Character and plr.Character:FindFirstChild('HumanoidRootPart')
...
) FarmPhaBinh = Tabs.Main:AddToggle({ Name ='Auto Summon Boss', Description ='', Default = false, Callback = function(Value)
_G.FarmPhaBinh = Value
end
, })
local function sendSkillKey(skillKey)
local virtualInputManager = game:GetService('VirtualInputManager') virtualInputManager:SendKeyEvent(true, skillKey, false, game) wait(0.05) virtualInputManager:SendKeyEvent(false, skillKey, false, game)
end
...
for _, item in pairs(backpack:GetChildren()) do
    if item:IsA('Tool') and item.ToolTip == toolType then
        item.Parent = character wait(0.12)
    ...
    if _G.FarmPhaBinh then
        ...
        for _, point in ipairs(PhaBinhPoints) do
            ...
            if _G.FarmPhaBinh and arrived then
                equipAndUseSkill('Melee') equipAndUseSkill('Sword') equipAndUseSkill('Gun')
            end
        end
    end
    )
...
) Tabs.Main:AddSection('Farm Material') Test = Tabs.Main:AddDropdown({ Name ='Choose Material', Description ='', Options = MaterialList, Callback = function(Value)
getgenv().SelectMaterial = Value
end
, }) Toggle = Tabs.Main:AddToggle({ Name ='Auto Farm Materials', Description ='', Default = false, Callback = function(Value)
...
if v:FindFirstChild('Humanoid') and v:FindFirstChild('HumanoidRootPart') and v.Humanoid.Health > 0 then
    if v.Name == EnemyName then
        repeat
            wait() Attack.Kill(v, getgenv().AutoMaterial)
...
) Tabs.Main:AddSection('Farm Boss') BossDropdown = Tabs.Main:AddDropdown({ Name ='Select Boss', Description ='', Options = BossList, Callback = function(value)
_G.FindBoss = value
end
, }) FarmBoss = Tabs.Main:AddToggle({ Name ='Auto Farm Boss', Description ='', Default = false, Callback = function(value)
_G.FarmBoss = value spawn(function()
while wait(Sec) do
    if _G.FarmBoss then
        pcall(function()
                    ...
                    for i, v in pairs(workspace.Enemies:GetChildren()) do
                        if Attack.Alive(v) and v.Name == QuestBeta()[1] then
                            if string.find(QuestTitle, QuestBeta()[0]) then
                                repeat
                                    wait() Attack.Kill(v, _G.FarmBoss)
...
, }) BossQ = Tabs.Main:AddToggle({ Name ='Accept Quests', Description ='', Default = true, Callback = function(Value)
_G.AcceptQuestBoss = Value
end
, }) FarmAllBoss = Tabs.Main:AddToggle({ Name ='Auto Farm All Boss', Default = false, Callback = function(Value)
...
while task.wait(0.3) do
    if _G.AutoFarmAllBoss then
            ...
            if boss:FindFirstChild('HumanoidRootPart') and boss:FindFirstChild('Humanoid') and boss.Humanoid.Health > 0 then
                if table.find(BossList, boss.Name) then
                    ...
                    if dist < nearestDist then
                        nearestBoss = boss nearestDist = dist
                    end
                end
            end
        end
        if nearestBoss and nearestBoss:FindFirstChild('HumanoidRootPart') then
            ...
            local humanoid = nearestBoss.Humanoid repeat
            task.wait(0.1)
...
local Mastery_Config = Tabs.Main:AddDropdown({ Name ='Choose Island', Description ='', Options = posMastery, Default = Bone, Callback = function(Value)
SelectIsland = Value
end
, })
local MasteryFruits = Tabs.Main:AddToggle({ Name ='Auto Mastery Fruits', Description ='', Default = false, Callback = function(Value)
...
while wait(Sec) do
    if _G.FarmMastery_Dev then
        ...
        if SelectIsland =='Cake'then
            ...
            if v then
                HealthM = v.Humanoid.MaxHealth * 70 / 100 repeat
                wait() MousePos = v.HumanoidRootPart.Position Attack.Mas(v, _G.FarmMastery_Dev)
...
local MasteryGun = Tabs.Main:AddToggle({ Name ='Auto Mastery Gun', Description ='', Default = false, Callback = function(Value)
...
while wait(Sec) do
    if _G.FarmMastery_G then
        ...
        if SelectIsland =='Cake'then
            ...
            if v then
                HealthM = v.Humanoid.MaxHealth * 70 / 100 repeat
                wait() MousePos = v.HumanoidRootPart.Position Attack.Masgun(v, _G.FarmMastery_G)
                ...
                if plr.Character:FindFirstChildOfClass('Tool') and plr.Character:FindFirstChildOfClass('Tool').Name =='Skull Guitar'then
                    SoulGuitar = true plr.Character:FindFirstChildOfClass('Tool').RemoteEvent:FireServer('TAP', MousePos)
                    if _G.FarmMastery_G then
                        vim1:SendMouseButtonEvent(0, 0, 0, true, game, 1) wait(0.05) vim1:SendMouseButtonEvent(0, 0, 0, false, game, 1) wait(0.05)
                    end
                elseif plr.Character:FindFirstChildOfClass('Tool') and plr.Character:FindFirstChildOfClass('Tool').Name ~ ='Skull Guitar'then
                    SoulGuitar = false RE_ShootGunEvent:FireServer(MousePos, { v.HumanoidRootPart, })
                    if _G.FarmMastery_G then
                        vim1:SendMouseButtonEvent(0, 0, 0, true, game, 1) wait(0.05) vim1:SendMouseButtonEvent(0, 0, 0, false, game, 1) wait(0.05)
                    end
                end
            until _G.FarmMastery_G == false or v.Humanoid.Health < = 0 or not v.Parent SoulGuitar = false
        else
            _tp(CFrame.new(- 1943.676513671875, 251.5095672607422, - 12337.880859375))
        end
    elseif SelectIsland =='Bone'then
...
local MasterySword = Tabs.Main:AddToggle({ Name ='Auto Mastery All Sword', Description ='', Default = false, Callback = function(Value)
                    ...
                    if v.Type =='Sword'then
                        ...
                        if tonumber(v.Mastery) > = 1 or tonumber(v.Mastery) < = 599 then
                            ...
                            if GetBP(SwordName) then
                                if v then
                                    repeat
                                        wait() Attack.Sword(v, _G.FarmMastery_S)
...
) Tabs.Settings:AddSection('Settings / Configure') Initialize = Tabs.Settings:AddToggle({ Name ='Fast Attack', Description ='', Default = true, Callback = function(Value)
_G.Seriality = Value
end
, }) Bringmob = Tabs.Settings:AddToggle({ Name ='Bring Mobs', Description ='', Default = true, Callback = function(Value)
_B = Value
end
, }) Tabs.Settings:AddToggle({ Name ='Auto Hop Server with time', Default = false, Callback = function(Value)
...
) Tabs.Settings:AddSlider({ Name ='Hop Delay (Minutes)', Min = 5, Max = 120, Default = 30, Increment = 1, Callback = function(Value)
_G.HopDelay = Value * 60
end
, }) Tabs.Settings:AddToggle({ Name ='Auto Set Spawn Point', Default = false, Callback = function(Value)
getgenv().Set = Value
if Value then
    pcall(function()
...
, }) BusuAura = Tabs.Settings:AddToggle({ Name ='Auto Turn on Buso', Description ='', Default = true, Callback = function(Value)
Boud = Value
end
, }) spawn(function()
while wait(Sec) do
...
) Tabs.Settings:AddToggle({ Name ='Auto Haki Observation', Default = false, Callback = function(Value)
...
) RaceV3Aura = Tabs.Settings:AddToggle({ Name ='Auto Turn on Race V3', Description ='', Default = false, Flag ='AutoTurnonRaceV3', Callback = function(Value)
...
while wait(0.2) do
    ...
    if _G.RaceClickAutov3 then
        repeat
            replicated.Remotes.CommE:FireServer('ActivateAbility') wait(30)
...
) RaceV4Aura = Tabs.Settings:AddToggle({ Name ='Auto Turn on Race V4', Description ='', Default = false, Callback = function(Value)
...
) RandomAround = Tabs.Settings:AddToggle({ Name ='Auto Turn on Spin  xyz', Description ='', Default = false, Callback = function(Value)
RandomCFrame = Value
end
, }) SafeModes = Tabs.Settings:AddToggle({ Name ='Safe Mode', Description ='', Default = false, Callback = function(Value)
_G.Safemode = Value
end
, }) spawn(function()
while task.wait(Sec) do
    ...
    if _G.Safemode then
        ...
        if Calc_Health < Num_self then
            shouldTween = true _tp(Root.CFrame * CFrame.new(0, 500, 0))
        else
            shouldTween = false
        end
    end
...
) DisableHitVFX = Tabs.Settings:AddToggle({ Name ='Remove Hit VFX', Description ='Removes slash and sword visual effects for better visibility', Default = false, Callback = function(Value)
_G.DestroyHit = Value
end
, })
local HitEffects = {'SlashHit','CurvedRing','SwordSlash','SlashTail', } task.spawn(function()
while task.wait(Sec) do
...
) RmvVFX = Tabs.Settings:AddToggle({ Name ='Remove Death & Respawned VFX', Description ='', Default = false, Callback = function(Value)
RDeath = Value
end
, }) spawn(function()
while wait(Sec) do
...
) DisblesNotify = Tabs.Settings:AddToggle({ Name ='Disable Notify', Description ='', Default = false, Callback = function(Value)
RemoveDamage = Value
end
, }) spawn(function()
while wait(Sec) do
    ...
    if RemoveDamage then
        replicated.Assets.GUI.DamageCounter.Enabled = false plr.PlayerGui.Notifications.Enabled = false
    else
        replicated.Assets.GUI.DamageCounter.Enabled = true plr.PlayerGui.Notifications.Enabled = true
    end
end
)
end
end
) Tabs.Settings:AddToggle({ Name ='Anti AFK', Default = true, Callback = function(Value)
if Value then
    local vu = game:GetService('VirtualUser') repeat
    wait()
until game:IsLoaded() game:GetService('Players').LocalPlayer.Idled:Connect(function()
...
, }) Tabs.Settings:AddToggle({ Name ='Auto Anti - Admin Join Server', Description ='', Default = true, Callback = function(Value)
...
) Tabs.Settings:AddToggle({ Name ='No Clip', Default = false, Callback = function(Value)
...
) Tabs.Esp:AddSection('Stats Upgrade') StatusSelect = Tabs.Esp:AddSlider({ Name ='Stats Value', Description ='', Default = 10, Min = 0, Max = 1000, Rounding = 1, Callback = function(Value)
pSats = Value
end
, }) StatsUpg = Tabs.Esp:AddToggle({ Name ='Auto Melee', Description ='', Default = false, Callback = function(Value)
_G.Auto_Melee = Value
end
, }) spawn(function()
while wait(Sec) do
...
) StatsUpg = Tabs.Esp:AddToggle({ Name ='Auto Swords', Description ='', Default = false, Callback = function(Value)
_G.Auto_Sword = Value
end
, }) spawn(function()
while wait(Sec) do
...
) StatsUpg = Tabs.Esp:AddToggle({ Name ='Auto Gun', Description ='', Default = false, Callback = function(Value)
_G.Auto_Gun = Value
end
, }) spawn(function()
while wait(Sec) do
...
) StatsUpg = Tabs.Esp:AddToggle({ Name ='Auto Blox Fruit', Description ='', Default = false, Callback = function(Value)
...
) StatsUpg = Tabs.Esp:AddToggle({ Name ='Auto Defense', Description ='', Default = false, Callback = function(Value)
...
) Tabs.Fish:AddSection('Fishing') Tabs.Fish:AddDropdown({ Name ='Select Fishing Rod', Description ='', Options = {'Fishing Rod','Gold Rod','Shark Rod','Shell Rod','Treasure Rod', }, Default ='Fishing Rod', Callback = function(Value)
_G.SelectedRod = Value
end
, }) BaitDropdown = Tabs.Fish:AddDropdown({ Name ='Select Bait', Description ='', Options = {'Basic Bait','Kelp Bait','Good Bait','Abyssal Bait','Frozen Bait','Epic Bait','Carnivore Bait', }, Default ='Basic Bait', Callback = function(Value)
...
, }) BuyBaitToggle = Tabs.Fish:AddToggle({ Name ='Auto Buy Bait', Description ='', Default = false, Callback = function(Value)
...
) FishingToggle = Tabs.Fish:AddToggle({ Name ='Auto Fishing', Description ='', Default = false, Callback = function(Value)
...
local MaxDistance = Config.Rod.MaxLaunchDistance task.spawn(function()
while task.wait(0.5) do
    if _G.AutoFishing then
        ...
        if _G.SelectedRod and (not Tool or Tool.Name ~ = _G.SelectedRod) then
            ...
            if backpackTool then
                Char.Humanoid:EquipTool(backpackTool) Tool = backpackTool
            end
        end
        if Tool then
            local waterHeight = GetWaterHeight(HRP.Position)
            local _, hitPos = Workspace:FindPartOnRayWithIgnoreList(Ray.new(Char.Head.Position, HRP.CFrame.LookVector * MaxDistance), { Char, Workspace.Characters, Workspace.Enemies, })
            ...
            if TargetPos and (State =='ReeledIn'or ServerState =='ReeledIn') then
                FishingRequest:InvokeServer('StartCasting') task.wait() FishingRequest:InvokeServer('CastLineAtLocation', TargetPos, 100, true)
            elseif ServerState =='Biting'then
                FishingRequest:InvokeServer('Catching', true) task.wait(0.1) FishingRequest:InvokeServer('Catch', 1)
            end
        end
    end
    )
...
) FishingQ = Tabs.Fish:AddToggle({ Name ='Auto Quest Fishing', Description ='', Default = false, Callback = function(Value)
...
) QuestToggle = Tabs.Fish:AddToggle({ Name ='Auto Complete Quest', Description ='', Default = false, Callback = function(Value)
...
) SellFishToggle = Tabs.Fish:AddToggle({ Name ='Auto Sell Fish', Description ='', Default = false, Callback = function(Value)
...
) SpamSkillZ = Tabs.Fish:AddToggle({ Name ='Auto Spam Skill Z', Description ='', Default = false, Callback = function(Value)
_G.AutoSkillZ = Value
end
, })
local ReplicatedStorage4 = game:GetService('ReplicatedStorage')
local RFJobToolAbilities4 = ReplicatedStorage4.Modules.Net:WaitForChild('RF/JobToolAbilities') task.spawn(function()
while task.wait(0.5) do
...
) TravelDress = Tabs.Quests:AddToggle({ Name ='Auto Quest Sea 2', Description ='', Default = false, Callback = function(Value)
_G.TravelDres = Value
end
, }) spawn(function()
while wait(Sec) do
    ...
    if _G.TravelDres then
        if plr.Data.Level.Value > = 700 then
            if workspace.Map.Ice.Door.CanCollide == true and workspace.Map.Ice.Door.Transparency == 0 then
                replicated.Remotes.CommF_:InvokeServer('DressrosaQuestProgress','Detective') EquipWeapon('Key') repeat
                wait() _tp(CFrame.new(1347.7124, 37.3751602, - 1325.6488))
            ...
            if Enemies:FindFirstChild('Ice Admiral') then
                for _, xz in pairs(Enemies:GetChildren()) do
                    if xz.Name =='Ice Admiral'and Attack.Alive(xz) then
                        repeat
                            task.wait() Attack.Kill(xz, _G.TravelDres)
                        until _G.TravelDres == false or xz.Humanoid.Health < = 0 replicated.Remotes.CommF_:InvokeServer('TravelDressrosa')
                    end
                end
            else
...
) Zou = Tabs.Quests:AddToggle({ Name ='Auto Quest Sea 3', Description ='', Default = false, Callback = function(Value)
_G.AutoZou = Value
end
, }) spawn(function()
while wait(Sec) do
    ...
    if _G.AutoZou then
            ...
            if replicated.Remotes.CommF_:InvokeServer('BartiloQuestProgress','Bartilo') == 3 then
                if replicated.Remotes.CommF_:InvokeServer('GetUnlockables').FlamingoAccess ~ = nil then
                    ...
                    if replicated.Remotes.CommF_:InvokeServer('ZQuestProgress','Check') == 0 then
                        ...
                        if v then
                            repeat
                                wait() Attack.Kill(v, _G.AutoZou)
                            until not _G.AutoZou or not v.Parent or v.Humanoid.Health < = 0 Check = 2 repeat
                            wait() replicated.Remotes.CommF_:InvokeServer('F_','TravelZou')
                        until Check == 1
                    else
                        replicated.Remotes.CommF_:InvokeServer('F_','ZQuestProgress','Check') wait(0.1) replicated.Remotes.CommF_:InvokeServer('F_','ZQuestProgress','Begin')
                    end
                        ...
                        for i1, DevilFruitStore in pairs(TabelDevilFruitStore) do
                            if DevilFruitOpenDoor == DevilFruitStore and replicated.Remotes.CommF_:InvokeServer('GetUnlockables').FlamingoAccess == nil then
                                if not plr.Backpack:FindFirstChild(DevilFruitStore) then
                                    ...
                                    replicated.Remotes.CommF_:InvokeServer('F_','TalkTrevor','1') replicated.Remotes.CommF_:InvokeServer('F_','TalkTrevor','2') replicated.Remotes.CommF_:InvokeServer('F_','TalkTrevor','3')
                                end
                            end
                        end
                    end
        ...
        elseif replicated.Remotes.CommF_:InvokeServer('BartiloQuestProgress','Bartilo') == 2 then
            ...
            notween(CFrame.new(- 1850.49329, 13.1789551, 1750.89685)) wait(0.1) notween(CFrame.new(- 1858.87305, 19.3777466, 1712.01807)) wait(0.1) notween(CFrame.new(- 1803.94324, 16.5789185, 1750.89685)) wait(0.1) notween(CFrame.new(- 1858.55835, 16.8604317, 1724.79541)) wait(0.1) notween(CFrame.new(- 1869.54224, 15.987854, 1681.00659)) wait(0.1) notween(CFrame.new(- 1800.0979, 16.4978027, 1684.52368)) wait(0.1) notween(CFrame.new(- 1819.26343, 14.795166, 1717.90625)) wait(0.1) notween(CFrame.new(- 1813.51843, 14.8604736, 1724.79541))
        end
    end
end
end
...
) Tabs.Quests:AddSection('Tushita + Yama') Q = Tabs.Quests:AddToggle({ Name ='Auto Tushita Sword', Description ='', Default = false, Callback = function(Value)
    ...
    if _G.Auto_Tushita then
        if workspace.Map.Turtle:FindFirstChild('TushitaGate') then
            if not GetBP('Holy Torch') then
                _tp(CFrame.new(5148.03613, 162.352493, 910.548218)) wait(0.7)
            else
                EquipWeapon('Holy Torch') task.wait(1) repeat
                task.wait() _tp(CFrame.new(- 10752, 417, - 9366))
            until not _G.Auto_Tushita or (CFrame.new(- 10752, 417, - 9366).Position - plr.Character.HumanoidRootPart.Position).Magnitude < = 10 wait(0.7) repeat
            task.wait() _tp(CFrame.new(- 11672, 334, - 9474))
        until not _G.Auto_Tushita or (CFrame.new(- 11672, 334, - 9474).Position - plr.Character.HumanoidRootPart.Position).Magnitude < = 10 wait(0.7) repeat
        task.wait() _tp(CFrame.new(- 12132, 521, - 10655))
    until not _G.Auto_Tushita or (CFrame.new(- 12132, 521, - 10655).Position - plr.Character.HumanoidRootPart.Position).Magnitude < = 10 wait(0.7) repeat
    task.wait() _tp(CFrame.new(- 13336, 486, - 6985))
until not _G.Auto_Tushita or (CFrame.new(- 13336, 486, - 6985).Position - plr.Character.HumanoidRootPart.Position).Magnitude < = 10 wait(0.7) repeat
...
until not _G.Auto_Tushita or (CFrame.new(- 13489, 332, - 7925).Position - plr.Character.HumanoidRootPart.Position).Magnitude < = 10
    ...
    if v then
        repeat
            task.wait() Attack.Kill(v, _G.Auto_Tushita)
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Yama Sword', Description ='', Default = false, Callback = function(Value)
_G.Auto_Yama = Value
end
, }) spawn(function()
while wait(Sec) do
    ...
    if _G.Auto_Yama then
        ...
        elseif replicated.Remotes.CommF_:InvokeServer('EliteHunter','Progress') > 30 then
            ...
            if (workspace.Map.Waterfall.SealedKatana.Handle.Position - plr.Character.HumanoidRootPart.Position).Magnitude > = 20 then
                ...
                if zx then
                    repeat
                        wait() Attack.Kill(zx, _G.Auto_Yama)
                    until zx.Humanoid.Health < = 0 or not zx.Parent or not _G.Auto_Yama fireclickdetector(workspace.Map.Waterfall.SealedKatana.Handle.ClickDetector)
                end
            end
        end
    end
...
local CheckSoul = Tabs.Quests:AddParagraph('Skull Guitar Quests','') spawn(function()
while wait(0.2) do
    pcall(function()
    if Quest1 == true then
...
) Tabs.Quests:AddToggle({ Name ='Auto Skull Guitar', Description ='', Default = false, Callback = function(Value)
...
while wait() do
    if _G.Auto_Soul_Guitar then
        ...
        if v then
            v.HumanoidRootPart.CFrame = CFrame.new(- 10138.3974609375, 138.6524658203125, 5902.89208984375) v.Head.CanCollide = false v.Humanoid.Sit = false v.HumanoidRootPart.CanCollide = false v.Humanoid.JumpPower = 0 v.Humanoid.WalkSpeed = 0
...
while wait(Sec) do
    ...
    if _G.Auto_Soul_Guitar then
        if World3 then
            replicated.Remotes.CommF_:InvokeServer('gravestoneEvent', 2) replicated.Remotes.CommF_:InvokeServer('gravestoneEvent', 2, true)
            if replicated.Remotes.CommF_:InvokeServer('GuitarPuzzleProgress','Check') == nil then
                _tp(CFrame.new(- 8655.0166015625, 141.3166961669922, 6160.0224609375)) replicated.Remotes.CommF_:InvokeServer('gravestoneEvent', 2) replicated.Remotes.CommF_:InvokeServer('gravestoneEvent', 2, true)
            elseif replicated.Remotes.CommF_:InvokeServer('GuitarPuzzleProgress','Check').Swamp == false then
                Quest1 = true Quest2 = false Quest3 = false Quest4 = false
                local v = GetConnectionEnemies('Living Zombie')
                if v then
                    repeat
                        task.wait() Attack.Kill(v, _G.Auto_Soul_Guitar)
            ...
            elseif replicated.Remotes.CommF_:InvokeServer('GuitarPuzzleProgress','Check').Ghost == false then
                replicated.Remotes.CommF_:InvokeServer('GuitarPuzzleProgress','Ghost') replicated.Remotes.CommF_:InvokeServer('GuitarPuzzleProgress','Ghost', true)
            elseif replicated.Remotes.CommF_:InvokeServer('GuitarPuzzleProgress','Check').Trophies == false then
                Quest1 = false Quest2 = false Quest3 = true Quest4 = false _tp(CFrame.new(- 9532.8232421875, 6.471667766571045, 6078.068359375)) repeat
                wait()
                local z1 = getRT(1)
                local _z1 = getT(1)
                if z1 and _z1 then
...
) Tabs.Quests:AddToggle({ Name ='Auto Farm Material Skull Guitar', Description ='', Default = false, Callback = function(Value)
        ...
        if GetM('Bones') > = 500 and GetM('Ectoplasm') > = 250 and GetM('Dark Fragment') > = 1 then
            ...
            if GetM('Ectoplasm') < = 250 then
                if _G.AutoMatSoul and World2 then
                    ...
                    if xz then
                        repeat
                            task.wait() Attack.Kill(xz, _G.AutoMatSoul)
            ...
            elseif GetM('Dark Fragment') < 1 then
                if _G.AutoMatSoul and World2 then
                    ...
                    if black then
                        repeat
                            task.wait() Attack.Kill(black, _G.AutoMatSoul)
            ...
            elseif GetM('Bones') < = 500 then
                if _G.AutoMatSoul and World3 then
                    ...
                    if zx then
                        repeat
                            task.wait() Attack.Kill(zx, _G.AutoMatSoul)
...
local CheckCDK = Tabs.Quests:AddParagraph('Number Cursed dual katana quests','Quest Numbers :') spawn(function()
while wait(0.2) do
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Get CDK [ Last Quest ]', Description ='', Default = false, Callback = function(Value)
_G.CDK = Value
end
, }) spawn(function()
while wait(Sec) do
    pcall(function()
    if _G.CDK then
        replicated.Remotes.CommF_:InvokeServer('CDKQuest','Progress','Good') replicated.Remotes.CommF_:InvokeServer('CDKQuest','Progress','Evil') replicated.Remotes.CommF_:InvokeServer('CDKQuest','StartTrial','Boss')
        ...
        if v then
            ...
            _tp(CFrame.new(- 12318.193359375, 601.9518432617188, - 6538.662109375)) wait(0.5) _tp(workspace.Map.Turtle.Cursed.BossDoor.CFrame)
        end
    end
end
)
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Yama CDK', Description ='', Default = false, Callback = function(Value)
_G.CDK_YM = Value
end
, }) spawn(function()
while wait() do
    ...
    if _G.CDK_YM then
        if tostring(replicated.Remotes.CommF_:InvokeServer('CDKQuest','OpenDoor')) ~ ='opened'then
            replicated.Remotes.CommF_:InvokeServer('CDKQuest','OpenDoor') replicated.Remotes.CommF_:InvokeServer('CDKQuest','OpenDoor', true)
        else
            if replicated.Remotes.CommF_:InvokeServer('CDKQuest','Progress')['Finished'] == nil then
                replicated.Remotes.CommF_:InvokeServer('CDKQuest','StartTrial','Evil') replicated.Remotes.CommF_:InvokeServer('CDKQuest','StartTrial','Evil')
                    ...
                    if (Root.Position - workspace.Map.HellDimension.Spawn.Position).Magnitude < = 1000 then
                        for gg, ez in pairs(workspace.Map.HellDimension.Exit:GetChildren()) do
                            if tonumber(gg) == 2 then
                                repeat
                                    task.wait() Root.CFrame = workspace.Map.HellDimension.Exit.CFrame
                        ...
                        if tonumber(replicated.Remotes.CommF_:InvokeServer('CDKQuest','Progress')['Evil']) ~ = 3 then
                            repeat
                                task.wait() repeat
                                task.wait() _tp(workspace.Map.HellDimension.Torch1.Particles.CFrame)
                                for i, v in pairs(workspace.Map.HellDimension:GetDescendants()) do
                                    if v:IsA('ProximityPrompt') then
                                        fireproximityprompt(v)
                                    end
                                end
                            until (workspace.Map.HellDimension.Torch1.Particles.Position - Root.Position).Magnitude < 5 wait(2) _G.T1Yama = true
                        until not _G.CDK_YM or _G.T1Yama or tonumber(replicated.Remotes.CommF_:InvokeServer('CDKQuest','Progress')['Evil']) == 3 repeat
                        task.wait() repeat
                        task.wait() _tp(workspace.Map.HellDimension.Torch2.Particles.CFrame)
                        for i, v in pairs(workspace.Map.HellDimension:GetDescendants()) do
                            if v:IsA('ProximityPrompt') then
                                fireproximityprompt(v)
                            end
                        end
                    until (workspace.Map.HellDimension.Torch2.Particles.Position - Root.Position).Magnitude < 5 wait(2) _G.T2Yama = true
                until _G.T2Yama or _G.CDK_YM == false or tonumber(replicated.Remotes.CommF_:InvokeServer('CDKQuest','Progress')['Evil']) == 3 repeat
                wait() repeat
                task.wait() _tp(workspace.Map.HellDimension.Torch3.Particles.CFrame)
                for i, v in pairs(workspace.Map.HellDimension:GetDescendants()) do
                    if v:IsA('ProximityPrompt') then
                        fireproximityprompt(v)
                    end
                end
            until (workspace.Map.HellDimension.Torch3.Particles.Position - Root.Position).Magnitude < 5 wait(2) _G.T3Yama = true
    ...
    for i, v in pairs(workspace.Enemies:GetChildren()) do
        if (v:FindFirstChild('HumanoidRootPart').Position - workspace.Map.HellDimension.Spawn.Position).Magnitude < = 300 then
            if v:FindFirstChild('HumanoidRootPart') and v:FindFirstChild('Humanoid') and v:FindFirstChild('Humanoid').Health > 0 then
                repeat
                    task.wait() Attack.Kill(v, _G.CDK_YM)
    ...
    if _G.CDK_YM then
        if tonumber(replicated.Remotes.CommF_:InvokeServer('CDKQuest','Progress')['Evil']) == - 5 then
            if not workspace.Map:FindFirstChild('HellDimension') or (Root.Position - workspace.Map.HellDimension.Spawn.Position).Magnitude > 1000 then
                ...
                if v then
                    repeat
                        task.wait() _tp(v.HumanoidRootPart.CFrame)
                ...
                elseif plr.Backpack:FindFirstChild('Hallow Essence') or plr.Character:FindFirstChild('Hallow Essence') then
                    ...
                    until (CFrame.new(- 8932.322265625, 146.83154296875, 6062.55078125).Position - Root.Position).Magnitude < = 8 EquipWeapon('Hallow Essence')
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Tushita CDK', Description ='', Default = false, Callback = function(Value)
_G.CDK_TS = Value
end
, }) spawn(function()
while wait() do
    ...
    if _G.CDK_TS then
        if tostring(replicated.Remotes.CommF_:InvokeServer('CDKQuest','OpenDoor')) ~ ='opened'then
            wait(0.7) replicated.Remotes.CommF_:InvokeServer('CDKQuest','OpenDoor') wait(0.3) replicated.Remotes.CommF_:InvokeServer('CDKQuest','OpenDoor', true)
        else
            if replicated.Remotes.CommF_:InvokeServer('CDKQuest','Progress')['Finished'] == nil then
            ...
            elseif replicated.Remotes.CommF_:InvokeServer('CDKQuest','Progress')['Finished'] == false then
                if tonumber(replicated.Remotes.CommF_:InvokeServer('CDKQuest','Progress')['Good']) == - 3 then
                    ...
                    wait() _tp(CFrame.new(- 4602.5107421875, 16.446542739868164, - 2880.998046875))
                ...
                if (CFrame.new(- 4602.5107421875, 16.446542739868164, - 2880.998046875).Position - game:GetService('Players').LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < = 10 then
                    wait(0.7) replicated.Remotes.CommF_:InvokeServer('CDKQuest','BoatQuest', workspace.NPCs:FindFirstChild('Luxury Boat Dealer'),'Check') wait(0.5) replicated.Remotes.CommF_:InvokeServer('CDKQuest','BoatQuest', workspace.NPCs:FindFirstChild('Luxury Boat Dealer'))
                end
                wait(1) repeat
                wait() _tp(CFrame.new(4001.185302734375, 10.089399337768555, - 2654.86328125))
            ...
            wait(1) repeat
            wait() _tp(CFrame.new(- 9530.763671875, 7.245208740234375, - 8375.5087890625))
    ...
    until not _G.CDK_TS or tonumber(replicated.Remotes.CommF_:InvokeServer('CDKQuest','Progress')['Good']) == 2 _G.AutoRaidCastle = false
elseif tonumber(replicated.Remotes.CommF_:InvokeServer('CDKQuest','Progress')['Good']) == - 5 then
    QuestTushita_1 = false QuestTushita_2 = false QuestTushita_3 = true
    if workspace.Enemies:FindFirstChild('Cake Queen') then
        for i, v in pairs(workspace.Enemies:GetChildren()) do
            if v.Name =='Cake Queen'then
                if v:FindFirstChild('Humanoid') and v:FindFirstChild('HumanoidRootPart') and v.Humanoid.Health > 0 then
                    repeat
                        wait() Attack.Kill(v, _G.CDK_TS)
    ...
    elseif replicated:FindFirstChild('Cake Queen') and replicated:FindFirstChild('Cake Queen').Humanoid.Health > 0 then
        ...
        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - workspace.Map.HeavenlyDimension.Spawn.Position).Magnitude < = 1000 then
            ...
            repeat
                wait() repeat
                wait() _tp(CFrame.new(- 22529.6171875, 5275.77392578125, 3873.5712890625))
                for i, v in pairs(workspace.Map.HeavenlyDimension:GetDescendants()) do
                    if v:IsA('ProximityPrompt') then
                        fireproximityprompt(v)
                    end
                end
            until (CFrame.new(- 22529.6171875, 5275.77392578125, 3873.5712890625).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 5 wait(2) _G.DoneT1 = true
        until not _G.CDK_TS or _G.DoneT1 repeat
        wait() repeat
        wait() _tp(CFrame.new(- 22637.291015625, 5281.365234375, 3749.28857421875))
        for i, v in pairs(workspace.Map.HeavenlyDimension:GetDescendants()) do
            if v:IsA('ProximityPrompt') then
                fireproximityprompt(v)
            end
        end
    until (CFrame.new(- 22637.291015625, 5281.365234375, 3749.28857421875).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 5 wait(2) _G.DoneT2 = true
until _G.DoneT2 or _G.CDK_TS == false repeat
wait() repeat
task.wait() _tp(CFrame.new(- 22791.14453125, 5277.16552734375, 3764.570068359375))
for i, v in pairs(workspace.Map.HeavenlyDimension:GetDescendants()) do
    if v:IsA('ProximityPrompt') then
        fireproximityprompt(v)
    end
end
until (CFrame.new(- 22791.14453125, 5277.16552734375, 3764.570068359375).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 5 wait(2) _G.DoneT3 = true
until _G.DoneT3 or _G.CDK_TS == false
for i, v in pairs(workspace.Enemies:GetChildren()) do
    if (v:FindFirstChild('HumanoidRootPart').Position - CFrame.new(- 22695.7012, 5270.93652, 3814.42847, 0.11794927, 3.3218583399999995e - 8, 0.99301964, - 8.73070718e - 8, 1, - 2.30819008e - 8, - 0.99301964, - 8.397513799999999e - 8, 0.11794927).Position).Magnitude < = 300 then
        if v:FindFirstChild('HumanoidRootPart') and v:FindFirstChild('Humanoid') and v:FindFirstChild('Humanoid').Health > 0 then
            repeat
                wait() Attack.Kill(v, _G.CDK_TS)
...
) Tabs.Quests:AddSection('True Triple Katana Sword') Tabs.Quests:AddButton({ Name ='Buy Legendary Sword', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('LegendarySwordDealer','1') replicated.Remotes.CommF_:InvokeServer('LegendarySwordDealer','2') replicated.Remotes.CommF_:InvokeServer('LegendarySwordDealer','3')
end
, }) Tabs.Quests:AddButton({ Name ='Buy True Triple Katana Sword', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('MysteriousMan','2')
end
, }) Q = Tabs.Quests:AddToggle({ Name ='Tween to Legendary Sword Dealer', Description ='', Default = false, Callback = function(Value)
_G.Tp_LgS = Value
end
, }) spawn(function()
while wait(Sec) do
...
) Tabs.Quests:AddSection("Pole / God Enal's") Q = Tabs.Quests:AddToggle({ Name ='Auto Pole V1', Description ='', Default = false, Callback = function(Value)
_G.AutoPole = Value
end
, }) spawn(function()
while wait(Sec) do
    if _G.AutoPole then
        ...
        if v then
            repeat
                task.wait() Attack.Kill(v, _G.AutoPole)
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Pole V2 [Beta]', Description ='', Default = false, Callback = function(Value)
_G.AutoPoleV2 = Value
end
, }) spawn(function()
while wait(Sec) do
    ...
    if _G.AutoPoleV2 then
        ...
        if GetBP('Rumble Fruit').AwakenedMoves:FindFirstChild('Z') and GetBP('Rumble Fruit').AwakenedMoves:FindFirstChild('X') and GetBP('Rumble Fruit').AwakenedMoves:FindFirstChild('C') and GetBP('Rumble Fruit').AwakenedMoves:FindFirstChild('V') and GetBP('Rumble Fruit').AwakenedMoves:FindFirstChild('F') then
            _G.SelectChip = nil _G.Raiding = false _G.Auto_Awakener = false
            if plr.Data.Fragments.Value > = 5000 then
                replicated.Remotes.CommF_:InvokeServer('Thunder God','Talk') wait(Sec) replicated.Remotes.CommF_:InvokeServer('Thunder God','Sure')
            end
        elseif replicated.Remotes.CommF_:InvokeServer('Awakener','Check') == nil or replicated.Remotes.CommF_:InvokeServer('Awakener','Check') == 0 then
            _G.SelectChip ='Rumble'local Buying = replicated.Remotes.CommF_:InvokeServer('RaidsNpc','Select', _G.SelectChip)
            if Buying then
                Buying:Stop()
            end
...
) Tabs.Quests:AddToggle({ Name ='Auto Saw Sword', Description ='', Default = false, Callback = function(Value)
_G.AutoSaw = Value
end
, }) spawn(function()
while wait(0.2) do
    ...
    if _G.AutoSaw then
        ...
        if v then
            repeat
                task.wait() Attack.Kill(v, _G.AutoSaw)
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Saber Sword', Description ='', Default = false, Callback = function(Value)
_G.AutoSaber = Value
end
, }) spawn(function()
while wait(0.2) do
            ...
            if workspace.Map.Jungle.QuestPlates.Door.Transparency == 0 then
                ...
                if workspace.Map.Desert.Burn.Part.Transparency == 0 then
                    if plr.Backpack:FindFirstChild('Torch') or plr.Character:FindFirstChild('Torch') then
                        EquipWeapon('Torch') firetouchinterest(plr.Character.Torch.Handle, workspace.Map.Desert.Burn.Fire, 0) firetouchinterest(plr.Character.Torch.Handle, workspace.Map.Desert.Burn.Fire, 1) _tp(CFrame.new(1114.61475, 5.04679728, 4350.22803, - 0.648466587, - 1.28799094e - 9, 0.761243105, - 5.70652914e - 10, 1, 1.20584542e - 9, - 0.761243105, 3.4754488199999996e - 10, - 0.648466587))
                    else
                        _tp(CFrame.new(- 1610.00757, 11.5049858, 164.001587, 0.984807551, - 0.167722285, - 0.0449818149, 0.17364943, 0.951244235, 0.254912198, 3.42372805e - 5, - 0.258850515, 0.965917408))
                    end
                else
                    if replicated.Remotes.CommF_:InvokeServer('ProQuestProgress','SickMan') ~ = 0 then
                        replicated.Remotes.CommF_:InvokeServer('ProQuestProgress','GetCup') wait(0.5) EquipWeapon('Cup') wait(0.5) replicated.Remotes.CommF_:InvokeServer('ProQuestProgress','FillCup', plr.Character.Cup) wait(Sec) replicated.Remotes.CommF_:InvokeServer('ProQuestProgress','SickMan')
                    else
                            ...
                            if workspace.Enemies:FindFirstChild('Mob Leader') or replicated:FindFirstChild('Mob Leader') then
                                ...
                                for i, v in pairs(workspace.Enemies:GetChildren()) do
                                    if v.Name =='Mob Leader'and Attack.Alive(v) then
                                        repeat
                                            task.wait() Attack.Kill(v, _G.AutoSaber)
                        ...
                        elseif replicated.Remotes.CommF_:InvokeServer('ProQuestProgress','RichSon') == 1 then
                            replicated.Remotes.CommF_:InvokeServer('ProQuestProgress','RichSon') EquipWeapon('Relic') _tp(CFrame.new(- 1404.91504, 29.9773273, 3.80598116, 0.876514494, 5.66906877e - 9, 0.481375456, 2.53851997e - 8, 1, - 5.79995607e - 8, - 0.481375456, 6.30572643e - 8, 0.876514494))
                        end
                    end
                end
            end
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Cybrog', Description ='', Default = false, Callback = function(Value)
...
while wait(0.2) do
    if _G.AutoColShad then
        ...
        if v then
            repeat
                task.wait() Attack.Kill(v, _G.AutoColShad)
...
) Q = Tabs.Quests:AddToggle({ Name ="Auto Usoap's Hat", Description ='', Default = false, Callback = function(Value)
        ...
        for _, v in pairs(workspace.Characters:GetChildren()) do
            if v.Name ~ = plr.Name then
                if v.Humanoid.Health > 0 and v:FindFirstChild('HumanoidRootPart') and v.Parent and (Root.Position - v.HumanoidRootPart.Position).Magnitude < = 230 then
                    repeat
                        task.wait() EquipWeapon(_G.SelectWeapon) _tp(v.HumanoidRootPart.CFrame * CFrame.new(1, 1, 2))
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Bisento V2', Description ='', Default = false, Callback = function(Value)
_G.Greybeard = Value
end
, }) spawn(function()
while wait(Sec) do
    if _G.Greybeard then
        ...
        elseif GetWP('Bisento') then
            ...
            if v then
                repeat
                    wait() Attack.Kill(v, _G.Greybeard)
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Warden Sword', Description ='', Default = false, Callback = function(Value)
_G.WardenBoss = Value
end
, }) spawn(function()
while wait(0.1) do
    if _G.WardenBoss then
        ...
        if v then
            repeat
                wait() Attack.Kill(v, _G.WardenBoss)
            until _G.WardenBoss == false or not v.Parent or v.Humanoid.Health < = 0
        else
            _tp(CFrame.new(5206.92578, 0.997753382, 814.976746, 0.342041343, - 0.00062915677, 0.939684749, 0.00191645394, 0.999998152, - 2.80422337e - 5, - 0.939682961, 0.00181045406, 0.342041939))
        end
    end
    )
end
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Marine Coat', Description ='', Default = false, Callback = function(Value)
...
while wait(0.1) do
    if _G.MarinesCoat then
        ...
        if v then
            repeat
                wait() Attack.Kill(v, _G.MarinesCoat)
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Swan Coat', Description ='', Default = false, Callback = function(Value)
_G.SwanCoat = Value
end
, }) spawn(function()
while wait(0.1) do
    if _G.SwanCoat then
        ...
        if v then
            repeat
                wait() Attack.Kill(v, _G.SwanCoat)
...
) Tabs.Quests:AddSection('Rengoku Sword') Q = Tabs.Quests:AddToggle({ Name ='Auto Rengoku Sword', Description ='', Default = false, Callback = function(Value)
_G.IceBossRen = Value
end
, }) spawn(function()
pcall(function()
while wait(0.1) do
    if _G.IceBossRen then
        ...
        if v then
            repeat
                task.wait() Attack.Kill(v, _G.IceBossRen)
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Key Rengoku', Description ='', Default = false, Callback = function(Value)
_G.KeysRen = Value
end
, }) spawn(function()
while wait(0.1) do
    ...
    if _G.KeysRen then
        if plr.Backpack:FindFirstChild(RenMon[3]) or plr.Character:FindFirstChild(RenMon[3]) then
            EquipWeapon(RenMon[3]) wait(0.1) _tp(CFrame.new(6571.1201171875, 299.23028564453, - 6967.841796875))
        else
            local v = GetConnectionEnemies(RenMon)
            if v then
                repeat
                    task.wait() Attack.Kill(v, _G.KeysRen)
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Dragon Trident', Description ='', Default = false, Callback = function(Value)
...
while wait(0.1) do
    ...
    if _G.AutoTridentW2 then
        ...
        if v then
            repeat
                task.wait() Attack.Kill(v, _G.AutoTridentW2)
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Long Sword', Description ='', Default = false, Callback = function(Value)
_G.LongsWord = Value
end
, }) spawn(function()
while wait(0.1) do
    ...
    if _G.LongsWord then
        ...
        if v then
            repeat
                task.wait() Attack.Kill(v, _G.LongsWord)
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Black Spikey', Description ='', Default = false, Callback = function(Value)
...
while wait(0.1) do
    if _G.BlackSpikey then
        ...
        if v then
            repeat
                wait() Attack.Kill(v, _G.BlackSpikey)
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Dark Blade V3', Description ='', Default = false, Callback = function(Value)
    ...
    if _G.DarkBladev3 and World2 then
        ...
        if GetBP('Fist of Darkness') > 1 then
            ...
            elseif GetConnectionEnemies('Darkbeard') and GetBP('Fist of Darkness') > = 1 then
                repeat
                    wait() _tp(CFrame.new(- 5719.36376953125, 48.50590515136719, - 782.9759521484375))
                until not _G.DarkBladev3 or (Root.Position == CFrame.new(- 5719.36376953125, 48.50590515136719, - 782.9759521484375).Position) fireclickdetector(workspace.Map.GraveIsland.Mountain.Rocks.Button.ClickDetector)
            end
        else
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Midnight Blade', Description ='', Default = false, Callback = function(Value)
_G.AutoEcBoss = Value
end
, }) spawn(function()
while wait(Sec) do
    ...
    if _G.AutoEcBoss then
        ...
        elseif GetM('Ectoplasm') < = 99 then
            ...
            if v then
                repeat
                    wait() Attack.Kill(v, _G.AutoEcBoss)
                until not _G.AutoEcBoss or not v.Parent or v.Humanoid.Health < = 0
            else
                replicated.Remotes.CommF_:InvokeServer('requestEntrance', Vector3.new(923.21252441406, 126.9760055542, 32852.83203125)) wait(0.5) _tp(CFrame.new(916.928589, 181.092773, 33422))
            end
        end
    end
end
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Darkbeard', Description ='', Default = false, Callback = function(Value)
...
while wait(0.1) do
    if _G.Auto_Def_DarkCoat then
        ...
        elseif GetConnectionEnemies('Darkbeard') then
            ...
            if v then
                repeat
                    wait() Attack.Kill(v, _G.Auto_Def_DarkCoat)
        ...
        elseif not GetBP('Fist of Darkness') and not GetConnectionEnemies('Darkbeard') then
            repeat
                wait(0.1) _G.AutoFarmChest = true
            until not _G.Auto_Def_DarkCoat or GetBP('Fist of Darkness') or GetConnectionEnemies('Darkbeard') _G.AutoFarmChest = false
        end
    end
    )
end
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Unlocked DonSwan', Description ='', Default = false, Callback = function(Value)
                    ...
                    for _, z in pairs(FruitStore) do
                        if y == z and replicated.Remotes.CommF_:InvokeServer('GetUnlockables').FlamingoAccess == nil then
                            ...
                            if not plr.Backpack:FindFirstChild(FruitStore) then
                                ...
                                replicated.Remotes.CommF_:InvokeServer('TalkTrevor','1') replicated.Remotes.CommF_:InvokeServer('TalkTrevor','2') replicated.Remotes.CommF_:InvokeServer('TalkTrevor','3')
                            end
                        end
                    end
                end
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Swan Glasses', Description ='', Default = false, Callback = function(Value)
...
while wait(0.2) do
    if _G.Auto_SwanGG then
        ...
        if v then
            repeat
                wait() Attack.Kill(v, _G.Auto_SwanGG)
...
) Tabs.Quests:AddSection('Cavender + Twin Hooks + Bigmom') Q = Tabs.Quests:AddToggle({ Name ='Auto Bigmom', Description ='', Default = false, Callback = function(Value)
_G.AutoBigmom = Value
end
, }) spawn(function()
while wait(Sec) do
    if _G.AutoBigmom then
        ...
        if bx then
            repeat
                task.wait() Attack.Kill(bx, _G.AutoBigmom)
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Canvendish Sword', Description ='', Default = false, Callback = function(Value)
...
while wait(Sec) do
    ...
    if _G.Auto_Cavender then
        ...
        if v then
            repeat
                wait() Attack.Kill(v, _G.Auto_Cavender)
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Twin Hooks', Description ='', Default = false, Callback = function(Value)
_G.TwinHook = Value
end
, }) spawn(function()
while wait(Sec) do
    ...
    if _G.TwinHook then
        ...
        if v then
            repeat
                wait() Attack.Kill(v, _G.TwinHook)
            until not _G.TwinHook or v.Humanoid.Health < = 0
        else
            replicated.Remotes.CommF_:InvokeServer('requestEntrance', Vector3.new(- 12471.169921875, 374.94024658203, - 7551.677734375)) wait(0.2) _tp(CFrame.new(- 13376.7578125, 433.28689575195, - 8071.392578125))
        end
    end
end
)
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Serpent Bow', Description ='', Default = false, Callback = function(Value)
...
while wait(Sec) do
    if _G.AutoSerpentBow then
        ...
        if v then
            repeat
                wait() Attack.Kill(v, _G.AutoSerpentBow)
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Lei Accessory', Description ='', Default = false, Callback = function(Value)
_G.AutoKilo = Value
end
, }) spawn(function()
while wait(0.2) do
    if _G.AutoKilo then
        ...
        if v then
            repeat
                task.wait() Attack.Kill(v, _G.AutoKilo)
...
) Tabs.Quests:AddSection('Buso/Aura Colours') Q = Tabs.Quests:AddToggle({ Name ='Auto Teleport Barista Cousin', Description ='', Default = false, Callback = function(Value)
_G.Tp_MasterA = Value
end
, }) spawn(function()
while wait() do
...
) Tabs.Quests:AddButton({ Name ='Buy Buso Colors', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('ColorsDealer','2')
end
, }) Q = Tabs.Quests:AddToggle({ Name ='Auto Rainbow Colors', Description ='', Default = false, Callback = function(Value)
...
while wait(Sec) do
    if _G.Auto_Rainbow_Haki then
        if plr.PlayerGui.Main.Quest.Visible == false then
            if _G.GetQFast then
                ...
                elseif (plr.Character.HumanoidRootPart.CFrame == Rainbow1) then
                    wait(1) replicated.Remotes.CommF_:InvokeServer('HornedMan','Bet')
                end
            end
        elseif plr.PlayerGui.Main.Quest.Visible == true and string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,'Stone') then
            ...
            if v then
                repeat
                    wait() Attack.Kill(v, _G.Auto_Rainbow_Haki)
                until _G.Auto_Rainbow_Haki == false or v.Humanoid.Health < = 0 or not v.Parent or plr.PlayerGui.Main.Quest.Visible == false
            else
                _tp(CFrame.new(- 1086.11621, 38.8425903, 6768.71436, 0.0231462717, - 0.592676699, 0.805107772, 2.03251839e - 5, 0.805323839, 0.592835128, - 0.999732077, - 0.0137055516, 0.0186523199))
            end
        elseif plr.PlayerGui.Main.Quest.Visible == true and string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,'Hydra Leader') then
            ...
            if v then
                repeat
                    task.wait() Attack.Kill(v, _G.Auto_Rainbow_Haki)
                until _G.Auto_Rainbow_Haki == false or v.Humanoid.Health < = 0 or not v.Parent or plr.PlayerGui.Main.Quest.Visible == false
            else
...
) Q = Tabs.Quests:AddToggle({ Name ='Accept Rainbow Quest Faster', Description ='', Default = false, Callback = function(Value)
_G.GetQFast = Value
end
, }) Tabs.Quests:AddSection('Instinct / Observation') Q = Tabs.Quests:AddToggle({ Name ='Auto Farm Observation', Description ='', Default = false, Callback = function(Value)
_G.obsFarm = Value
end
, }) spawn(function()
while wait(0.2) do
    ...
    if _G.obsFarm then
        ...
        elseif plr:GetAttribute('KenDodgesLeft') > 0 then
            replicated.Remotes.CommE:FireServer('Ken', true) KenTest = true
        end
    end
end
)
    ...
    if _G.obsFarm then
        if World1 then
            if workspace.Enemies:FindFirstChild('Galley Captain') then
                if KenTest then
                    repeat
                        wait() plr.Character.HumanoidRootPart.CFrame = workspace.Enemies:FindFirstChild('Galley Captain').HumanoidRootPart.CFrame * CFrame.new(3, 0, 0)
                    until _G.obsFarm == false or KenTest == false
                else
                    repeat
                        wait() plr.Character.HumanoidRootPart.CFrame = workspace.Enemies:FindFirstChild('Galley Captain').HumanoidRootPart.CFrame * CFrame.new(0, 50, 0)
        ...
        elseif World2 then
            if workspace.Enemies:FindFirstChild('Lava Pirate') then
                if KenTest then
                    repeat
                        wait() plr.Character.HumanoidRootPart.CFrame = workspace.Enemies:FindFirstChild('Lava Pirate').HumanoidRootPart.CFrame * CFrame.new(3, 0, 0)
                    until _G.obsFarm == false or KenTest == false
                else
                    repeat
                        wait() plr.Character.HumanoidRootPart.CFrame = workspace.Enemies:FindFirstChild('Lava Pirate').HumanoidRootPart.CFrame * CFrame.new(0, 50, 0)
                    until _G.obsFarm == false or KenTest
                end
            else
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Observation V2', Description ='', Default = false, Callback = function(Value)
...
while wait(Sec) do
    if _G.AutoKenVTWO then
        ...
        local Kv2Pos2 ='Kuy'local Kv2Pos3 = CFrame.new(- 10920.125, 624.20275878906, - 10266.995117188)
        ...
        if plr.PlayerGui.Main.Quest.Visible == true and string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,'Defeat 50 Forest Pirates') then
            ...
            if v then
                repeat
                    wait() Attack.Kill(v, _G.AutoKenVTWO)
        ...
        elseif plr.PlayerGui.Main.Quest.Visible == false then
            replicated.Remotes.CommF_:InvokeServer('CitizenQuestProgress','Citizen') wait(0.1) replicated.Remotes.CommF_:InvokeServer('StartQuest','CitizenQuest', 1)
        end
        ...
        if not plr.Backpack:FindFirstChild('Fruit Bowl') or not plr.Character:FindFirstChild('Fruit Bowl') then
                ...
                if not GetBP('Apple') then
                    ...
                    for i, v in pairs(workspace:GetDescendants()) do
                        if v.Name =='Apple'then
                            v.Handle.CFrame = plr.Character.HumanoidRootPart.CFrame * CFrame.new(0, 1, 10) wait() firetouchinterest(plr.Character.HumanoidRootPart, v.Handle, 0) wait()
                        end
                    end
            ...
            if plr.Backpack:FindFirstChild('Banana') and plr.Backpack:FindFirstChild('Apple') and plr.Backpack:FindFirstChild('Pineapple') or plr:FindFirstChild('Banana') and plr:FindFirstChild('Apple') and plr:FindFirstChild('Pineapple') then
                repeat
                    wait() _tp(Kv2Pos1)
                until _G.AutoKenVTWO or plr.Character.HumanoidRootPart.CFrame == Kv2Pos1 replicated.Remotes.CommF_:InvokeServer('CitizenQuestProgress','Citizen')
            end
            if plr.Backpack:FindFirstChild('Fruit Bowl') or plr.Character:FindFirstChild('Fruit Bowl') then
                ...
                elseif plr.Character.HumanoidRootPart.CFrame == Kv2Pos3 then
                    replicated.Remotes.CommF_:InvokeServer('KenTalk2','Start') wait(0.1) replicated.Remotes.CommF_:InvokeServer('KenTalk2','Buy')
                end
            end
        end
    end
...
) Bartilo = Tabs.Quests:AddToggle({ Name ='Auto Done Bartilo Quest', Description ='', Default = false, Callback = function(Value)
    ...
    if _G.Bartilo_Quest and Lv > = 850 then
        ...
        if replicated.Remotes.CommF_:InvokeServer('BartiloQuestProgress','Bartilo') == 0 then
            ...
            if Qbart.Visible == true then
                ...
                repeat
                    wait() _tp(CFrame.new(- 461.533203, 72.3478546, 300.311096, 0.050853312, - 0, - 0.998706102, 0, 1, - 0, 0.998706102, 0, 0.050853312))
        ...
        elseif replicated.Remotes.CommF_:InvokeServer('BartiloQuestProgress','Bartilo') == 1 then
            ...
            if je then
                repeat
                    task.wait() Attack.Kill(je, _G.Bartilo_Quest)
        ...
        elseif replicated.Remotes.CommF_:InvokeServer('BartiloQuestProgress','Bartilo') == 2 then
            repeat
                wait() _tp(CFrame.new(- 1830.83972, 10.5578213, 1680.60229, 0.979988456, - 2.02152783e - 8, - 0.199054286, 2.20792113e - 8, 1, 7.1442483e - 9, 0.199054286, - 1.1396243099999999e - 8, 0.979988456))
            until (CFrame.new(- 1830.83972, 10.5578213, 1680.60229, 0.979988456, - 2.02152783e - 8, - 0.199054286, 2.20792113e - 8, 1, 7.1442483e - 9, 0.199054286, - 1.1396243099999999e - 8, 0.979988456).Position - plr.Character.HumanoidRootPart.Position).Magnitude < = 1 or _G.Bartilo_Quest == false wait(0.5) plr.Character.HumanoidRootPart.CFrame = workspace.Map.Dressrosa.BartiloPlates.Plate1.CFrame wait(0.5) plr.Character.HumanoidRootPart.CFrame = workspace.Map.Dressrosa.BartiloPlates.Plate2.CFrame wait(0.5) plr.Character.HumanoidRootPart.CFrame = workspace.Map.Dressrosa.BartiloPlates.Plate3.CFrame wait(0.5) plr.Character.HumanoidRootPart.CFrame = workspace.Map.Dressrosa.BartiloPlates.Plate4.CFrame wait(0.5) plr.Character.HumanoidRootPart.CFrame = workspace.Map.Dressrosa.BartiloPlates.Plate5.CFrame wait(0.5) plr.Character.HumanoidRootPart.CFrame = workspace.Map.Dressrosa.BartiloPlates.Plate6.CFrame wait(0.5) plr.Character.HumanoidRootPart.CFrame = workspace.Map.Dressrosa.BartiloPlates.Plate7.CFrame wait(0.5) plr.Character.HumanoidRootPart.CFrame = workspace.Map.Dressrosa.BartiloPlates.Plate8.CFrame wait(2.5)
        end
    end
end
)
...
) CitizenQ = Tabs.Quests:AddToggle({ Name ='Auto Done Citizen Quest', Description ='', Default = false, Callback = function(Value)
    ...
    if _G.CitizenQuest then
        if Lv > = 1800 and replicated.Remotes.CommF_:InvokeServer('CitizenQuestProgress').KilledBandits == false then
            if string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,'Forest Pirate') and string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,'50') and plr.PlayerGui.Main.Quest.Visible == true then
                ...
                if v then
                    repeat
                        task.wait() Attack.Kill(v, _G.CitizenQuest)
        ...
        elseif Lv > = 1800 and replicated.Remotes.CommF_:InvokeServer('CitizenQuestProgress').KilledBoss == false then
            ...
            if plr.PlayerGui.Main.Quest.Visible and string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,'Captain Elephant') and plr.PlayerGui.Main.Quest.Visible == true then
                ...
                if (CFrame.new(- 12443.8671875, 332.40396118164, - 7675.4892578125).Position - plr.Character.HumanoidRootPart.Position).Magnitude < = 4 then
                    wait(1.5) replicated.Remotes.CommF_:InvokeServer('CitizenQuestProgress','Citizen')
                end
            end
...
) Q = Tabs.Quests:AddToggle({ Name ='Auto Training Dummy', Description ='', Default = false, Callback = function(Value)
_G.DummyMan = Value
end
, }) spawn(function()
while wait(Sec) do
    if _G.DummyMan then
        pcall(function()
        if plr.PlayerGui.Main.Quest.Visible == false then
            local xxx = { [1] ='ArenaTrainer', } replicated:WaitForChild('Remotes'):WaitForChild('CommF_'):InvokeServer(unpack(xxx))
        else
            local v = GetConnectionEnemies('Training Dummy')
            if v then
                repeat
                    wait() Attack.Kill(v, _G.DummyMan)
...
) Tabs.Quests:AddSection('Fighting Melee Styles') SuperHuman = Tabs.Quests:AddToggle({ Name ='Auto Superhuman', Description ='', Default = false, Callback = function(Value)
...
) DeathStep = Tabs.Quests:AddToggle({ Name ='Auto DeathStep', Description ='', Default = false, Callback = function(Value)
        ...
        if plr:FindFirstChild('WeaponAssetCache') then
            if not GetBP('Death Step') then
                ...
                if GetBP('Black Leg') and GetBP('Black Leg').Level.Value > = 400 then
                    replicated.Remotes.CommF_:InvokeServer('BuyDeathStep') _G.Level = false
                ...
                if GetBP('Black Leg') or GetBP('Black Leg').Level.Value > = 400 then
                    if workspace.Map.IceCastle.Hall.LibraryDoor.PhoeyuDoor.Transparency == 0 then
                        if GetBP('Library Key') then
                            repeat
                                wait() _tp(CFrame.new(6371.2001953125, 296.63433837890625, - 6841.18115234375))
                        ...
                        elseif not GetBP('Library Key') then
                            ...
                            if v then
                                repeat
                                    wait() Attack.Kill(v, _G.AutoDeathStep)
...
) SharkManV2 = Tabs.Quests:AddToggle({ Name ='Auto Sharkman Karate', Description ='', Default = false, Callback = function(Value)
        ...
        if plr:FindFirstChild('WeaponAssetCache') then
            if not GetBP('Sharkman Karate') then
                ...
                if GetBP('Fishman Karate') and GetBP('Fishman Karate').Level.Value > = 400 then
                    replicated.Remotes.CommF_:InvokeServer('BuySharkmanKarate') _G.Level = false
                ...
                if GetBP('Fishman Karate') or GetBP('Fishman Karate').Level.Value > = 400 then
                    if GetBP('Water Key') then
                        if string.find(replicated.Remotes.CommF_:InvokeServer('BuySharkmanKarate'),'keys') then
                            if GetBP('Water Key') then
                                repeat
                                    wait() _tp(CFrame.new(- 2604.6958, 239.432526, - 10315.1982, 0.0425701365, 0, - 0.999093413, 0, 1, 0, 0.999093413, 0, 0.0425701365))
                                until not _G.Auto_SharkMan_Karate or (Root.Position == CFrame.new(- 2604.6958, 239.432526, - 10315.1982, 0.0425701365, 0, - 0.999093413, 0, 1, 0, 0.999093413, 0, 0.0425701365).Position) replicated.Remotes.CommF_:InvokeServer('BuySharkmanKarate')
                            end
                        end
                    elseif not GetBP('Water Key') then
                        ...
                        if v then
                            repeat
                                wait() Attack.Kill(v, _G.Auto_SharkMan_Karate)
...
) ElectricClaw = Tabs.Quests:AddToggle({ Name ='Auto ElectricClaw', Description ='', Default = false, Callback = function(Value)
    ...
    if _G.Auto_Electric_Claw then
        ...
        if plr:FindFirstChild('WeaponAssetCache') then
            ...
            elseif GetBP('Electro') and GetBP('Electro').Level.Value < 400 then
                ...
                until not _G.Auto_Electric_Claw or GetBP('Electric Claw') _G.AutoFarm_Bone = false
            end
        end
    end
    )
...
) DragonTalon = Tabs.Quests:AddToggle({ Name ='Auto DragonTalon', Description ='', Default = false, Callback = function(Value)
    ...
    if _G.AutoDragonTalon then
        ...
        if plr:FindFirstChild('WeaponAssetCache') then
            ...
            if GetBP('Dragon Claw') and GetBP('Dragon Claw').Level.Value > = 400 then
                replicated.Remotes.CommF_:InvokeServer('Bones','Buy', 1, 1) replicated.Remotes.CommF_:InvokeServer('BuyDragonTalon')
            elseif GetBP('Dragon Claw') and GetBP('Dragon Claw').Level.Value < 400 then
                repeat
                    _G.AutoFarm_Bone = true wait()
                until not _G.AutoDragonTalon or GetBP('Dragon Talon') _G.AutoFarm_Bone = false
            end
        end
    end
    )
...
) Godhuman = Tabs.Quests:AddToggle({ Name ='Auto Godhuman', Description ='', Default = false, Callback = function(Value)
...
) SanguineArt = Tabs.Quests:AddToggle({ Name ='Auto SanguineArt', Description ='', Default = false, Callback = function(Value)
_G.Snaguine = Value
end
, }) spawn(function()
while wait(Sec) do
        ...
        if not GetBP('Sanguine Art') then
            ...
            if GetM('Vampire Fang') < = 19 then
                if World2 then
                    ...
                    if n then
                        repeat
                            task.wait() Attack.Kill(n, _G.Snaguine)
            ...
            if GetM('Vampire Fang') > = 20 and GetM('Demonic Wisp') > = 20 and GetM('Dark Fragment') < = 1 then
                if World2 then
                    ...
                    if n then
                        repeat
                            task.wait() Attack.Kill(black, _G.Snaguine)
...
local Ismirage = Tabs.Race:AddParagraph('Mirage Island Status','') spawn(function()
while wait(0.2) do
...
while wait(0.2) do
    pcall(function()
    local moon8 ='http://www.roblox.com/asset/?id=9709150401'local moon7 ='http://www.roblox.com/asset/?id=9709150086'local moon6 ='http://www.roblox.com/asset/?id=9709149680'local moon5 ='http://www.roblox.com/asset/?id=9709149431'local moon4 ='http://www.roblox.com/asset/?id=9709149052'local moon3 ='http://www.roblox.com/asset/?id=9709143733'local moon2 ='http://www.roblox.com/asset/?id=9709139597'local moon1 ='http://www.roblox.com/asset/?id=9709135895'local moon = Getmoon()
    if moon == moon1 then
...
) Tabs.Race:AddToggle({ Name ='Auto Find Mirage Island', Description ='', Default = false, Callback = function(Value)
_G.FindMirage = Value
end
, }) spawn(function()
while wait() do
    if _G.FindMirage then
        ...
        if not workspace['_WorldOrigin'].Locations:FindFirstChild('Mirage Island', true) then
            ...
            if not myBoat then
                local buyBoatCFrame = CFrame.new(- 16927.451, 9.086, 433.864) TeleportToTarget(buyBoatCFrame)
                ...
                if plr.Character.Humanoid.Sit == false then
                    local boatSeatCFrame = myBoat.VehicleSeat.CFrame * CFrame.new(0, 1, 0) _tp(boatSeatCFrame)
                else
                    repeat
                        wait()
...
) Tabs.Race:AddToggle({ Name ='Esp Mirage Island', Description ='', Value = false, Callback = function(Value)
...
, }) Tabs.Race:AddToggle({ Name ='Auto Tween To Mirage Island', Description ='', Default = false, Callback = function(Value)
...
) Tabs.Race:AddToggle({ Name ='Auto Tween To Highest Point', Description ='', Default = false, Callback = function(Value)
...
) Tabs.Race:AddToggle({ Name ='Auto Collect Gear', Description ='', Default = false, Callback = function(Value)
_G.TPGEAR = Value
end
, }) spawn(function()
pcall(function()
...
) Tabs.Race:AddToggle({ Name ='Change Transparency can see', Description ='', Default = false, Callback = function(Value)
_G.can = Value
end
, }) spawn(function()
pcall(function()
...
) Tabs.Race:AddToggle({ Name ='Auto Tween Advanced Fruit Dealer', Description ='', Default = false, Callback = function(Value)
_G.Addealer = Value
end
, }) spawn(function()
while wait() do
...
) Tabs.Race:AddToggle({ Name ='Auto Collect Mirage Chest', Description ='', Default = false, Callback = function(Value)
_G.FarmChestM = Value
end
, }) spawn(function()
while wait(0.2) do
...
) Tabs.Race:AddButton({ Name ='Talk With Stone', Description ='', Callback = function()
replicated:WaitForChild('Remotes'):WaitForChild('CommF_'):InvokeServer('RaceV4Progress','Begin') replicated:WaitForChild('Remotes'):WaitForChild('CommF_'):InvokeServer('RaceV4Progress','Check') replicated:WaitForChild('Remotes'):WaitForChild('CommF_'):InvokeServer('RaceV4Progress','Teleport') replicated:WaitForChild('Remotes'):WaitForChild('CommF_'):InvokeServer('RaceV4Progress','Continue')
end
, }) Tabs.Race:AddToggle({ Name ='Auto Look At Moon', Description ='', Default = false, Callback = function(Value)
LookM = Value
end
, }) function MoveCamtoMoon()
workspace.CurrentCamera.CFrame = CFrame.new(workspace.CurrentCamera.CFrame.Position, Lighting:GetMoonDirection() + workspace.CurrentCamera.CFrame.Position) plr.Character.HumanoidRootPart.CFrame = CFrame.new(plr.Character.HumanoidRootPart.Position, Lighting:GetMoonDirection() + plr.Character.HumanoidRootPart.CFrame.Position)
end
task.spawn(function()
while task.wait() do
    if LookM then
        MoveCamtoMoon() wait(0.1) replicated.Remotes.CommE:FireServer('ActivateAbility')
    end
end
end
) Tabs.Race:AddToggle({ Name ='Look Moon + Auto V3', Description ='', Default = false, Callback = function(Value)
LookMV3 = Value
end
, }) function MoveCamtoMoon()
local moonDir = Lighting:GetMoonDirection() workspace.CurrentCamera.CFrame = CFrame.new(workspace.CurrentCamera.CFrame.Position, workspace.CurrentCamera.CFrame.Position + moonDir) plr.Character.HumanoidRootPart.CFrame = CFrame.new(plr.Character.HumanoidRootPart.Position, plr.Character.HumanoidRootPart.Position + moonDir)
end
task.spawn(function()
while task.wait(0.1) do
    if LookMV3 then
        MoveCamtoMoon() replicated.Remotes.CommE:FireServer('ActivateAbility') UIS:SendKeyEvent(true,'T', false, game) wait(0.5) UIS:SendKeyEvent(false,'T', false, game)
    end
end
end
) Tabs.Race:AddSection('Upgrade Races V2 And V3') RaceMink = Tabs.Race:AddToggle({ Name ='Auto Upgrade Mink', Description ='', Default = false, Callback = function(Value)
_G.Auto_Mink = Value
end
, }) spawn(function()
while wait(Sec) do
        ...
        if replicated.Remotes.CommF_:InvokeServer('Alchemist','1') ~ = 2 then
            ...
            elseif replicated.Remotes.CommF_:InvokeServer('Alchemist','1') == 1 then
                ...
                elseif not plr.Backpack:FindFirstChild('Flower 3') and not plr.Character:FindFirstChild('Flower 3') then
                    ...
                    if v then
                        repeat
                            wait() Attack.Kill(v, _G.Auto_Mink)
...
) RaceHuman = Tabs.Race:AddToggle({ Name ='Auto Upgrade Human', Description ='', Default = false, Callback = function(Value)
_G.Auto_Human = Value
end
, }) spawn(function()
while wait(Sec) do
        ...
        if replicated.Remotes.CommF_:InvokeServer('Alchemist','1') ~ = - 2 then
            ...
            elseif replicated.Remotes.CommF_:InvokeServer('Alchemist','1') == 1 then
                ...
                elseif not plr.Backpack:FindFirstChild('Flower 3') and not plr.Character:FindFirstChild('Flower 3') then
                    ...
                    if v then
                        repeat
                            wait() Attack.Kill(v, _G.Auto_Human)
...
) RaceSky = Tabs.Race:AddToggle({ Name ='Auto Upgrade Angel', Description ='', Default = false, Callback = function(Value)
        ...
        if replicated.Remotes.CommF_:InvokeServer('Alchemist','1') ~ = - 2 then
            ...
            elseif replicated.Remotes.CommF_:InvokeServer('Alchemist','1') == 1 then
                ...
                elseif not plr.Backpack:FindFirstChild('Flower 3') and not plr.Character:FindFirstChild('Flower 3') then
                    ...
                    if v then
                        repeat
                            wait() Attack.Kill(v, _G.Auto_Skypiea)
        ...
        elseif replicated.Remotes.CommF_:InvokeServer('Wenlocktoad','1') == 1 then
            for i, v in pairs(game.Players:GetChildren()) do
                if v.Name ~ = plr.Name and tostring(v.Data.Race.Value) =='Skypiea'then
                    repeat
                        task.wait() _tp(v.HumanoidRootPart.CFrame * CFrame.new(0, 8, 0) * CFrame.Angles(math.rad(- 45), 0, 0))
...
) RaceFish = Tabs.Race:AddToggle({ Name ='Auto Upgrade FishMan', Description ='', Default = false, Callback = function(Value)
_G.Auto_Fish = Value
end
, }) spawn(function()
while wait(Sec) do
        ...
        if replicated.Remotes.CommF_:InvokeServer('Alchemist','1') ~ = - 2 then
            ...
            elseif replicated.Remotes.CommF_:InvokeServer('Alchemist','1') == 1 then
                ...
                elseif not plr.Backpack:FindFirstChild('Flower 3') and not plr.Character:FindFirstChild('Flower 3') then
                    ...
                    if v then
                        repeat
                            wait() Attack.Kill(v, _G.Auto_Fish)
...
local CheckTier = Tabs.Race:AddParagraph('Tiers V4 Status','') spawn(function()
pcall(function()
while wait(0.2) do
...
) PullLv = Tabs.Race:AddToggle({ Name ='Auto Pull Lever', Description ='', Default = false, Callback = function(Value)
_G.Lver = Value
end
, }) spawn(function()
while wait(Sec) do
...
) Train = Tabs.Race:AddToggle({ Name ='Auto Train V4', Description ='', Default = false, Callback = function(Value)
_G.AcientOne = Value
end
, }) spawn(function()
while wait(Sec) do
    ...
    if _G.AcientOne then
        ...
        for i = 1, #BonesTable do
            if plr.Character:FindFirstChild('RaceEnergy').Value == 1 then
                vim1:SendKeyEvent(true,'Y', false, game) replicated.Remotes.CommF_:InvokeServer('UpgradeRace','Buy') _tp(CFrame.new(- 8987.041015625, 215.862060546875, 5886.71044921875))
            elseif plr.Character:FindFirstChild('RaceTransformed').Value == false then
                local v = GetConnectionEnemies(BonesTable)
                if v then
                    repeat
                        wait() Attack.Kill(v, _G.AcientOne)
...
) Tabs.Race:AddButton({ Name ='Teleport to Temple of Time', Description ='', Callback = function()
...
, }) Tabs.Race:AddButton({ Name ='Teleport to Ancient One', Description ='', Callback = function()
local plr = game:GetService('Players').LocalPlayer
local hrp = plr.Character and plr.Character:FindFirstChild('HumanoidRootPart')
if hrp then
    hrp.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
...
task.wait(2) tween(CFrame.new(28981.552734375, 14888.4267578125, - 120.245849609375))
end
, }) Tabs.Race:AddButton({ Name ='Teleport to Ancient Clock', Description ='', Callback = function()
local plr = game:GetService('Players').LocalPlayer
local hrp = plr.Character and plr.Character:FindFirstChild('HumanoidRootPart')
...
, }) Doors = Tabs.Race:AddToggle({ Name ='Auto Teleport to Race Doors', Description ='', Default = false, Callback = function(Value)
_G.TPDoor = Value
end
, }) spawn(function()
while wait(Sec) do
...
) Trials = Tabs.Race:AddToggle({ Name ='Auto Complete Trial Race', Description ='', Default = false, Callback = function(Value)
    ...
    if _G.Complete_Trials then
        if tostring(plr.Data.Race.Value) =='Fishman'then
            if GetSeaBeastTrial() then
                ...
                ) MousePos = GetSeaBeastTrial().HumanoidRootPart.Position Useskills('Melee','Z') Useskills('Melee','X') Useskills('Melee','C') wait(0.1) Useskills('Sword','Z') Useskills('Sword','X') wait(0.1) Useskills('Blox Fruit','Z') Useskills('Blox Fruit','X') Useskills('Blox Fruit','C') wait(0.1) Useskills('Gun','Z') Useskills('Gun','X')
...
while wait(0.1) do
    ...
    if _G.Complete_Trials then
        if tostring(plr.Data.Race.Value) =='Human'or tostring(plr.Data.Race.Value) =='Ghoul'then
            ...
            if v then
                repeat
                    wait() Attack.Kill(v, _G.Complete_Trials)
...
) AutoKill = Tabs.Race:AddToggle({ Name ='Auto Kill Player After Trial', Description ='', Default = false, Callback = function(Value)
_G.Defeating = Value
end
, }) spawn(function()
while task.wait(Sec) do
        ...
        for _, v in pairs(workspace.Characters:GetChildren()) do
            if v.Name ~ = plr.Name then
                if v.Humanoid.Health > 0 and v:FindFirstChild('HumanoidRootPart') and v.Parent and (Root.Position - v.HumanoidRootPart.Position).Magnitude < = 250 then
                    repeat
                        task.wait() EquipWeapon(_G.SelectWeapon) _tp(v.HumanoidRootPart.CFrame * CFrame.new(0, 0, 15)) sethiddenproperty(plr,'SimulationRadius', math.huge)
...
) Tabs.Prehistoric:AddSection('Dojo Quest') Tabs.Prehistoric:AddButton({ Title ='Teleport To Dragon Dojo', Callback = function()
game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('requestEntrance', Vector3.new(5661.5322265625, 1013.0907592773438, - 334.9649963378906)) topos(CFrame.new(5814.42724609375, 1208.3267822265625, 884.5785522460938))
end
, }) DojoQ = Tabs.Prehistoric:AddToggle({ Name ='Auto Dojo Trainer', Description ='', Default = false, Callback = function(Value)
_G.Dojoo = Value
end
...
while wait(Sec) do
    if _G.Dojoo then
        ...
        if debug == false and not progress and not NameBelt then
            _tp(CFrame.new(5865.0234375, 1208.3154296875, 871.15185546875)) debug = true
        elseif debug == true and (CFrame.new(5865.0234375, 1208.3154296875, 871.15185546875).Position - plr.Character.HumanoidRootPart.Position).Magnitude < = 50 then
            if NameBelt =='White'then
                ...
                if v then
                    repeat
                        task.wait() Attack.Kill(v, _G.Dojoo)
            ...
            elseif NameBelt =='Yellow'then
                ...
                until not _G.Dojoo or not progress _G.SeaBeast1 = false _G.TerrorShark = false _G.Shark = false _G.Piranha = false _G.MobCrew = false _G.FishBoat = false _G.SailBoats = false
            elseif NameBelt =='Green'then
                repeat
                    task.wait() _G.SailBoats = true
                until not _G.Dojoo or not progress _G.SailBoats = false
            elseif NameBelt =='Purple'then
                repeat
                    task.wait() _G.FarmEliteHunt = true
                until not _G.Dojoo or not progress _G.FarmEliteHunt = false
            elseif NameBelt =='Red'then
                repeat
                    task.wait() _G.SailBoats = true _G.FishBoat = true
                until not _G.Dojoo or not progress _G.SailBoats = false _G.FishBoat = false
            elseif NameBelt =='Black'then
                ...
                until not _G.Dojoo or not progress _G.Prehis_Find = false _G.Prehis_Skills = false
        ...
        if not progress then
            debug = false
            local args = { [1] = { ['NPC'] ='Dojo Trainer', ['Command'] ='ClaimQuest', }, } replicated.Modules.Net:FindFirstChild('RF/InteractDragonQuest'):InvokeServer(unpack(args))
        end
    end
    )
end
...
) BlazeEM = Tabs.Prehistoric:AddToggle({ Name ='Auto Dragon Hunter', Description ='', Default = false, Callback = function(Value)
_G.FarmBlazeEM = Value
end
, }) checkQuesta = function()
local a = { [1] = { ['Context'] ='Check', }, }
local b = nil pcall(function()
local c = { [1] = { ['Context'] ='RequestQuest', }, } game:GetService('ReplicatedStorage'):WaitForChild('Modules'):WaitForChild('Net'):WaitForChild('RF/DragonHunter'):InvokeServer(unpack(c))
end
)
...
if b then
    if b.Text then
        ...
        if string.find(tostring(j),'Defeat') then
            i = 1 g = string.sub(tostring(j), 8, 9) g = tonumber(g)
        ...
        if a == true and not BackTODoJo() then
            if x == 1 then
                if v =='Hydra Enforcer'or v =='Venomous Assailant'then
                    repeat
                        wait() DragonMobClear(true, v, CFrame.new(4620.61572265625, 1002.2954711914063, 399.0868835449219))
            ...
            elseif x == 2 then
                if workspace.Map.Waterfall.IslandModel:FindFirstChild('Meshes/bambootree', true) then
                    ...
                    if (workspace.Map.Waterfall.IslandModel:FindFirstChild('Meshes/bambootree', true).Position - Root.Position).Magnitude < = 200 then
                        MousePos = workspace.Map.Waterfall.IslandModel:FindFirstChild('Meshes/bambootree', true).Position Useskills('Melee','Z') Useskills('Melee','X') Useskills('Melee','C') wait(0.5) Useskills('Sword','Z') Useskills('Sword','X') wait(0.5) Useskills('Blox Fruit','Z') Useskills('Blox Fruit','X') Useskills('Blox Fruit','C') wait(0.5) Useskills('Gun','Z') Useskills('Gun','X')
                    end
                until not _G.FarmBlazeEM or not a or BackTODoJo()
            end
        end
...
) Tabs.Prehistoric:AddSection('Drago Trial') GetQuestDracoLevel = function()
...
Toggle = Tabs.Prehistoric:AddToggle({ Name ='Tween To Upgrade Droco Trial', Description ='', Default = false, Callback = function(Value)
_G.UPGDrago = Value
end
, }) spawn(function()
while wait(Sec) do
    ...
    if _G.UPGDrago then
        ...
        elseif GetQuestDracoLevel() == true then
            if (CFrame.new(5814.42724609375, 1208.3267822265625, 884.5785522460938).Position - Root.Position).Magnitude > = 300 then
                ...
                _tp(CFrame.new(5814.42724609375, 1208.3267822265625, 884.5785522460938))
                local v371 = { [1] = { NPC ='Dragon Wizard', Command ='Upgrade', }, } replicated.Modules.Net:FindFirstChild('RF/InteractDragonQuest'):InvokeServer(unpack(v371))
            end
        end
    end
end
...
) Toggle = Tabs.Prehistoric:AddToggle({ Name ='Auto Drago (V1)', Description ='', Default = false, Callback = function(Value)
_G.DragoV1 = Value
end
, }) spawn(function()
while wait(Sec) do
    ...
    if _G.DragoV1 then
        if GetM('Dragon Egg') < = 0 then
            ...
            until not _G.DragoV1 or GetM('Dragon Egg') > = 1 _G.Prehis_Find = false _G.Prehis_Skills = false _G.Prehis_DE = false
        end
    end
end
)
...
) fireflower = Tabs.Prehistoric:AddToggle({ Name ='Auto Drago (V2)', Description ='', Default = false, Callback = function(Value)
...
while wait(Sec) do
    if _G.AutoFireFlowers then
        ...
        if v then
            repeat
                wait() Attack.Kill(v, _G.AutoFireFlowers)
...
) Toggle = Tabs.Prehistoric:AddToggle({ Name ='Auto Drago (V3)', Description ='', Default = false, Callback = function(Value)
_G.DragoV3 = Value
end
, }) spawn(function()
while wait(Sec) do
    ...
    if _G.DragoV3 then
        ...
        until not _G.DragoV3 _G.DangerSc ='Lv 1'_G.SailBoats = false _G.TerrorShark = false
    end
end
)
end
end
) Toggle = Tabs.Prehistoric:AddToggle({ Name ='Auto Relic Drago Trial [Beta]', Description ='', Default = false, Callback = function(Value)
_G.Relic123 = Value
end
, }) spawn(function()
while wait(Sec) do
    if _G.Relic123 then
        ...
        if workspace.Map:FindFirstChild('DracoTrial') then
            replicated.Remotes.DracoTrial:InvokeServer() wait(0.5) repeat
            wait() _tp(CFrame.new(- 39934.9765625, 10685.359375, 22999.34375))
        until not _G.Relic123 or (Root.Position == CFrame.new(- 39934.9765625, 10685.359375, 22999.34375).Position) repeat
        wait() _tp(CFrame.new(- 40511.25390625, 9376.4013671875, 23458.37890625))
    until not _G.Relic123 or (Root.Position == CFrame.new(- 40511.25390625, 9376.4013671875, 23458.37890625).Position) wait(2.5) repeat
    wait() _tp(CFrame.new(- 39914.65625, 10685.384765625, 23000.177734375))
until not _G.Relic123 or (Root.Position == CFrame.new(- 39914.65625, 10685.384765625, 23000.177734375).Position) repeat
wait() _tp(CFrame.new(- 40045.83203125, 9376.3984375, 22791.287109375))
until not _G.Relic123 or (Root.Position == CFrame.new(- 40045.83203125, 9376.3984375, 22791.287109375).Position) wait(2.5) repeat
wait() _tp(CFrame.new(- 39908.5, 10685.4052734375, 22990.04296875))
until not _G.Relic123 or (Root.Position == CFrame.new(- 39908.5, 10685.4052734375, 22990.04296875).Position) repeat
...
) Toggle = Tabs.Prehistoric:AddToggle({ Name ='Auto Train Drago v4', Description ='', Default = false, Callback = function(Value)
_G.TrainDrago = Value
end
, }) spawn(function()
while wait(Sec) do
    ...
    if _G.TrainDrago then
        ...
        for i = 1, #DragoM do
            if plr.Character:FindFirstChild('RaceEnergy').Value == 1 then
                vim1:SendKeyEvent(true,'Y', false, game) replicated.Remotes.CommF_:InvokeServer('UpgradeRace','Buy', 2) _tp(CFrame.new(4620.61572265625, 1002.2954711914063, 399.0868835449219))
            elseif plr.Character:FindFirstChild('RaceTransformed').Value == false then
                local v = GetConnectionEnemies(DragoM)
                if v then
                    repeat
                        wait() Attack.Kill(v, _G.TrainDrago)
...
) dragoTpVolcano = Tabs.Prehistoric:AddToggle({ Name ='Tween to Drago Trials', Description ='', Default = false, Callback = function(Value)
...
) bdrago = Tabs.Prehistoric:AddToggle({ Name ='Swap Drago Race', Description ='', Default = false, Callback = function(Value)
_G.BuyDrago = Value
end
, }) spawn(function()
while wait(Sec) do
    if _G.BuyDrago then
        ...
        if (CFrame.new(5814.42724609375, 1208.3267822265625, 884.5785522460938).Position - Root.Position).Magnitude > = 300 then
            ...
            _tp(CFrame.new(5814.42724609375, 1208.3267822265625, 884.5785522460938))
            local v371 = { [1] = { NPC ='Dragon Wizard', Command ='DragonRace', }, } replicated.Modules.Net:FindFirstChild('RF/InteractDragonQuest'):InvokeServer(unpack(v371))
        end
    end
    )
end
...
) UpTalon = Tabs.Prehistoric:AddToggle({ Name ='Upgrade Dragon Talon With Uzoth', Description ='', Default = false, Callback = function(Value)
_G.DT_Uzoth = Value
end
, }) spawn(function()
while wait(Sec) do
    if _G.DT_Uzoth then
        local Uz_POS = CFrame.new(5661.89014, 1211.31909, 864.836731, 0.811413169, - 1.36805838e - 8, - 0.584473014, 4.75227395e - 8, 1, 4.25682458e - 8, 0.584473014, - 6.231619659999999e - 8, 0.811413169) _tp(Uz_POS)
        if (Uz_POS.Position - plr.Character.HumanoidRootPart.Position).Magnitude < = 25 then
            local ohTable1 = { ['NPC'] ='Uzoth', ['Command'] ='Upgrade', } replicated.Modules.Net['RF/InteractDragonQuest']:InvokeServer(ohTable1)
        end
    end
end
end
) Tabs.Prehistoric:AddSection('Volcanic Crafting') Tabs.Prehistoric:AddButton({ Name ='Craft Dragonheart', Description ='', Callback = function()
local args = { [1] ='CraftItem', [2] ='Craft', [3] ='Dragonheart', } game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer(unpack(args))
end
, }) Tabs.Prehistoric:AddButton({ Name ='Craft Dragonstorm', Description ='', Callback = function()
local args = { [1] ='CraftItem', [2] ='Craft', [3] ='Dragonstorm', } game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer(unpack(args))
end
, }) Tabs.Prehistoric:AddButton({ Name ='Craft Dino Hood', Callback = function()
local args = { [1] ='CraftItem', [2] ='Craft', [3] ='DinoHood', } game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer(unpack(args))
end
, }) Tabs.Prehistoric:AddButton({ Name ='Craft T-Rex Skull', Callback = function()
local args = { [1] ='CraftItem', [2] ='Craft', [3] ='TRexSkull', } game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer(unpack(args))
end
, }) Tabs.Prehistoric:AddSection('Prehistoric Island')
local Check_Volcano = Tabs.Prehistoric:AddParagraph('Prehistoric Island Status','') spawn(function()
while wait(0.2) do
    if workspace.Map:FindFirstChild('PrehistoricIsland') or workspace._WorldOrigin.Locations:FindFirstChild('Prehistoric Island') then
...
) Tabs.Prehistoric:AddButton({ Name ='Craft Volcanic Magnet', Callback = function()
local RF = game:GetService('ReplicatedStorage').Modules.Net['RF/Craft'] RF:InvokeServer('PossibleHardcode','Volcanic Magnet')
end
, }) Tabs.Prehistoric:AddToggle({ Name ='Craft Volcanic Magnet', Default = false, Callback = function(Value)
...
while task.wait(0.3) do
    if getgenv().AutoCraftVolcanic then
        pcall(function()
        RF:InvokeServer('PossibleHardcode','Volcanic Magnet')
    end
    ) getgenv().AutoCraftVolcanic = false
end
end
end
) Tabs.Prehistoric:AddToggle({ Name ='Auto Find Prehistoric Island', Description ='', Default = false, Callback = function(Value)
_G.Prehis_Find = Value
end
, })
local targetDestination = nil spawn(function()
while wait(Sec) do
    pcall(function()
    if _G.Prehis_Find then
        ...
        if not prehistoricLoc then
            ...
            if hum.Sit == false then
                local seatCFrame = myBoat.VehicleSeat.CFrame * CFrame.new(0, 1, 0) _tp(seatCFrame)
                return
            end
            local seaCFrame = CFrame.new(- 10000000, 31, 37016.25) targetDestination = seaCFrame
            if CheckEnemiesBoat() or CheckTerrorShark() or CheckPirateGrandBrigade() then
                _tp(CFrame.new(- 10000000, 150, 37016.25))
            else
                _tp(seaCFrame)
            ...
            local stoneHead = prehistoricLoc:FindFirstChild('HeadTeleport', true) or prehistoricLoc:FindFirstChild('Teleport_Head', true) or prehistoricLoc:FindFirstChild('Head', true)
            if stoneHead then
                local headCF = stoneHead.CFrame
                local safePos = headCF.Position - headCF.LookVector * 40 + Vector3.new(0, 20, 0)
                ...
                local safePos = islandPos - dir * 250 + Vector3.new(0, 60, 0) _tp(CFrame.new(safePos))
            end
        end
    end
end
...
) Tabs.Prehistoric:AddToggle({ Name ='Auto Start Prehistoric Event', Default = false, Callback = function(Value)
            ...
            if workspace.Map:FindFirstChild('PrehistoricIsland', true) then
                ...
                if promptPart and promptPart:FindFirstChild('ProximityPrompt') then
                    if plr:DistanceFromCharacter(promptPart.CFrame.Position) < = 150 then
                        fireproximityprompt(promptPart.ProximityPrompt, math.huge) vim1:SendKeyEvent(true,'E', false, game) wait(1.5) vim1:SendKeyEvent(false,'E', false, game)
                    end
...
) Tabs.Prehistoric:AddToggle({ Name ='Auto Patch Prehistoric Event', Description ='', Default = false, Callback = function(Value)
...
while wait(0.3) do
    if _G.Prehis_Skills then
        ...
        for _, v in pairs(island:GetDescendants()) do
            if v.Name =='TouchInterest'and not (trialTeleport and v:IsDescendantOf(trialTeleport)) then
                v.Parent:Destroy()
            end
        end
    end
...
while wait(Sec) do
    if _G.Prehis_Skills then
        ...
        if golem and golem:FindFirstChild('Humanoid') then
            repeat
                wait(0.1) Attack.Kill(golem, true) golem.Humanoid:ChangeState(15)
    ...
    if _G.Prehis_Skills then
        ...
        for _, rock in pairs(rocks:GetChildren()) do
            ...
            if glow and glow.Enabled then
                repeat
                    wait(0.1) _tp(layer.CFrame)
                    if plr:DistanceFromCharacter(layer.CFrame.Position) < = 150 then
                        MousePos = layer.CFrame.Position Useskills('Melee','Z') wait(0.4) Useskills('Melee','X') wait(0.4) Useskills('Melee','C') wait(0.4) Useskills('Blox Fruit','Z') wait(0.4) Useskills('Blox Fruit','X') wait(0.4) Useskills('Blox Fruit','C')
                    end
...
) Kaura = Tabs.Prehistoric:AddToggle({ Name ='Kill Aura', Description ='', Default = false, Callback = function(Value)
_G.KillAuraFull = Value
end
, })
local Range = 500
local Delay = 2 spawn(function()
        ...
        for _, enemy in pairs(workspace.Enemies:GetChildren()) do
            if enemy:FindFirstChild('Humanoid') and enemy:FindFirstChild('HumanoidRootPart') then
                ...
                if dist < = Range and enemy.Humanoid.Health > 0 then
                    enemy.Humanoid.Health = 0 enemy.HumanoidRootPart.CanCollide = false enemy:BreakJoints()
                end
            end
        end
    end
...
) Vocan = Tabs.Prehistoric:AddToggle({ Name ='Auto Collect Dino Bones', Description ='', Default = false, Callback = function(Value)
_G.Prehis_DB = Value
end
, }) spawn(function()
while wait(Sec) do
...
) Vocan = Tabs.Prehistoric:AddToggle({ Name ='Auto Collect Dragon Eggs', Description ='', Default = false, Callback = function(Value)
_G.Prehis_DE = Value
end
, }) spawn(function()
while wait(Sec) do
...
) Toggle = Tabs.Prehistoric:AddToggle({ Name ='Auto Reset When Complete Volcano', Description ='', Default = false, Callback = function(Value)
_G.ResetPH = Value
end
, }) spawn(function()
while wait(Sec) do
...
local ListSeaZone = {'Lv 1','Lv 2','Lv 3','Lv 4','Lv 5','Lv 6','Lv Infinite', } Tabs.SeaEvent:AddButton({ Name ='Remove Lighting Effect', Callback = function()
game:GetService('Lighting').BaseAtmosphere:Destroy()
end
, }) Tabs.SeaEvent:AddToggle({ Name ='Ship Speed Modifier', Default = false, Callback = function(Value)
...
) Tabs.SeaEvent:AddSlider({ Name ='Ship Speed', Min = 0, Max = 1000, Increment = 1, Default = 300, Callback = function(Value)
SetSpeedBoat = Value
end
, }) Tabs.SeaEvent:AddToggle({ Name ='Auto Press W', Default = false, Callback = function(Value)
...
) Tabs.SeaEvent:AddToggle({ Name ='No Clip Ship', Default = false, Callback = function(Value)
...
) Tabs.SeaEvent:AddSection('Crafting Items') Tabs.SeaEvent:AddButton({ Name ='Craft SharkTooth', Description ='', Callback = function()
local args = { [1] ='CraftItem', [2] ='Craft', [3] ='SharkTooth', } game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer(unpack(args))
end
, }) Tabs.SeaEvent:AddButton({ Name ='Craft TerrorJaw', Description ='', Callback = function()
local args = { [1] ='CraftItem', [2] ='Craft', [3] ='TerrorJaw', } game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer(unpack(args))
end
, }) Tabs.SeaEvent:AddButton({ Name ='Craft SharkAnchor', Description ='', Callback = function()
local args = { [1] ='CraftItem', [2] ='Craft', [3] ='SharkAnchor', } game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer(unpack(args))
end
, }) Tabs.SeaEvent:AddButton({ Name ='Craft LeviathanCrown', Description ='', Callback = function()
local args = { [1] ='CraftItem', [2] ='Craft', [3] ='LeviathanCrown', } game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer(unpack(args))
end
, }) Tabs.SeaEvent:AddButton({ Name ='Craft LeviathanShield', Description ='', Callback = function()
local args = { [1] ='CraftItem', [2] ='Craft', [3] ='LeviathanShield', } game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer(unpack(args))
end
, }) Tabs.SeaEvent:AddButton({ Name ='Craft LeviathanBoat', Description ='', Callback = function()
local args = { [1] ='CraftItem', [2] ='Craft', [3] ='LeviathanBoat', } game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer(unpack(args))
end
, }) Tabs.SeaEvent:AddButton({ Name ='Craft LegendaryScroll', Description ='', Callback = function()
local args = { [1] ='CraftItem', [2] ='Craft', [3] ='LegendaryScroll', } game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer(unpack(args))
end
, }) Tabs.SeaEvent:AddButton({ Name ='Craft MythicalScroll', Description ='', Callback = function()
local args = { [1] ='CraftItem', [2] ='Craft', [3] ='MythicalScroll', } game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer(unpack(args))
end
, }) Tabs.SeaEvent:AddSection('Choose Sea Event') Q = Tabs.SeaEvent:AddDropdown({ Name ='Select Boats', Options = ListSeaBoat, Callback = function(Value)
_G.SelectedBoat = Value
end
, }) Tabs.SeaEvent:AddButton({ Name ='Buy Boats', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyBoat', _G.SelectedBoat)
end
, }) Q = Tabs.SeaEvent:AddDropdown({ Name ='Select Sea Level', Options = ListSeaZone, Callback = function(Value)
_G.DangerSc = Value
end
, }) Q = Tabs.SeaEvent:AddToggle({ Name ='Auto Sail Boat', Description ='', Default = false, Callback = function(Value)
_G.SailBoats = Value
end
, }) spawn(function()
while wait() do
...
) Tabs.SeaEvent:AddSection('Entity Sea Event') Tabs.SeaEvent:AddToggle({ Name ='Auto Shark', Description ='', Default = false, Callback = function(Value)
_G.Shark = Value
end
, }) Tabs.SeaEvent:AddToggle({ Name ='Auto Piranha', Description ='', Default = false, Callback = function(Value)
_G.Piranha = Value
end
, }) Tabs.SeaEvent:AddToggle({ Name ='Auto Terror Shark', Description ='', Default = false, Callback = function(Value)
_G.TerrorShark = Value
end
, }) Tabs.SeaEvent:AddToggle({ Name ='Auto Fish Crew Member', Description ='', Default = false, Callback = function(Value)
_G.MobCrew = Value
end
, }) Tabs.SeaEvent:AddToggle({ Name ='Auto Haunted Crew Member', Description ='', Default = false, Callback = function(Value)
_G.HCM = Value
end
, }) Tabs.SeaEvent:AddToggle({ Name ='Auto Attack PirateGrandBrigade', Description ='', Default = false, Callback = function(Value)
_G.PGB = Value
end
, }) Tabs.SeaEvent:AddToggle({ Name ='Auto Attack Fish Boat', Description ='', Default = false, Callback = function(Value)
_G.FishBoat = Value
end
, }) Tabs.SeaEvent:AddToggle({ Name ='Auto Attack Sea Beast', Description ='', Default = false, Callback = function(Value)
_G.SeaBeast1 = Value
end
, }) spawn(function()
while wait() do
            ...
            for b, c in pairs(workspace.Enemies:GetChildren()) do
                if table.find(a, c.Name) then
                    if Attack.Alive(c) then
                        repeat
                            task.wait() Attack.Kill(c, _G.Shark)
        ...
        if CheckTerrorShark() then
            for b, c in pairs(workspace.Enemies:GetChildren()) do
                if table.find(a, c.Name) then
                    if Attack.Alive(c) then
                        repeat
                            task.wait() Attack.KillSea(c, _G.TerrorShark)
        ...
        if CheckPiranha() then
            for b, c in pairs(workspace.Enemies:GetChildren()) do
                if table.find(a, c.Name) then
                    if Attack.Alive(c) then
                        repeat
                            task.wait() Attack.Kill(c, _G.Piranha)
        ...
        if CheckFishCrew() then
            for b, c in pairs(workspace.Enemies:GetChildren()) do
                if table.find(a, c.Name) then
                    if Attack.Alive(c) then
                        repeat
                            task.wait() Attack.Kill(c, _G.MobCrew)
        ...
        if CheckHauntedCrew() then
            for b, c in pairs(workspace.Enemies:GetChildren()) do
                if table.find(a, c.Name) then
                    if Attack.Alive(c) then
                        repeat
                            task.wait() Attack.Kill(c, _G.HCM)
            ...
            for a, b in pairs(workspace.SeaBeasts:GetChildren()) do
                if b:FindFirstChild('HumanoidRootPart') and b:FindFirstChild('Health') and b.Health.Value > 0 then
                    ...
                    if plr:DistanceFromCharacter(b.HumanoidRootPart.CFrame.Position) < = 500 then
                        AitSeaSkill_Custom = b.HumanoidRootPart.CFrame MousePos = AitSeaSkill_Custom.Position
                        if CheckF() then
                            weaponSc('Blox Fruit') Useskills('Blox Fruit','Z') Useskills('Blox Fruit','X') Useskills('Blox Fruit','C')
                        else
                            Useskills('Melee','Z') Useskills('Melee','X') Useskills('Melee','C') wait(0.1) Useskills('Sword','Z') Useskills('Sword','X') wait(0.1) Useskills('Blox Fruit','Z') Useskills('Blox Fruit','X') Useskills('Blox Fruit','C') wait(0.1) Useskills('Gun','Z') Useskills('Gun','X')
                        end
                    end
        ...
        for a, b in pairs(workspace.Enemies:GetChildren()) do
            if b:FindFirstChild('Health') and b.Health.Value > 0 and b:FindFirstChild('VehicleSeat') then
                ...
                if plr:DistanceFromCharacter(b.Engine.CFrame.Position) < = 150 then
                    AitSeaSkill_Custom = b.Engine.CFrame MousePos = AitSeaSkill_Custom.Position
                    if CheckF() then
                        weaponSc('Blox Fruit') Useskills('Blox Fruit','Z') Useskills('Blox Fruit','X') Useskills('Blox Fruit','C')
                    else
                        Useskills('Melee','Z') Useskills('Melee','X') Useskills('Melee','C') wait(0.1) Useskills('Sword','Z') Useskills('Sword','X') wait(0.1) Useskills('Blox Fruit','Z') Useskills('Blox Fruit','X') Useskills('Blox Fruit','C') wait(0.1) Useskills('Gun','Z') Useskills('Gun','X')
...
local Check_Kitsu = Tabs.SeaEvent:AddParagraph('Kitsune Island Status','') spawn(function()
while wait(0.2) do
...
) Tabs.SeaEvent:AddToggle({ Name ='Auto Find Kitsune Island', Description ='', Default = false, Callback = function(Value)
        ...
        if not workspace['_WorldOrigin'].Locations:FindFirstChild('Kitsune Island', true) then
            ...
            if not myBoat then
                ...
                if plr.Character.Humanoid.Sit == false then
                    ...
                    local targetDestination = CFrame.new(- 10000000, 31, 37016.25) repeat
                    wait()
                    if CheckEnemiesBoat() or CheckTerrorShark() or CheckPirateGrandBrigade() then
                        _tp(CFrame.new(- 10000000, 150, 37016.25))
                    else
...
) Tabs.SeaEvent:AddToggle({ Name ='Auto Teleport to Shrine Actived', Description ='', Default = false, Callback = function(Value)
        ...
        if shrineActive then
            for _, v in next, shrineActive:GetDescendants() do
                if v:IsA('BasePart') and v.Name:find('NeonShrinePart') then
                    replicated.Modules.Net:FindFirstChild('RE/TouchKitsuneStatue'):FireServer() repeat
                    wait() _tp(v.CFrame * CFrame.new(0, 2, 0))
...
) Tabs.SeaEvent:AddToggle({ Name ='Auto Collect Azure Ember', Description ='', Default = false, Callback = function(Value)
...
while wait(0.1) do
    if _G.Collect_Ember then
        ...
        if workspace:WaitForChild('AttachedAzureEmber') or workspace:WaitForChild('EmberTemplate') then
            ...
            _tp(workspace._WorldOrigin.Locations:FindFirstChild('Kitsune Island').CFrame * CFrame.new(0, 500, 0)) replicated.Modules.Net['RF/KitsuneStatuePray']:InvokeServer()
        end
    end
    )
end
...
) Tabs.SeaEvent:AddToggle({ Name ='Auto Trade Azure Ember', Description ='', Default = false, Callback = function(Value)
...
) Tabs.SeaEvent:AddButton({ Name ='Trade Items Azure', Description ='', Callback = function()
replicated.Modules.Net:FindFirstChild('RF/KitsuneStatuePray'):InvokeServer()
end
, }) Tabs.SeaEvent:AddButton({ Name ='Talk with kitsune statue', Description ='', Callback = function()
replicated.Modules.Net:FindFirstChild('RE/TouchKitsuneStatue'):FireServer()
end
, }) Tabs.SeaEvent:AddSection('Frozen Dimension Event')
local FloD = Tabs.SeaEvent:AddParagraph('FrozenDimension Status','') spawn(function()
pcall(function()
while wait(0.2) do
...
local SPYING = Tabs.SeaEvent:AddParagraph('Spy Status','') spawn(function()
while wait(0.2) do
    pcall(function()
...
) Tabs.SeaEvent:AddButton({ Name ='Buy Spy', Callback = function()
game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('InfoLeviathan','2')
end
, }) Tabs.SeaEvent:AddToggle({ Name ='Auto Teleport Frozen Dimension', Description ='', Default = false, Callback = function(Value)
_G.FrozenTP = Value
end
, }) spawn(function()
while wait(0.1) do
    if _G.FrozenTP then
        ...
        if workspace.Map:FindFirstChild('LeviathanGate') then
            _tp(workspace.Map.LeviathanGate.CFrame) replicated:WaitForChild('Remotes'):WaitForChild('CommF_'):InvokeServer('OpenLeviathanGate')
        end
    end
    )
end
...
) Tabs.SeaEvent:AddToggle({ Name ='Auto Drive To Hydra Island', Description ='', Default = false, Callback = function(Value)
...
) Tabs.SeaEvent:AddToggle({ Name ='Auto Attack Leviathan', Description ='', Default = false, Callback = function(Value)
_G.Leviathan1 = Value
end
, }) Tabs.Esp:AddSection('Esp') function isnil(thing)
return (thing == nil)
end
...
local TeamSelf = plr.Team EspPly = function()
for _, v in next, game.Players:GetChildren() do
    pcall(function()
    if not isnil(v.Character) then
        if PlayerEsp then
            if not isnil(v.Character.Head) and not v.Character.Head:FindFirstChild('NameEsp'.. Number) then
                local bill = Instance.new('BillboardGui', v.Character.Head) bill.Name ='NameEsp'.. Number bill.ExtentsOffset = Vector3.new(0, 1, 0) bill.Size = UDim2.new(1, 200, 1, 30) bill.Adornee = v.Character.Head bill.AlwaysOnTop = true
                local name = Instance.new('TextLabel', bill) name.Font = Enum.Font.Code name.FontSize ='Size14'name.TextWrapped = true name.Text = (v.Name ..' \n'.. round((plr.Character.Head.Position - v.Character.Head.Position).Magnitude / 3) ..' M') name.Size = UDim2.new(1, 0, 1, 0) name.TextYAlignment ='Top'name.BackgroundTransparency = 1 name.TextStrokeTransparency = 0.5
    ...
    if IslandESP then
        if (v.Name ~ ='Sea') then
            if not v:FindFirstChild('NameEsp') then
                local bill = Instance.new('BillboardGui', v) bill.Name ='NameEsp'bill.ExtentsOffset = Vector3.new(0, 1, 0) bill.Size = UDim2.new(1, 200, 1, 30) bill.Adornee = v bill.AlwaysOnTop = true
                local name = Instance.new('TextLabel', bill) name.Font = Enum.Font.Code name.FontSize ='Size14'name.TextWrapped = true name.Size = UDim2.new(1, 0, 1, 0) name.TextYAlignment ='Top'name.BackgroundTransparency = 1 name.TextStrokeTransparency = 0.5 name.TextColor3 = Color3.fromRGB(98, 252, 252) name.Text = (v.Name ..'   \n'.. round((plr.Character.Head.Position - v.Position).Magnitude / 3) ..' M')
            else
    ...
    if DevilFruitESP then
        if string.find(v.Name,'Fruit') then
            if not v.Handle:FindFirstChild('NameEsp'.. Number) then
                local bill = Instance.new('BillboardGui', v.Handle) bill.Name ='NameEsp'.. Number bill.ExtentsOffset = Vector3.new(0, 1, 0) bill.Size = UDim2.new(1, 200, 1, 30) bill.Adornee = v.Handle bill.AlwaysOnTop = true
                local name = Instance.new('TextLabel', bill) name.Font = Enum.Font.Code name.FontSize ='Size14'name.TextWrapped = true name.Size = UDim2.new(1, 0, 1, 0) name.TextYAlignment ='Top'name.BackgroundTransparency = 1 name.TextStrokeTransparency = 0.5 name.TextColor3 = Color3.fromRGB(255, 255, 255) name.Text = (v.Name ..' \n'.. round((plr.Character.Head.Position - v.Handle.Position).Magnitude / 3) ..' M')
            else
    ...
    if v.Name =='Flower2'or v.Name =='Flower1'then
        if FlowerESP then
            if not v:FindFirstChild('NameEsp'.. Number) then
                local bill = Instance.new('BillboardGui', v) bill.Name ='NameEsp'.. Number bill.ExtentsOffset = Vector3.new(0, 1, 0) bill.Size = UDim2.new(1, 200, 1, 30) bill.Adornee = v bill.AlwaysOnTop = true
                local name = Instance.new('TextLabel', bill) name.Font = Enum.Font.Code name.FontSize ='Size14'name.TextWrapped = true name.Size = UDim2.new(1, 0, 1, 0) name.TextYAlignment ='Top'name.BackgroundTransparency = 1 name.TextStrokeTransparency = 0.5 name.TextColor3 = Color3.fromRGB(88, 214, 252)
...
for i, v in pairs(workspace._WorldOrigin.Locations:GetChildren()) do
    ...
    if EspEventIsland then
        if (v.Name =='Mirage Island'or v.Name =='Prehistoric Island'or v.Name =='Kitsune Island') then
            if not v:FindFirstChild('NameEsp') then
                local bill = Instance.new('BillboardGui', v) bill.Name ='NameEsp'bill.ExtentsOffset = Vector3.new(0, 1, 0) bill.Size = UDim2.new(1, 200, 1, 30) bill.Adornee = v bill.AlwaysOnTop = true
                local name = Instance.new('TextLabel', bill) name.Font ='Code'name.FontSize ='Size14'name.TextWrapped = true name.Size = UDim2.new(1, 0, 1, 0) name.TextYAlignment ='Top'name.BackgroundTransparency = 1 name.TextStrokeTransparency = 0.5 name.TextColor3 = Color3.fromRGB(80, 245, 245) name.Text = (v.Name ..'   \n'.. round((plr.Character.Head.Position - v.Position).Magnitude / 3) ..' M')
            else
...
for _, v in pairs(workspace.Map.MysticIsland:GetDescendants()) do
    ...
    if ESPGear then
        if v.Name =='Part'and v.Material == Enum.Material.Neon then
            if not v:FindFirstChild('NameEsp') then
                local bill = Instance.new('BillboardGui', v) bill.Name ='NameEsp'bill.ExtentsOffset = Vector3.new(0, 1, 0) bill.Size = UDim2.new(1, 200, 1, 30) bill.Adornee = v bill.AlwaysOnTop = true
                local name = Instance.new('TextLabel', bill) name.Font ='Code'name.FontSize ='Size14'name.TextWrapped = true name.Size = UDim2.new(1, 0, 1, 0) name.TextYAlignment ='Top'name.BackgroundTransparency = 1 name.TextStrokeTransparency = 0.5 name.TextColor3 = Color3.fromRGB(80, 245, 245) name.Text = ('Gear'..'   \n'.. round((plr.Character.Head.Position - v.Position).Magnitude / 3) ..' M')
            else
    ...
    for _, v in pairs(replicated.NPCs:GetChildren()) do
        if v.Name =='Advanced Fruit Dealer'then
            if not workspace:FindFirstChild('Adv') then
                Adv = Instance.new('Part') Adv.Name ='Adv'Adv.Transparency = 1 Adv.Size = Vector3.new(1, 1, 1) Adv.Anchored = true Adv.CanCollide = false Adv.Parent = workspace Adv.CFrame = v.HumanoidRootPart.CFrame
            elseif workspace:FindFirstChild('Adv') then
                if not Adv:FindFirstChild('NameEsp') then
                    local bill = Instance.new('BillboardGui', Adv) bill.Name ='NameEsp'bill.ExtentsOffset = Vector3.new(0, 1, 0) bill.Size = UDim2.new(1, 200, 1, 30) bill.Adornee = Adv bill.AlwaysOnTop = true
    ...
    for _, v in pairs(replicated.NPCs:GetChildren()) do
        if v.Name =='Barista Cousin'then
            if not workspace:FindFirstChild('Gay') then
                Gay = Instance.new('Part') Gay.Name ='Gay'Gay.Transparency = 1 Gay.Size = Vector3.new(1, 1, 1) Gay.Anchored = true Gay.CanCollide = false Gay.Parent = workspace Gay.CFrame = v.HumanoidRootPart.CFrame
            elseif workspace:FindFirstChild('Gay') then
                if not Gay:FindFirstChild('NameEsp') then
                    local bill = Instance.new('BillboardGui', Gay) bill.Name ='NameEsp'bill.ExtentsOffset = Vector3.new(0, 1, 0) bill.Size = UDim2.new(1, 200, 1, 30) bill.Adornee = Gay bill.AlwaysOnTop = true
                    local name = Instance.new('TextLabel', bill) name.Font ='Code'name.FontSize ='Size14'name.TextWrapped = true name.Size = UDim2.new(1, 0, 1, 0) name.TextYAlignment ='Top'name.BackgroundTransparency = 1 name.TextStrokeTransparency = 0.5 name.TextColor3 = Color3.fromRGB(80, 245, 245) name.Text = (v.Name ..'   \n'.. round((plr.Character.Head.Position - v.HumanoidRootPart.Position).Magnitude / 3) ..' M')
                else
    ...
    for _, v in pairs(replicated.NPCs:GetChildren()) do
        if v.Name =='Legendary Sword Dealer'then
            if not workspace:FindFirstChild('Lgd') then
                Lgd = Instance.new('Part') Lgd.Name ='Lgd'Lgd.Transparency = 1 Lgd.Size = Vector3.new(1, 1, 1) Lgd.Anchored = true Lgd.CanCollide = false Lgd.Parent = workspace Lgd.CFrame = v.HumanoidRootPart.CFrame
            elseif workspace:FindFirstChild('Lgd') then
                if not Lgd:FindFirstChild('NameEsp') then
                    local bill = Instance.new('BillboardGui', Lgd) bill.Name ='NameEsp'bill.ExtentsOffset = Vector3.new(0, 1, 0) bill.Size = UDim2.new(1, 200, 1, 30) bill.Adornee = Lgd bill.AlwaysOnTop = true
                    local name = Instance.new('TextLabel', bill) name.Font ='Code'name.FontSize ='Size14'name.TextWrapped = true name.Size = UDim2.new(1, 0, 1, 0) name.TextYAlignment ='Top'name.BackgroundTransparency = 1 name.TextStrokeTransparency = 0.5 name.TextColor3 = Color3.fromRGB(80, 245, 245) name.Text = (v.Name ..'   \n'.. round((plr.Character.Head.Position - v.HumanoidRootPart.Position).Magnitude / 3) ..' M')
                else
...
if ChestESP then
    ...
    for _, Chest in ipairs(Chests) do
        ...
        if not existingEsp then
            local attachment = Instance.new('Attachment') attachment.Name ='ChestEspAttachment'attachment.Parent = Chest attachment.Position = Vector3.new(0, 3, 0)
            local nameEsp = Instance.new('BillboardGui') nameEsp.Name ='NameEsp'nameEsp.Size = UDim2.new(0, 200, 0, 30) nameEsp.Adornee = attachment nameEsp.ExtentsOffset = Vector3.new(0, 1, 0) nameEsp.AlwaysOnTop = true nameEsp.Parent = attachment
            local nameLabel = Instance.new('TextLabel') nameLabel.Font = Enum.Font.Code nameLabel.TextSize = 14 nameLabel.TextWrapped = true nameLabel.Size = UDim2.new(1, 0, 1, 0) nameLabel.TextYAlignment = Enum.TextYAlignment.Top nameLabel.BackgroundTransparency = 1 nameLabel.TextStrokeTransparency = 0.5 nameLabel.TextColor3 = Color3.fromRGB(80, 245, 245) nameLabel.Parent = nameEsp
        end
        local nameEsp = existingEsp and existingEsp:FindFirstChild('NameEsp')
        if nameEsp then
            local displayDistance = math.floor(distanceMagnitude / 3)
            local chestName = Chest.Name:gsub('Label','') nameEsp.TextLabel.Text = string.format('[%s] %d M', chestName, displayDistance)
        end
    end
    )
end
    ...
    for _, Bush in ipairs(BerryBushes) do
        ...
        for _, BerryName in pairs(Bush:GetAttributes()) do
            if BerryName then
                ...
                if not existingEsp then
                    existingEsp = Instance.new('Part') existingEsp.Name = espPartName existingEsp.Transparency = 1 existingEsp.Size = Vector3.new(1, 1, 1) existingEsp.Anchored = true existingEsp.CanCollide = false existingEsp.Parent = workspace existingEsp.CFrame = CFrame.new(bushPosition)
                end
                if not existingEsp:FindFirstChild('NameEsp') then
                    local nameEsp = Instance.new('BillboardGui', existingEsp) nameEsp.Name ='NameEsp'nameEsp.ExtentsOffset = Vector3.new(0, 1, 0) nameEsp.Size = UDim2.new(0, 200, 0, 30) nameEsp.Adornee = existingEsp nameEsp.AlwaysOnTop = true
                    local nameLabel = Instance.new('TextLabel', nameEsp) nameLabel.Font = Enum.Font.Code nameLabel.TextSize = 14 nameLabel.TextWrapped = true nameLabel.Size = UDim2.new(1, 0, 1, 0) nameLabel.TextYAlignment = Enum.TextYAlignment.Top nameLabel.BackgroundTransparency = 1 nameLabel.TextStrokeTransparency = 0.5 nameLabel.TextColor3 = Color3.fromRGB(80, 245, 245)
                end
...
Tabs.Esp:AddToggle({ Name ='Esp Berry', Description ='', Default = false, Callback = function(Value)
BerryEsp = Value
if not Value then
    for _, v in ipairs(workspace:GetChildren()) do
        if v:IsA('Part') and v.Name:match('BerryEspPart_.*') then
    ...
    task.spawn(function()
    while BerryEsp do
        berriesEsp() task.wait()
    end
end
)
end
end
, }) Tabs.Esp:AddToggle({ Name ='Esp Player', Description ='', Default = false, Callback = function(Value)
PlayerEsp = Value
if not Value then
    for _, v in next, game.Players:GetChildren() do
        pcall(function()
...
, }) Tabs.Esp:AddToggle({ Name ='Esp Chest', Description ='', Default = false, Callback = function(Value)
ChestESP = Value
if not Value then
    for _, Chest in ipairs(game:GetService('CollectionService'):GetTagged('_ChestTagged')) do
        local espAttachment = Chest:FindFirstChild('ChestEspAttachment')
...
, }) Tabs.Esp:AddToggle({ Name ='Esp Fruit', Description ='', Default = false, Callback = function(Value)
DevilFruitESP = Value
if not Value then
    for i, v in next, workspace:GetChildren() do
        pcall(function()
...
, }) Tabs.Esp:AddToggle({ Name ='Esp Island', Description ='', Default = false, Callback = function(Value)
IslandESP = Value
if not Value then
    for _, v in next, workspace['_WorldOrigin'].Locations:GetChildren() do
        pcall(function()
    ...
    task.spawn(function()
    while IslandESP do
        LocationEsp() task.wait()
    end
end
)
end
end
, }) Tabs.Esp:AddToggle({ Name ='Esp Flower', Description ='', Default = false, Callback = function(Value)
FlowerESP = Value
if not Value then
    for i, v in pairs(workspace:GetChildren()) do
        pcall(function()
...
, }) Tabs.Esp:AddToggle({ Name ='Esp Legendary Sword', Description ='', Default = false, Callback = function(Value)
LegenS = Value
if not Value then
    if workspace:FindFirstChild('Lgd') then
        workspace:FindFirstChild('Lgd'):Destroy()
    ...
    task.spawn(function()
    while LegenS do
        LegenSword() task.wait()
    end
end
)
end
end
, }) Tabs.Esp:AddToggle({ Name ='Esp Haki Color', Description ='', Default = false, Callback = function(Value)
ColorEsp = Value
if not Value then
    if workspace:FindFirstChild('Gay') then
        workspace:FindFirstChild('Gay'):Destroy()
    ...
    task.spawn(function()
    while ColorEsp do
        HakiClorEsp() task.wait()
    end
end
)
end
end
, }) Tabs.Esp:AddToggle({ Name ='Esp Gear', Description ='', Default = false, Callback = function(Value)
ESPGear = Value
if not Value then
    for _, v in pairs(workspace.Map.MysticIsland:GetDescendants()) do
        pcall(function()
...
, }) Tabs.Esp:AddToggle({ Name ='Esp SeaEvent Island', Description ='', Default = false, Callback = function(Value)
...
if not Value then
    ...
    while EspEventIsland do
        EventIslandEsp() task.wait()
    end
end
)
end
end
, }) Tabs.Esp:AddToggle({ Name ='Esp Advanced Dealer', Description ='', Default = false, Callback = function(Value)
advanEsp = Value
if not Value then
    if workspace:FindFirstChild('Adv') then
        workspace:FindFirstChild('Adv'):Destroy()
...
local str = tostring(number) repeat
local replaced, count = str:gsub('^(-?%d+)(%d%d%d)','%1,%2') str = replaced
until count == 0
return str
end
...
if not success or not advanceFruits then
    ...
    for _, fruit in pairs(advanceFruits) do
        if fruit.OnSale then
            hasFruit = true resultStr = resultStr .. fruit.Name ..' - $'.. formatNumber(fruit.Price) ..'\n'end
        end
    ...
    if success2 and normalFruits then
        ...
        for _, fruit in pairs(normalFruits) do
            ...
            local stockParagraph = Tabs.Raids:AddParagraph('Stock Fruit','Loading...') task.spawn(function()
...
) RandomFF = Tabs.Raids:AddToggle({ Name ='Auto Random Fruit', Description ='', Default = false, Callback = function(Value)
...
) DropF = Tabs.Raids:AddToggle({ Name ='Auto Drop Fruit', Description ='', Default = false, Callback = function(Value)
_G.DropFruit = Value
end
, }) spawn(function()
while wait(Sec) do
...
) StoredF = Tabs.Raids:AddToggle({ Name ='Auto Store Fruit', Description ='', Default = false, Callback = function(Value)
_G.StoreF = Value
end
, }) spawn(function()
while wait(Sec) do
...
) TwF = Tabs.Raids:AddToggle({ Name ='Auto Tween to Fruit', Description ='', Default = false, Callback = function(Value)
_G.TwFruits = Value
end
, }) spawn(function()
while wait(Sec) do
...
) BringF = Tabs.Raids:AddToggle({ Name ='Auto Collect Fruit', Description ='', Default = false, Callback = function(Value)
_G.InstanceF = Value
end
, }) spawn(function()
while wait(Sec) do
...
) Tabs.Raids:AddDropdown({ Name ='Select Fruit Shop', Options = {'Rocket-Rocket','Spin-Spin','Blade-Blade','Spring-Spring','Bomb-Bomb','Smoke-Smoke','Spike-Spike','Flame-Flame','Ice-Ice','Sand-Sand','Dark-Dark','Eagle-Eagle','Diamond-Diamond','Light-Light','Rubber-Rubber','Ghost-Ghost','Magma-Magma','Quake-Quake','Buddha-Buddha','Love-Love','Creation-Creation','Spider-Spider','Sound-Sound','Phoenix-Phoenix','Portal-Portal','Lightning-Lightning','Pain-Pain','Blizzard-Blizzard','Gravity-Gravity','T-Rex-T-Rex','Mammoth-Mammoth','Dough-Dough','Shadow-Shadow','Venom-Venom','Gas-Gas','Control-Control','Spirit-Spirit','Leopard-Leopard','Yeti-Yeti','Kitsune-Kitsune','Dragon-Dragon', }, Callback = function(Value)
getgenv().SelectFruit = Value
end
, }) Tabs.Raids:AddToggle({ Name ='Auto Buy Fruit Shop', Default = false, Callback = function(Value)
...
while wait() do
    if getgenv().AutoBuyFruitSniper then
        game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('GetFruits') game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('PurchaseRawFruit', getgenv().SelectFruit)
    end
end
end
)
end
) Tabs.Raids:AddSection('Dungeon Event / Raiding') DungeonTables = {'Flame','Ice','Quake','Light','Dark','String','Rumble','Magma','Human: Buddha','Sand','Bird: Phoenix','Dough', } Q = Tabs.Raids:AddDropdown({ Name ='Select Chip', Description ='', Options = DungeonTables, Callback = function(Value)
_G.SelectChip = Value
end
, }) Q = Tabs.Raids:AddToggle({ Name ='Auto Select Dungeon Chip', Description ='', Default = false, Callback = function(Value)
_G.AutoSelectDungeon = Value
end
, }) Tabs.Raids:AddToggle({ Name ='Get Fruit In Inventory Below 1M', Default = false, Callback = function(Value)
...
while wait() do
    ...
    if getgenv().AutoGetFruit then
        ...
        for _, fruit in ipairs(fruits) do
            local args = { [1] ='LoadFruit', [2] = fruit, } game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer(unpack(args))
        end
    end
end
)
...
) Tabs.Raids:AddButton({ Name ='Buy Dungeon Chips [Beli]', Description ='', Callback = function()
if not GetBP('Special Microchip') then
    replicated.Remotes.CommF_:InvokeServer('RaidsNpc','Select', _G.SelectChip)
end
end
, }) Tabs.Raids:AddButton({ Name ='Buy Dungeon Chips [Devil Fruit]', Description ='', Callback = function()
...
for _, y in pairs(FruitPrice) do
    for i, v in pairs(DungeonTables) do
        if not GetBP('Special Microchip') then
            replicated.Remotes.CommF_:InvokeServer('LoadFruit', tostring(y)) replicated.Remotes.CommF_:InvokeServer('RaidsNpc','Select', _G.SelectChip)
        end
    end
end
end
, }) AutoChipBeli = Tabs.Raids:AddToggle({ Name ='Auto Buy Chip [Beli]', Description ='', Default = false, Callback = function(Value)
...
) AutoChipFruit = Tabs.Raids:AddToggle({ Name ='Auto Buy Chip [Devil Fruit]', Description ='', Default = false, Callback = function(Value)
        ...
        if not GetBP('Special Microchip') then
            ...
            for _, data in pairs(fruits) do
                if data.Price < = 490000 then
                    cheapest = data.Name break
                end
            end
            if cheapest then
                replicated.Remotes.CommF_:InvokeServer('LoadFruit', tostring(cheapest)) replicated.Remotes.CommF_:InvokeServer('RaidsNpc','Select', _G.SelectChip)
            end
        end
    end
    )
...
) StartR = Tabs.Raids:AddToggle({ Name ='Auto Start Raid', Description ='', Default = false, Callback = function(Value)
...
while task.wait(Sec) do
    ...
    if not top or top.RaidTimer.Visible then
        return
    end
    if not GetBP('Special Microchip') then
        return
...
) Raiding = Tabs.Raids:AddToggle({ Name ='Auto Raid + Next Island', Description ='', Default = false, Callback = function(Value)
_G.Raiding = Value
end
, }) spawn(function()
local locations = workspace['_WorldOrigin'].Locations
...
while task.wait(0.3) do
    ...
    if hum.Sit or hum.PlatformStand or root.Anchored then
        continue
    end
    ...
    for _, name in ipairs(islands) do
        ...
        if loc then
            ...
            if dist < closestDist then
                closestDist = dist currentIsland = name
            end
        end
    end
    ...
    for _, mob in ipairs(workspace.Enemies:GetChildren()) do
        ...
        if eh and ehrp and eh.Health > 0 then
            if (ehrp.Position - islandPos.Position).Magnitude < 450 then
                foundEnemies = true repeat
                task.wait() Attack.Kill(mob, _G.Raiding)
...
if not foundEnemies then
    ...
    if idx and islands[idx + 1] then
        ...
        if nxt then
            local safePos = nxt.CFrame * CFrame.new(0, 45, 120) _tp(safePos)
        end
        currentIsland = islands[idx + 1] task.wait(1)
    end
end
end
end
) Tabs.Raids:AddToggle({ Name ='Auto Awakening', Description ='', Default = false, Callback = function(Value)
...
while wait(Sec) do
    ...
    if _G.Auto_Awakener then
        replicated.Remotes.CommF_:InvokeServer('Awakener','Check') replicated.Remotes.CommF_:InvokeServer('Awakener','Awaken')
    end
end
)
end
end
) Tabs.Raids:AddToggle({ Name ='Auto Teleport To Lab', Default = false, Callback = function(Value)
_G.TpLab = Value StopTween(_G.TpLab)
while _G.TpLab do
    wait()
    if _G.TpLab then
...
, }) Tabs.Raids:AddSection('Items Law/Order Sword') Tabs.Raids:AddButton({ Name ='Buy Microchip Law', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BlackbeardReward','Microchip','2')
end
, }) Tabs.Raids:AddButton({ Name ='Start Law Raids', Description ='', Callback = function()
fireclickdetector(workspace.Map.CircleIsland.RaidSummon.Button.Main.ClickDetector)
end
, }) Tabs.Raids:AddToggle({ Name ='Auto Buy Microchip Law', Description ='', Default = false, Callback = function(Value)
...
) Tabs.Raids:AddToggle({ Name ='Auto Start Law Raids', Description ='', Default = false, Callback = function(Value)
...
) Tabs.Raids:AddToggle({ Name ='Auto Kill Law', Description ='', Default = false, Callback = function(Value)
_G.AutoLawKak = Value
end
, }) spawn(function()
while wait(Sec) do
    if _G.AutoLawKak then
        ...
        if v then
            repeat
                task.wait() Attack.Kill(v, _G.AutoLawKak)
...
Tabs.Raids:AddToggle({ Name ='Auto Farm Dungeon', Description ='', Default = false, Callback = function(Value)
_G.AutoFarmDungeon = Value
end
, })
local FARM_RANGE = 5000 spawn(function()
    ...
    for _, mob in pairs(workspace.Enemies:GetChildren()) do
        ...
        if mh and mhrp and mh.Health > 0 then
            ...
            if dist < = FARM_RANGE then
                repeat
                    task.wait() Attack.Kill(mob, true)
                until not _G.AutoFarmDungeon or not mob.Parent or mh.Health < = 0
            end
        end
    end
end
...
) Tabs.Raids:AddToggle({ Name ='TP Exit (1)', Default = false, Callback = function(v)
_G.TPFloor1 = v
end
, })
local tp1Done = false
...
while task.wait(0.3) do
    if not _G.TPFloor1 then
        tp1Done = false continue
    end
    if not tp1Done then
        local root = GetCurrentFloor()
        if root then
            root = root.CFrame * CFrame.new(0, 3, 0) GetHRP().CFrame = root tp1Done = true
        end
    end
end
end
) Tabs.Raids:AddToggle({ Name ='TP Exit (2)', Default = false, Callback = function(v)
_G.TPFloor2 = v
end
, })
local tp2Done = false task.spawn(function()
while task.wait(0.3) do
    if not _G.TPFloor2 then
        tp2Done = false continue
    end
    if tp2Done then
        continue
    end
    ...
    for _, floor in pairs(workspace.Map.Dungeon:GetChildren()) do
        ...
        if ent and ext and ent:FindFirstChild('Root') and ext:FindFirstChild('Root') then
            if (hrp.Position - ent.Root.Position).Magnitude < 100 then
                hrp.CFrame = ext.Root.CFrame * CFrame.new(0, 3, 0) tp2Done = true break
            end
        end
    end
end
end
) Tabs.Raids:AddToggle({ Name ='TP Exit (3)', Default = false, Callback = function(v)
_G.TPFloor3 = v
end
, })
local tp3Done = false
...
while task.wait(0.3) do
    if not _G.TPFloor3 then
        tp3Done = false continue
    end
    if not tp3Done then
        local floor = GetHighestFloor()
        if floor and floor:FindFirstChild('ExitTeleporter') and floor.ExitTeleporter:FindFirstChild('Root') then
            GetHRP().CFrame = floor.ExitTeleporter.Root.CFrame * CFrame.new(0, 3, 0) tp3Done = true
        end
    end
end
end
) Tabs.Raids:AddToggle({ Name ='TP Exit (4)', Default = false, Callback = function(v)
_G.TPFloor4 = v
end
, })
local tp4Done = false
...
while task.wait(0.3) do
    if not _G.TPFloor4 then
        tp4Done = false continue
    end
    if not tp4Done then
        local root = GetNearestExit()
        if root then
            GetHRP().CFrame = root.CFrame * CFrame.new(0, 3, 0) tp4Done = true
        end
    end
end
end
) Tabs.Combat:AddSection('Combat / AimBot')
local __indexPlayer = Tabs.Combat:AddParagraph('All Players On Server','') spawn(function()
while wait(Sec) do
    pcall(function()
...
local __AimBotTurn = Tabs.Combat:AddParagraph('Aimbot Status','') Checking_AimStatus = function()
if _G.AimCam then
    return'Aimbot Camera'elseif _G.AimbotGun then
    return'Aimbot Guns'else
    return''end
end
spawn(function()
while wait(0.2) do
...
Tabs.Combat:AddDropdown({ Name ='Select Players', Description ='', Options = PlrList, Callback = function(Value)
_G.PlayersList = Value
end
, }) Tabs.Combat:AddToggle({ Name ='Teleport To Select Players', Description ='', Default = false, Callback = function(Value)
_G.TpPly = Value spawn(function()
pcall(function()
while _G.TpPly do
...
, }) Tabs.Combat:AddToggle({ Name ='Spectate Select Players', Description ='', Default = false, Callback = function(Value)
SpectatePlys = Value spawn(function()
repeat
    task.wait(0.1)
...
until not SpectatePlys workspace.Camera.CameraSubject = plr.Character.Humanoid
end
)
end
, }) Tabs.Combat:AddDropdown({ Name ='Select Aim Method', Description ='', Options = {'Aim Player','Nearest Aim', }, Callback = function(Value)
ABmethod = Value
end
, }) Tabs.Combat:AddToggle({ Name ='Aimbot Method Skills', Description ='', Default = false, Callback = function(Value)
_G.AimMethod = Value
end
, }) spawn(function()
while wait() do
        ...
        for _, v in pairs(Players:GetPlayers()) do
            if v ~ = plr and v.Team ~ = plr.Team and v.Character and v.Character:FindFirstChild('HumanoidRootPart') then
                ...
                if Distance < MaxDistance then
                    MaxDistance = Distance MousePos = v.Character.HumanoidRootPart.Position
                end
            end
        end
    end
...
) Tabs.Combat:AddToggle({ Name ='Aimbot Camera Closet Players', Description ='', Default = false, Callback = function(Value)
_G.AimCam = Value
end
, }) task.spawn(function()
while task.wait(Sec) do
    pcall(function()
    if _G.AimCam then
        local camera = workspace.CurrentCamera closestplayer = function()
    ...
    repeat
        task.wait() camera.CFrame = CFrame.new(camera.CFrame.Position, closestplayer().Character.HumanoidRootPart.Position)
...
) Tabs.Combat:AddSection('Quests Players') Tabs.Combat:AddButton({ Name ='Get player quests', Description ='', Callback = function()
pcall(function()
game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('PlayerHunter')
end
)
end
, }) Tabs.Combat:AddToggle({ Name ='Auto Get PlayerQuest', Description ='', Default = false, Callback = function(Value)
...
) Tabs.Combat:AddToggle({ Name ='Auto Kill Player Quest', Default = false, Callback = function(Value)
...
while task.wait() do
    if _G.AutoPlayerHunter then
        if game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false then
            task.wait(0.5) game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('PlayerHunter')
        else
            for _, target in pairs(game:GetService('Workspace').Characters:GetChildren()) do
                if string.find(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, target.Name) then
                    repeat
                        ...
                        Useskill = true _tp(target.HumanoidRootPart.CFrame * CFrame.new(1, 7, 3)) target.HumanoidRootPart.Size = Vector3.new(60, 60, 60) game:GetService('VirtualUser'):CaptureController() game:GetService('VirtualUser'):Button1Down(Vector2.new(1280, 672))
                    until _G.AutoPlayerHunter == false or target.Humanoid.Health < = 0 Useskill = false game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('AbandonQuest')
                end
            end
        end
    end
...
) Tabs.Combat:AddToggle({ Name ='Auto Enable PvP', Description ='', Default = false, Callback = function(Value)
_G.AutoPvP = Value
end
, }) spawn(function()
while task.wait(0.5) do
...
) Tabs.Combat:AddToggle({ Name ='Auto Safe Mode', Default = false, Callback = function(Value)
_G.SafeMode = Value
end
, }) spawn(function()
while task.wait(0.1) do
    if _G.SafeMode then
        ...
        local hrp = char and char:FindFirstChild('HumanoidRootPart')
        if hrp then
            local targetPos = hrp.CFrame * CFrame.new(0, 1000, 0) _tp(targetPos)
        end
    end
end
end
...
local moveDirection = humanoid.MoveDirection ctrl.f = 0 ctrl.b = 0 ctrl.l = 0 ctrl.r = 0
...
local controlConnection controlConnection = RunService.Heartbeat:Connect(function()
if flying then
...
if flying then
    ...
    local descendantAddedConnection descendantAddedConnection = player.Character.DescendantAdded:Connect(function(descendant)
    if flying and descendant:IsA('BasePart') then
        descendant.CanCollide = false descendant.Massless = true
    end
end
) bg = Instance.new('BodyGyro', rootPart) bg.P = 9e4 bg.maxTorque = Vector3.new(9e9, 9e9, 9e9) bg.cframe = rootPart.CFrame bv = Instance.new('BodyVelocity', rootPart) bv.velocity = Vector3.new(0, 0, 0) bv.maxForce = Vector3.new(9e9, 9e9, 9e9) humanoid.PlatformStand = true setupMobileControls() flyConnection = RunService.Heartbeat:Connect(function()
...
bg.cframe = workspace.CurrentCamera.CoordinateFrame
    ...
    if player.Character then
        ...
        for _, part in ipairs(player.Character:GetDescendants()) do
            if part:IsA('BasePart') then
                part.CanCollide = true part.Massless = false
            end
        end
        if bg then
            bg:Destroy()
...
wait(1)
if flying then
    toggleFly(false) wait(0.1) toggleFly(true)
end
end
) Tabs.Combat:AddToggle({ Name ='Enable Fly', Default = false, Callback = function(Value)
toggleFly(Value)
end
, }) Tabs.Combat:AddSlider({ Name ='Speed Fly Mode', Min = 10, Max = 200, Default = 50, Callback = function(Value)
updateFlySpeed(Value)
end
, }) Tabs.Combat:AddToggle({ Name ='Dash No Cooldown', Default = false, Callback = function(Value)
...
Tabs.Combat:AddToggle({ Name ='Instance Mink V3 [ INF ]', Description ='', Default = false, Callback = function(Value)
InfAblities = Value
end
, }) spawn(function()
while wait(0.2) do
    ...
    if InfAblities then
        if not plr.Character.HumanoidRootPart:FindFirstChild('Agility') then
            local agility = replicated.FX['Agility']:Clone() agility.Name ='Agility'agility.Parent = plr.Character.HumanoidRootPart
        end
    else
...
) Tabs.Combat:AddToggle({ Name ='Instance Energy [ INF ]', Description ='', Default = false, Callback = function(Value)
infEnergy = Value
if Value then
    getInfinity_Ability('Energy', infEnergy)
end
end
, }) Tabs.Combat:AddToggle({ Name ='Instance Soru [ INF ]', Description ='', Default = false, Callback = function(Value)
_G.InfSoru = Value
if Value then
    getInfinity_Ability('Soru', _G.InfSoru)
end
end
, }) Tabs.Combat:AddToggle({ Name ='Instance Observation Range [ INF ]', Description ='', Default = false, Callback = function(Value)
_G.InfiniteObRange = Value
if Value then
    getInfinity_Ability('Observation', _G.InfiniteObRange)
end
end
, }) Tabs.Combat:AddToggle({ Name ='Ignore Same Teams', Description ='', Default = false, Callback = function(Value)
_G.NoAimTeam = Value
end
, }) Tabs.Combat:AddToggle({ Name ='Accept Allies', Description ='', Default = false, Callback = function(Value)
_G.AcceptAlly = Value
end
, }) spawn(function()
while wait(Sec) do
...
) Tabs.Travel:AddSection('Travel - Worlds') Tabs.Travel:AddButton({ Name ='Travel East Blue (World 1)', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('TravelMain')
end
, }) Tabs.Travel:AddButton({ Name ='Travel Dressrosa (World 2)', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('TravelDressrosa')
end
, }) Tabs.Travel:AddButton({ Name ='Travel Zou (World 3)', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('TravelZou')
end
, }) Tabs.Travel:AddSection('Travel - Island') Location = {}
for i, v in pairs(workspace['_WorldOrigin'].Locations:GetChildren()) do
    table.insert(Location, v.Name)
end
Travelllll = Tabs.Travel:AddDropdown({ Name ='Select Travelling', Description ='', Options = Location, Callback = function(Value)
_G.Island = Value
end
, }) GoIsland = Tabs.Travel:AddToggle({ Name ='Auto Travel', Description ='', Default = false, Callback = function(Value)
_G.Teleport = Value
if Value then
    for i, v in pairs(workspace['_WorldOrigin'].Locations:GetChildren()) do
        if v.Name == _G.Island then
            repeat
                wait() _tp(v.CFrame * CFrame.new(0, 30, 0))
...
PortalTP = Tabs.Travel:AddDropdown({ Name ='Select Portal', Options = Location_Portal, Callback = function(Value)
_G.Island_PT = Value
end
, }) Tabs.Travel:AddButton({ Name ='requestEntrance', Description ='', Callback = function()
...
NPCsPos = Tabs.Travel:AddDropdown({ Name ='Select NPCs', Options = NPCList, Callback = function(Value)
NPClist = Value
end
, }) GoNPCs = Tabs.Travel:AddToggle({ Name ='Auto Tween to NPC', Description ='', Default = false, Callback = function(Value)
_G.TPNpc = Value
end
, }) spawn(function()
while wait(Sec) do
...
) Tabs.Shop:AddSection('Shop Options') Tabs.Shop:AddButton({ Name ='Buy Buso', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyHaki','Buso')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Geppo', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyHaki','Geppo')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Soru', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyHaki','Soru')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Ken', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('KenTalk','Buy')
end
, }) Tabs.Shop:AddSection('Fighting - Style') Tabs.Shop:AddButton({ Name ='Buy Black Leg', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyBlackLeg')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Electro', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyElectro')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Fishman Karate', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyFishmanKarate')
end
, }) Tabs.Shop:AddButton({ Name ='Buy DragonClaw', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BlackbeardReward','DragonClaw','2')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Superhuman', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuySuperhuman')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Death Step', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyDeathStep')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Sharkman Karate', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuySharkmanKarate')
end
, }) Tabs.Shop:AddButton({ Name ='Buy ElectricClaw', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyElectricClaw')
end
, }) Tabs.Shop:AddButton({ Name ='Buy DragonTalon', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyDragonTalon')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Godhuman', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyGodhuman')
end
, }) Tabs.Shop:AddButton({ Name ='Buy SanguineArt', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuySanguineArt')
end
, }) Tabs.Shop:AddSection('Accessory') Tabs.Shop:AddButton({ Name ='Buy Tomoe Ring', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyItem','Tomoe Ring')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Black Cape', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyItem','Black Cape')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Swordsman Hat', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyItem','Swordsman Hat')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Bizarre Rifle', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('Ectoplasm','Buy', 1)
end
, }) Tabs.Shop:AddButton({ Name ='Buy Ghoul Mask', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('Ectoplasm','Buy', 2)
end
, }) Tabs.Shop:AddSection('Weapon World1') Tabs.Shop:AddButton({ Name ='Buy Cutlass', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyItem','Cutlass')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Katana', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyItem','Katana')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Iron Mace', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyItem','Iron Mace')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Duel Katana', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyItem','Duel Katana')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Triple Katana', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyItem','Triple Katana')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Pipe', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyItem','Pipe')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Dual-Headed Blade', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyItem','Dual-Headed Blade')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Bisento', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyItem','Bisento')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Soul Cane', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyItem','Soul Cane')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Slingshot', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyItem','Slingshot')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Musket', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyItem','Musket')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Dual Flintlock', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyItem','Dual Flintlock')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Flintlock', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyItem','Flintlock')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Refined Flintlock', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyItem','Refined Flintlock')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Cannon', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BuyItem','Cannon')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Kabucha', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BlackbeardReward','Slingshot','2')
end
, }) Tabs.Shop:AddSection('Fragments shop') Tabs.Shop:AddButton({ Name ='Buy Refund Stats', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BlackbeardReward','Refund','2')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Reroll Race', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('BlackbeardReward','Reroll','2')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Ghoul Race', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('Ectoplasm',' Change', 4)
end
, }) Tabs.Shop:AddButton({ Name ='Buy Cyborg Race (2.5k)', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('CyborgTrainer',' Buy')
end
, }) Tabs.Shop:AddButton({ Name ='Buy Draco Race', Callback = function()
_tp(CFrame.new(5814.42724609375, 1208.3267822265625, 884.5785522460938))
local targetPosition = Vector3.new(5814.42724609375, 1208.3267822265625, 884.5785522460938)
local player = game.Players.LocalPlayer
local character = player.Character or player.CharacterAdded:Wait() repeat
wait()
until (character.HumanoidRootPart.Position - targetPosition).Magnitude < 1
local args = { [1] = { ['NPC'] ='Dragon Wizard', ['Command'] ='DragonRace', }, } game:GetService('ReplicatedStorage').Modules.Net:FindFirstChild('RF/InteractDragonQuest'):InvokeServer(unpack(args))
end
, }) Tabs.Misc:AddSection('Server - Function') Tabs.Misc:AddButton({ Name ='Redeem All Codes', Description ='', Callback = function()
...
, }) Tabs.Misc:AddButton({ Name ='Rejoin Server', Description ='', Callback = function()
game:GetService('TeleportService'):Teleport(game.PlaceId, game.Players.LocalPlayer)
end
, }) Tabs.Misc:AddButton({ Name ='Hop Server', Description ='', Callback = function()
task.spawn(function()
...
local url ='https://games.roblox.com/v1/games/'.. PlaceId ..'/servers/Public?sortOrder=Asc&limit=100'local response = game:HttpGet(url)
...
, }) Tabs.Misc:AddButton({ Name ='Hop to Lowest Players', Description ='', Callback = function()
local Http = game:GetService('HttpService')
local TPS = game:GetService('TeleportService')
local Api ='https://games.roblox.com/v1/games/'local _place = game.PlaceId
local _servers = Api .. _place ..'/servers/Public?sortOrder=Asc&limit=100'function ListServers(cursor)
local Raw = game:HttpGet(_servers .. ((cursor and'&cursor='.. cursor) or''))
return Http:JSONDecode(Raw)
end
local Server, Next repeat
local Servers = ListServers(Next) Server = Servers.data[1] Next = Servers.nextPageCursor
until Server TPS:TeleportToPlaceInstance(_place, Server.id, plr)
end
, }) Tabs.Misc:AddButton({ Name ='Hop to Lowest Pings Server', Description ='', Callback = function()
local HTTPService = game:GetService('HttpService')
local TeleportService = game:GetService('TeleportService')
...
local commonLoadTime = 0.5 task.wait(commonLoadTime)
...
, })
local replicated = game:GetService('ReplicatedStorage') Tabs.Misc:AddTextBox({ Name ='Input Job Id', Placeholder ='Job ID', ClearOnFocus = true, Callback = function(Value)
getgenv().Job = Value
end
, }) Tabs.Misc:AddButton({ Name ='Teleport [Job ID]', Callback = function()
...
, }) Tabs.Misc:AddButton({ Name ='Copy JobID', Description ='', Callback = function()
setclipboard(tostring(game.JobId))
end
, }) Tabs.Misc:AddSection('Player Gui / Others') Tabs.Misc:AddButton({ Name ='Open Awakenings Expert', Description ='', Callback = function()
plr.PlayerGui.Main.AwakeningToggler.Visible = true
end
, }) Tabs.Misc:AddButton({ Name ='Open Title Selection', Description ='', Callback = function()
replicated.Remotes.CommF_:InvokeServer('getTitles', true) plr.PlayerGui.Main.Titles.Visible = true
end
, }) DisbleChat = Tabs.Misc:AddToggle({ Name ='Disable Chat GUI', Description ='', Default = false, Callback = function(Value)
_G.Rechat = Value
...
elseif _G.chat == false then
    local StarterGui = game:GetService('StarterGui') StarterGui:SetCoreGuiEnabled(Enum.CoreGuiType.Chat, true)
end
end
, }) DisbleLeaderB = Tabs.Misc:AddToggle({ Name ='Disable Leader Board GUI', Description ='', Default = false, Callback = function(Value)
ReLeader = Value
...
elseif ReLeader == false then
    local StarterGui = game:GetService('StarterGui') StarterGui:SetCoreGuiEnabled(Enum.CoreGuiType.PlayerList, true)
end
end
, }) Tabs.Misc:AddButton({ Name ='Set Pirate Team', Description ='', Callback = function()
Pirates()
end
, }) Tabs.Misc:AddButton({ Name ='Set Marine Team', Description ='', Callback = function()
Marines()
end
, }) UnPortal = Tabs.Misc:AddToggle({ Name ='Unlock All Portals', Description ='', Default = false, Callback = function(Value)
...
) Tabs.Misc:AddSection('Graphics / Haki Stats') HakiSt = {'State 0','State 1','State 2','State 3','State 4','State 5', } HakiStat = Tabs.Misc:AddDropdown({ Name ='Select Haki States', Options = HakiSt, Callback = function(Value)
_G.SelectStateHaki = Value
end
, }) Tabs.Misc:AddButton({ Name ='ChangeBusoStage', Description ='', Callback = function()
...
, }) rtxM = Tabs.Misc:AddToggle({ Name ='Turn on RTX Mode', Description ='', Default = false, Callback = function(Value)
_G.RTXMode = Value
local a = game.Lighting
local c = Instance.new('ColorCorrectionEffect', a)
local e = Instance.new('ColorCorrectionEffect', a) OldAmbient = a.Ambient OldBrightness = a.Brightness OldColorShift_Top = a.ColorShift_Top OldBrightnessc = c.Brightness OldContrastc = c.Contrast OldTintColorc = c.TintColor OldTintColore = e.TintColor
if not _G.RTXMode then
    return
end
while _G.RTXMode do
    wait() a.Ambient = Color3.fromRGB(33, 33, 33) a.Brightness = 0.3 c.Brightness = 0.176 c.Contrast = 0.39 c.TintColor = Color3.fromRGB(217, 145, 57) game.Lighting.FogEnd = 999
    if not plr.Character.HumanoidRootPart:FindFirstChild('PointLight') then
        local a2 = Instance.new('PointLight') a2.Parent = plr.Character.HumanoidRootPart a2.Range = 15 a2.Color = Color3.fromRGB(217, 145, 57)
    end
    if not _G.RTXMode then
        a.Ambient = OldAmbient a.Brightness = OldBrightness a.ColorShift_Top = OldColorShift_Top c.Contrast = OldContrastc c.Brightness = OldBrightnessc c.TintColor = OldTintColorc e.TintColor = OldTintColore game.Lighting.FogEnd = 2500 plr.Character.HumanoidRootPart:FindFirstChild('PointLight'):Destroy()
    end
end
end
, }) Tabs.Misc:AddButton({ Name ='Turn on Fast Mode', Description ='', Callback = function()
for _, zx in next, workspace:GetDescendants() do
    if table.find(Past, zx.ClassName) then
        zx.Material ='Plastic'end
    end
end
, }) Tabs.Misc:AddButton({ Name ='Turn on Low CPU', Description ='', Callback = function()
LowCpu()
end
, }) Tabs.Misc:AddButton({ Name ='Turn on increase Boats', Description ='', Callback = function()
for _, v in pairs(workspace.Boats:GetDescendants()) do
    if table.find(ListSeaBoat, v.Name) and tostring(v.Owner.Value) == tostring(plr.Name) then
        v.VehicleSeat.MaxSpeed = 350 v.VehicleSeat.Torque = 0.2 v.VehicleSeat.TurnSpeed = 5 v.VehicleSeat.HeadsUpDisplay = true
    end
end
end
, }) Tabs.Misc:AddButton({ Name ='Remove Sky Fog', Description ='', Callback = function()
...
, }) Tabs.Misc:AddSection('Configure - God') Tabs.Misc:AddButton({ Name ='Rain Fruits (Client)', Description ='', Callback = function()
for i, v in pairs(game:GetObjects('rbxassetid://14759368201')[1]:GetChildren()) do
    v.Parent = game.Workspace.Map v:MoveTo(plr.Character.PrimaryPart.Position + Vector3.new(math.random(- 50, 50), 100, math.random(- 50, 50)))
    if v.Fruit:FindFirstChild('AnimationController') then
        v.Fruit:FindFirstChild('AnimationController'):LoadAnimation(v.Fruit:FindFirstChild('Idle')):Play()
    end
    v.Handle.Touched:Connect(function(otherPart)
    if otherPart.Parent == plr.Character then
        v.Parent = plr.Backpack plr.Character.Humanoid:EquipTool(v)
    end
end
)
end
end
, }) briggt1 = Tabs.Misc:AddToggle({ Name ='Turn on Full Bright', Description ='', Default = false, Callback = function(Value)
bright = Value
if Value == true then
...
, }) DayN = Tabs.Misc:AddDropdown({ Name ='Select Time', Description ='', Options = {'Day','Night', }, Default = Day, Callback = function(Value)
_G.SelectDN = Value
end
, }) dayornight = Tabs.Misc:AddToggle({ Name ='Turn on Time', Description ='', Default = false, Callback = function(Value)
_G.daylightN = Value
end
, }) task.spawn(function()
while task.wait() do
...
) walkWater = Tabs.Misc:AddToggle({ Name ='Turn on Walk on Water', Description ='', Default = true, Callback = function(Value)
...
, }) iceWalk = Tabs.Misc:AddToggle({ Name ='Turn on Ice Walk', Description ='', Default = false, Callback = function(Value)
_G.WalkWater = Value
end
, }) spawn(function()
while task.wait() do
    if _G.WalkWater then
        ...
        if plr.Character and plr.Character:FindFirstChild('LeftFoot') then
            local upval0 = replicated.Assets.Models.IceSpikes4:Clone() upval0.Parent = workspace upval0.Size = Vector3.new(3 + math.random(10, 12), 1.7, 3 + math.random(10, 12)) upval0.Color = Color3.fromRGB(128, 187, 219) upval0.CFrame = CFrame.new(plr.Character.Head.Position.X, - 3.8, plr.Character.Head.Position.Z) * CFrame.Angles((math.random() - 0.5) * 0.06, math.random() * 7, (math.random() - 0.5) * 0.07)
            local var85 = {} var85.Size = Vector3.new(0, 0.3, 0)
            local var3 = TW:Create(upval0, TweenInfo.new(2, Enum.EasingStyle.Quad, Enum.EasingDirection.In), var85) var3.Completed:Connect(function()
            upval0:Destroy()
        end
        ) var3:Play()
    end
...
function AttackNoCoolDown()
    ...
    for _, enemy in ipairs(enemiesInRange) do
        if not enemy:GetAttribute('IsBoat') then
            ...
            if head then
                table.insert(targets, {enemy, head}) mainTarget = head
            end
        end
    end
    ...
    while not localScript do
        playerScripts.ChildAdded:Wait() localScript = playerScripts:FindFirstChildOfClass('LocalScript')
    end
    local hitFunction
    if getsenv then
...
if ToolTip =='Blox Fruit'then
    if MobAura then
        ...
        if LeftClickRemote then
            Actived() LeftClickRemote:FireServer(Vector3.new(0.01, - 500, 0.01), 1, true) LeftClickRemote:FireServer(false)
        end
    end
end
end
...
local Net = SafeWaitForChild(Modules,'Net') FastAttackModule.Rate = 0.000000002 FastAttackModule.Enabled = true function FastAttackModule.IsAlive(target)
...
function FastAttackModule.ExecuteFastAttack()
    ...
    local hitRemote = Net['RE/RegisterHit'] attackRemote:FireServer(FastAttackModule.Rate)
    local targetHead = targetParts[1][2] hitRemote:FireServer(targetHead, targetParts)
end
local AttackRemoteTarget
local AttackRemoteId
local function InitializeHitRegistration()
local foldersToCheck = { ReplicatedStorage.Util, ReplicatedStorage.Common, ReplicatedStorage.Remotes, ReplicatedStorage.Assets, ReplicatedStorage.FX, }
for _, folder in ipairs(foldersToCheck) do
    local children = folder:GetChildren()
    for _, child in ipairs(children) do
        if child:IsA('RemoteEvent') and child:GetAttribute('Id') then
            AttackRemoteTarget = child AttackRemoteId = child:GetAttribute('Id')
        end
    end
...
InitializeHitRegistration() function HitRegistrationModule.Execute()
local character = LocalPlayer.Character
if not character then
    return
end
...
ScanFolder(Enemies) ScanFolder(Characters)
local tool = character:FindFirstChildOfClass('Tool')
if #hitTargets > 0 and tool and (tool:GetAttribute('WeaponType') =='Melee'or tool:GetAttribute('WeaponType') =='Sword') then
    ...
    local attackRemote = Net['RE/RegisterAttack']
    local hitRemote = Net['RE/RegisterHit'] attackRemote:FireServer()
    ...
    if AttackRemoteTarget then
        local remoteCode ='RE/RegisterHit'local encryptionKey = math.floor(Workspace:GetServerTimeNow() / 10 % 10) + 1
        local encodedString = string.gsub(remoteCode,'.', function(char)
        return string.char(bit32.bxor(string.byte(char), encryptionKey))
    end
    )
    local finalId = bit32.bxor(AttackRemoteId + 909090, seed * 2) cloneref(AttackRemoteTarget):FireServer(encodedString, finalId, targetHead, hitTargets)
end
end
end
local function DisableCameraShake()
local cameraModule = require(ReplicatedStorage.Util.CameraShaker) cameraModule:Stop()
end
